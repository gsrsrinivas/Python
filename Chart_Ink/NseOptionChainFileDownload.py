...
def nse_option_chain_file_download():
    ...
    def print_header(index="", ul=0, nearest=0):
        print(strPurple(index.ljust(12, " ") + " => ") + strLightPurple(" Last Price: ") + strBold(
            str(ul)) + strLightPurple(" Nearest Strike: ") + strBold(str(nearest)))
    ...
    # Finding high Open Interest of People's in CE based on CE data
    ...
    # Finding high Open Interest of People's in PE based on PE data
...
if __name__ == "__main__":
    nse_option_chain_file_download()
