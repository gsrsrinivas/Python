...
/****** Object:  View [_sis].[Analyse_Stocks_v]    Script Date: 24-Jul-2025 9:21:49 AM ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER view [_sis].[Analyse_Stocks_v] as 
select 
...
from (select 
	...
	, [Segments - Order], [Segments - Sum]
	  ...
	  where Batch_No = (select max(batch_no) from _sis.Analyse_Stocks) 
