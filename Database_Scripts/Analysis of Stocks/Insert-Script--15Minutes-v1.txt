...
where a.Batch_No = (select max(batch_no) from dbo.Analyse_15Minutes_Stocks)
;
...
;
-- ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
-- select * from dbo.Analyse_15Minutes_Stocks where Batch_No = (select max(batch_no) from dbo.Analyse_15Minutes_Stocks) order by Sno;
