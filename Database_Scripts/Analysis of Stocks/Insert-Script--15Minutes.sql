...
-- add new stocks in master table
...
where symbol in (
	select symbol from dbo.Cash_15Minutes_Stocks
	except
	select symbol from dbo.Master_Stocks_In_Segments
);
-- update the sno in master table
...
select (select isnull(max(batch_no)+1,1) from dbo.Analyse_15Minutes_Stocks),SYSDATETIME(),a.[stock_name]
...
from dbo.Analyse_15Minutes_Stocks a inner join (
select symbol, 1 as volume__yearly__shockers from dbo.Cash_15Minutes_Stocks where Indicator = 'Volume' and TimeLine = 'Yearly' and Direction = 'Shockers'
) b on b.symbol = a.Symbol
where a.Batch_No = @Batch_no
;
update a set volume__quarterly__shockers = 1
from dbo.Analyse_15Minutes_Stocks a inner join (
select symbol, 1 as volume__quarterly__shockers from dbo.Cash_15Minutes_Stocks where Indicator = 'Volume' and TimeLine = 'Quarterly' and Direction = 'Shockers'
) b on b.symbol = a.Symbol
where a.Batch_No = @Batch_no
;
update a set volume__monthly__shockers = 1
from dbo.Analyse_15Minutes_Stocks a inner join (
select symbol, 1 as volume__monthly__shockers from dbo.Cash_15Minutes_Stocks where Indicator = 'Volume' and TimeLine = 'Monthly' and Direction = 'Shockers'
) b on b.symbol = a.Symbol
where a.Batch_No = @Batch_no
;
update a set volume__weekly__shockers = 1
from dbo.Analyse_15Minutes_Stocks a inner join (
select symbol, 1 as volume__weekly__shockers from dbo.Cash_15Minutes_Stocks where Indicator = 'Volume' and TimeLine = 'Weekly' and Direction = 'Shockers'
) b on b.symbol = a.Symbol
where a.Batch_No = @Batch_no
;
update a set volume__daily__shockers = 1
from dbo.Analyse_15Minutes_Stocks a inner join (
select symbol, 1 as volume__daily__shockers from dbo.Cash_15Minutes_Stocks where Indicator = 'Volume' and TimeLine = 'Daily' and Direction = 'Shockers'
) b on b.symbol = a.Symbol
where a.Batch_No = @Batch_no
;
update a set volume__4_hourly__shockers = 1
from dbo.Analyse_15Minutes_Stocks a inner join (
select symbol, 1 as volume__4_hourly__shockers from dbo.Cash_15Minutes_Stocks where Indicator = 'Volume' and TimeLine = '4 Hourly' and Direction = 'Shockers'
) b on b.symbol = a.Symbol
where a.Batch_No = @Batch_no
;
update a set volume__1_hourly__shockers = 1
from dbo.Analyse_15Minutes_Stocks a inner join (
select symbol, 1 as volume__1_hourly__shockers from dbo.Cash_15Minutes_Stocks where Indicator = 'Volume' and TimeLine = '1 Hourly' and Direction = 'Shockers'
) b on b.symbol = a.Symbol
where a.Batch_No = @Batch_no
;
update a set volume__15_minutes__shockers = 1
from dbo.Analyse_15Minutes_Stocks a inner join (
select symbol, 1 as volume__15_minutes__shockers from dbo.Cash_15Minutes_Stocks where Indicator = 'Volume' and TimeLine = '15 Minutes' and Direction = 'Shockers'
) b on b.symbol = a.Symbol
where a.Batch_No = @Batch_no
;
end 
