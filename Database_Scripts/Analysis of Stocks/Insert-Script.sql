...
delete from dbo.Analyse_Stocks where Batch_No = @Batch_No;
...
insert into dbo.Analyse_Stocks (Symbol,Stock_Name,Percent_Change,Price,Volume,Batch_No,Created_Date,' + @cols + ')
SELECT * 
FROM source
PIVOT (
    MAX(sno)
