...
order by [Trading View] desc,sector_order desc,[sum of screens] desc, [length of Trade Type Details] desc,[Length of Segments] desc,[length of trade type] desc
;
select * from _sis.Analyse_Stocks_v 
order by [Trading View] desc,sector_order desc,[sum of screens] desc, [length of Trade Type Details] desc,[Length of Segments] desc,[length of trade type] desc
;
------------------------------------------------------------------------------------------------------------------------------
select * from _sis.Analyse_15Minutes_Stocks_v 
...
,rn,[Stock_Name], [Sum of Screens], [Sum of Bullish Screen], [Sum of Bearish Screen], [Trade Type], [Length of Trade Type], [Length of Segments], [Length of Trade Type Details], [Created_Date]
,sector_order,sector_sum
from (
	select row_number() over(partition by [Batch_No], [Trading View],[Trade Type Details],[Stock_Name], [Segments], [Symbol] order by Sno desc) as rn, 
	[Sno], [Batch_No], [Sum of Screens], [Sum of Bullish Screen], [Sum of Bearish Screen], [Length of Segments], [Trading View], [Trade Type], [Length of Trade Type], replace([Trade Type Details],';',';'+char(13)+char(10)) as 'Trade-Type-Details',[Trade Type Details], [Length of Trade Type Details], [Created_Date], [Stock_Name],replace([Segments],';',';' + char(13)+ char(10))as segment, [Segments], [Symbol], [% Chg], [Price], [Volume]
	,sector_order,sector_sum
	--from _sis.Analyse_15Minutes_Stocks where Batch_No = (select max(batch_no) from _sis.Analyse_15Minutes_Stocks)
	 from _sis.Analyse_Stocks where Batch_No = (select max(batch_no) from _sis.Analyse_Stocks)	 	
	and [length of Segments] > 5 and [sum of screens] > 10 and [Length of Segments] > 25 and volume >1000
...
order by [Trading View] desc, sector_order desc,[sum of screens] desc,volume desc,[length of Trade Type Details] desc,[Length of Segments] desc,[length of trade type] desc
;
------------------------------------------------------------------------------------------------------------------------------
select [Batch_No], [Trading View],[Trade Type Details],[Segments], [Symbol], [% Chg], [Price], [Volume]
,rn,[Stock_Name], [Sum of Screens], [Sum of Bullish Screen], [Sum of Bearish Screen], [Trade Type], [Length of Trade Type], [Length of Segments], [Length of Trade Type Details], [Created_Date]
from (
	select row_number() over(partition by [Batch_No], [Trading View], [Trade Type Details],[Stock_Name], [Segments], [Symbol] order by Sno desc) as rn, 
	[Sno], [Batch_No], [Sum of Screens], [Sum of Bullish Screen], [Sum of Bearish Screen], [Length of Segments], [Trading View], [Trade Type], [Length of Trade Type], [Trade Type Details], [Length of Trade Type Details], [Created_Date], [Stock_Name], [Segments], [Symbol], [% Chg], [Price], [Volume]
	from 
	_sis.Analyse_Stocks 
	-- _sis.Analyse_15Minutes_Stocks 
	where Batch_No = (select max(batch_no) from _sis.Analyse_15Minutes_Stocks) 
	and [length of Segments] > 5 and [sum of screens] > 10 and [Length of Segments] > 25 and volume >10000
) a where rn = 1
order by [Trading View] desc,[sum of screens] desc, [length of Trade Type Details] desc,[Length of Segments] desc,[length of trade type] desc
;
------------------------------------------------------------------------------------------------------------------------------
------------------------------------------------------------------------------------------------------------------------------
select * from _sis.ALL_Stocks;
select * from _sis.Stocks_In_Segments; ;
select * 
from 
(select distinct symbol,STRING_AGG(segment,'; ') as Segments from 
( select distinct symbol,segment from _sis.ALL_Stocks ) a
group by symbol) a
;

select segment,count(1) from _sis.ALL_Stocks group by segment; ;
select distinct symbol from _sis.ALL_Stocks where Segment = 'cash' ;
...
--
select * 
--update a set Stock_Name = b.[stock name]
from [dbo].[Stocks_In_Segments] a
inner join _sis.Cash_Stocks b
on a.symbol = b.symbol
;
select  distinct b.[stock name],a.*
from [dbo].[Stocks_In_Segments] a
inner join _sis.Cash_Stocks b
on a.symbol = b.symbol
;
...
from [dbo].[Stocks_In_Segments] a
left join (select symbol, 1 as Macd_Yearly_Crosses_Above from _sis.Cash_Stocks 
...
from [dbo].[Stocks_In_Segments] a
left join (select symbol, 1 as Macd_Yearly_Crosses_Above from _sis.Cash_Stocks where Indicator = 'Macd' and TimeLine = 'Yearly' and Direction = 'Crosses Above'
) m1 on m1.symbol = a.Symbol
left join (select symbol, 1 as Macd_Yearly_Crosses_Below from _sis.Cash_Stocks where Indicator = 'Macd' and TimeLine = 'Yearly' and Direction = 'Crosses Below'
) m2 on m2.symbol = a.Symbol
left join (select symbol, 1 as Macd_Quarterly_Crosses_Above from _sis.Cash_Stocks where Indicator = 'Macd' and TimeLine = 'Quarterly' and Direction = 'Crosses Above'
) m3 on m3.symbol = a.Symbol
left join (select symbol, 1 as Macd_Quarterly_Crosses_Above from _sis.Cash_Stocks where Indicator = 'Macd' and TimeLine = 'Quarterly' and Direction = 'Crosses Below'
) m4 on m4.symbol = a.Symbol
left join (select symbol, 1 as Macd_Monthly_Crosses_Above from _sis.Cash_Stocks where Indicator = 'Macd' and TimeLine = 'Monthly' and Direction = 'Crosses Above'
) m5 on m5.symbol = a.Symbol
left join (select symbol, 1 as Macd_Monthly_Crosses_Above from _sis.Cash_Stocks where Indicator = 'Macd' and TimeLine = 'Monthly' and Direction = 'Crosses Below'
) m6 on m6.symbol = a.Symbol
left join (select symbol, 1 as Macd_Weekly_Crosses_Above from _sis.Cash_Stocks where Indicator = 'Macd' and TimeLine = 'Weekly' and Direction = 'Crosses Above'
) m7 on m7.symbol = a.Symbol
left join (select symbol, 1 as Macd_Weekly_Crosses_Above from _sis.Cash_Stocks where Indicator = 'Macd' and TimeLine = 'Weekly' and Direction = 'Crosses Below'
) m8 on m8.symbol = a.Symbol
left join (select symbol, 1 as Macd_Daily_Crosses_Above from _sis.Cash_Stocks where Indicator = 'Macd' and TimeLine = 'Daily' and Direction = 'Crosses Above'
) m9 on m9.symbol = a.Symbol
left join (select symbol, 1 as Macd_Daily_Crosses_Above from _sis.Cash_Stocks where Indicator = 'Macd' and TimeLine = 'Daily' and Direction = 'Crosses Below'
) m10 on m10.symbol = a.Symbol
left join (select symbol, 1 as Macd_4Hourly_Crosses_Above from _sis.Cash_Stocks where Indicator = 'Macd' and TimeLine = '4 Hourly' and Direction = 'Crosses Above'
) m11 on m11.symbol = a.Symbol
left join (select symbol, 1 as Macd_4Hourly_Crosses_Above from _sis.Cash_Stocks where Indicator = 'Macd' and TimeLine = '4 Hourly' and Direction = 'Crosses Below'
) m12 on m12.symbol = a.Symbol
left join (select symbol, 1 as Macd_1Hourly_Crosses_Above from _sis.Cash_Stocks where Indicator = 'Macd' and TimeLine = '1 Hourly' and Direction = 'Crosses Above'
) m13 on m13.symbol = a.Symbol
left join (select symbol, 1 as Macd_1Hourly_Crosses_Above from _sis.Cash_Stocks where Indicator = 'Macd' and TimeLine = '1 Hourly' and Direction = 'Crosses Below'
) m14 on m14.symbol = a.Symbol
left join (select symbol, 1 as Macd_15Minutes_Crosses_Above from _sis.Cash_Stocks where Indicator = 'Macd' and TimeLine = '15 Minutes' and Direction = 'Crosses Above'
) m15 on m15.symbol = a.Symbol
left join (select symbol, 1 as Macd_15Minutes_Crosses_Above from _sis.Cash_Stocks where Indicator = 'Macd' and TimeLine = '15 Minutes' and Direction = 'Crosses Below'
...
from _sis.Stocks s
left join (select * from _sis.Stocks where indicator = 'MACD' and timeline = 'Monthly' and direction = 'Crosses Above') a on s.symbol = a.symbol
left join (select * from _sis.Stocks where indicator = 'MACD' and timeline = 'Weekly' and direction = 'Crosses Above') b on s.symbol = b.symbol
left join (select * from _sis.Stocks where indicator = 'MACD' and timeline = 'Daily' and direction = 'Crosses Above') c on s.symbol = c.symbol
left join (select * from _sis.Stocks where indicator = 'MACD' and timeline = '4 Hourly' and direction = 'Crosses Above') d on s.symbol = d.symbol
left join (select * from _sis.Stocks where indicator = 'MACD' and timeline = '1 Hourly' and direction = 'Crosses Above') e on s.symbol = e.symbol
left join (select * from _sis.Stocks where indicator = 'MACD' and timeline = '15 Minutes' and direction = 'Crosses Above') f on s.symbol = f.symbol
;

select distinct s.symbol,a.indicator,a.timeline,a.direction,b.indicator,b.timeline,b.direction,c.indicator,c.timeline,c.direction,d.indicator,d.timeline,d.direction,e.indicator,e.timeline,e.direction,f.indicator,f.timeline,f.direction
from _sis.Stocks s
left join (select * from _sis.Stocks where indicator = 'MACD' and timeline = 'Monthly' and direction = 'Crosses Below') a on s.symbol = a.symbol
left join (select * from _sis.Stocks where indicator = 'MACD' and timeline = 'Weekly' and direction = 'Crosses Below') b on s.symbol = b.symbol
left join (select * from _sis.Stocks where indicator = 'MACD' and timeline = 'Daily' and direction = 'Crosses Below') c on s.symbol = c.symbol
left join (select * from _sis.Stocks where indicator = 'MACD' and timeline = '4 Hourly' and direction = 'Crosses Below') d on s.symbol = d.symbol
left join (select * from _sis.Stocks where indicator = 'MACD' and timeline = '1 Hourly' and direction = 'Crosses Below') e on s.symbol = e.symbol
left join (select * from _sis.Stocks where indicator = 'MACD' and timeline = '15 Minutes' and direction = 'Crosses Below') f on s.symbol = f.symbol
;

select distinct symbol,STRING_AGG(segment,', ') from 
( select distinct symbol,segment from _sis.Stocks ) a
group by symbol
;

select distinct a.sr#,a.[stock name],a.symbol, a.TimeLine, a.Direction, a.Indicator, a.price, a.[% Chg], a.volume;rom _sis.Stocks a where symbol = 'DANGEE'
;
select distinct indicator from _sis.Stocks
/*
Adx Down Tick
Ema 50 100
Adx
...
from _sis.Stocks_In_Segments sis inner join (
select row_number() over(order by len(segments) desc) as rn, 
len(segments) as maxsegments,* 
from _sis.Stocks_In_Segments
) b
on sis.Symbol = b.Symbol
;
select count(1),Batch_No from _sis.Cash_Stocks
group by Batch_No
order by Batch_No
;
select * from _sis.Cash_Stocks
;
...
,cs.[% Chg],cs.price,cs.volume
from [dbo].[Stocks_In_Segments] a 
join _sis.Cash_Stocks cs on a.Symbol = cs.symbol
where cs.Batch_No = (select max(batch_no) from _sis.Cash_Stocks)
;
...
;
select distinct symbol from _sis.Cash_Stocks where Indicator = 'all'
...
from _sis.Analyse_Stocks a
where 1=1 and Batch_No = (select MAX(Batch_No) from _sis.Analyse_Stocks)
...
----------------------------------
--insert into [dbo].[Analyse_Stocks]([Batch_No], [Created_Date], [Stock_Name], [Segments], [Symbol], [% Chg], [price], [volume], [Macd_Yearly_Crosses_Above], [Macd_Yearly_Crosses_Below], [Macd_Quarterly_Crosses_Above], [Macd_Quarterly_Crosses_Below], [Macd_Monthly_Crosses_Above], [Macd_Monthly_Crosses_Below], [Macd_Weekly_Crosses_Above], [Macd_Weekly_Crosses_Below], [Macd_Daily_Crosses_Above], [Macd_Daily_Crosses_Below], [Macd_4_Hourly_Crosses_Above], [Macd_4_Hourly_Crosses_Below], [Macd_1_Hourly_Crosses_Above], [Macd_1_Hourly_Crosses_Below], [Macd_15_Minutes_Crosses_Above], [Macd_15_Minutes_Crosses_Below], [Stochastic_Yearly_Crosses_Above], [Stochastic_Yearly_Crosses_Below], [Stochastic_Quarterly_Crosses_Above], [Stochastic_Quarterly_Crosses_Below], [Stochastic_Monthly_Crosses_Above], [Stochastic_Monthly_Crosses_Below], [Stochastic_Weekly_Crosses_Above], [Stochastic_Weekly_Crosses_Below], [Stochastic_Daily_Crosses_Above], [Stochastic_Daily_Crosses_Below], [Stochastic_4_Hourly_Crosses_Above], [Stochastic_4_Hourly_Crosses_Below], [Stochastic_1_Hourly_Crosses_Above], [Stochastic_1_Hourly_Crosses_Below], [Stochastic_15_Minutes_Crosses_Above], [Stochastic_15_Minutes_Crosses_Below], [Ema_5_13_Yearly_Crosses_Above], [Ema_5_13_Yearly_Crosses_Below], [Ema_5_13_Quarterly_Crosses_Above], [Ema_5_13_Quarterly_Crosses_Below], [Ema_5_13_Monthly_Crosses_Above], [Ema_5_13_Monthly_Crosses_Below], [Ema_5_13_Weekly_Crosses_Above], [Ema_5_13_Weekly_Crosses_Below], [Ema_5_13_Daily_Crosses_Above], [Ema_5_13_Daily_Crosses_Below], [Ema_5_13_4_Hourly_Crosses_Above], [Ema_5_13_4_Hourly_Crosses_Below], [Ema_5_13_1_Hourly_Crosses_Above], [Ema_5_13_1_Hourly_Crosses_Below], [Ema_5_13_15_Minutes_Crosses_Above], [Ema_5_13_15_Minutes_Crosses_Below], [Ema_13_26_Yearly_Crosses_Above], [Ema_13_26_Yearly_Crosses_Below], [Ema_13_26_Quarterly_Crosses_Above], [Ema_13_26_Quarterly_Crosses_Below], [Ema_13_26_Monthly_Crosses_Above], [Ema_13_26_Monthly_Crosses_Below], [Ema_13_26_Weekly_Crosses_Above], [Ema_13_26_Weekly_Crosses_Below], [Ema_13_26_Daily_Crosses_Above], [Ema_13_26_Daily_Crosses_Below], [Ema_13_26_4_Hourly_Crosses_Above], [Ema_13_26_4_Hourly_Crosses_Below], [Ema_13_26_1_Hourly_Crosses_Above], [Ema_13_26_1_Hourly_Crosses_Below], [Ema_13_26_15_Minutes_Crosses_Above], [Ema_13_26_15_Minutes_Crosses_Below], [Ema_50_100_Yearly_Crosses_Above], [Ema_50_100_Yearly_Crosses_Below], [Ema_50_100_Quarterly_Crosses_Above], [Ema_50_100_Quarterly_Crosses_Below], [Ema_50_100_Monthly_Crosses_Above], [Ema_50_100_Monthly_Crosses_Below], [Ema_50_100_Weekly_Crosses_Above], [Ema_50_100_Weekly_Crosses_Below], [Ema_50_100_Daily_Crosses_Above], [Ema_50_100_Daily_Crosses_Below], [Ema_50_100_4_Hourly_Crosses_Above], [Ema_50_100_4_Hourly_Crosses_Below], [Ema_50_100_1_Hourly_Crosses_Above], [Ema_50_100_1_Hourly_Crosses_Below], [Ema_50_100_15_Minutes_Crosses_Above], [Ema_50_100_15_Minutes_Crosses_Below], [Ema_100_200_Yearly_Crosses_Above], [Ema_100_200_Yearly_Crosses_Below], [Ema_100_200_Quarterly_Crosses_Above], [Ema_100_200_Quarterly_Crosses_Below], [Ema_100_200_Monthly_Crosses_Above], [Ema_100_200_Monthly_Crosses_Below], [Ema_100_200_Weekly_Crosses_Above], [Ema_100_200_Weekly_Crosses_Below], [Ema_100_200_Daily_Crosses_Above], [Ema_100_200_Daily_Crosses_Below], [Ema_100_200_4_Hourly_Crosses_Above], [Ema_100_200_4_Hourly_Crosses_Below], [Ema_100_200_1_Hourly_Crosses_Above], [Ema_100_200_1_Hourly_Crosses_Below], [Ema_100_200_15_Minutes_Crosses_Above], [Ema_100_200_15_Minutes_Crosses_Below], [Adx_Yearly_Crosses_Above], [Adx_Yearly_Crosses_Below], [Adx_Quarterly_Crosses_Above], [Adx_Quarterly_Crosses_Below], [Adx_Monthly_Crosses_Above], [Adx_Monthly_Crosses_Below], [Adx_Weekly_Crosses_Above], [Adx_Weekly_Crosses_Below], [Adx_Daily_Crosses_Above], [Adx_Daily_Crosses_Below], [Adx_4_Hourly_Crosses_Above], [Adx_4_Hourly_Crosses_Below], [Adx_1_Hourly_Crosses_Above], [Adx_1_Hourly_Crosses_Below], [Adx_15_Minutes_Crosses_Above], [Adx_15_Minutes_Crosses_Below], [Rsi_Yearly_Crosses_Above], [Rsi_Yearly_Crosses_Below], [Rsi_Quarterly_Crosses_Above], [Rsi_Quarterly_Crosses_Below], [Rsi_Monthly_Crosses_Above], [Rsi_Monthly_Crosses_Below], [Rsi_Weekly_Crosses_Above], [Rsi_Weekly_Crosses_Below], [Rsi_Daily_Crosses_Above], [Rsi_Daily_Crosses_Below], [Rsi_4_Hourly_Crosses_Above], [Rsi_4_Hourly_Crosses_Below], [Rsi_1_Hourly_Crosses_Above], [Rsi_1_Hourly_Crosses_Below], [Rsi_15_Minutes_Crosses_Above], [Rsi_15_Minutes_Crosses_Below], [Upper_Bollinger_Band3_Yearly_Greater_Than_Equal_To], [Upper_Bollinger_Band3_Yearly_Less_Than_Equal_To], [Upper_Bollinger_Band3_Quarterly_Greater_Than_Equal_To], [Upper_Bollinger_Band3_Quarterly_Less_Than_Equal_To], [Upper_Bollinger_Band3_Monthly_Greater_Than_Equal_To], [Upper_Bollinger_Band3_Monthly_Less_Than_Equal_To], [Upper_Bollinger_Band3_Weekly_Greater_Than_Equal_To], [Upper_Bollinger_Band3_Weekly_Less_Than_Equal_To], [Upper_Bollinger_Band3_Daily_Greater_Than_Equal_To], [Upper_Bollinger_Band3_Daily_Less_Than_Equal_To], [Upper_Bollinger_Band3_4_Hourly_Greater_Than_Equal_To], [Upper_Bollinger_Band3_4_Hourly_Less_Than_Equal_To], [Upper_Bollinger_Band3_1_Hourly_Greater_Than_Equal_To], [Upper_Bollinger_Band3_1_Hourly_Less_Than_Equal_To], [Upper_Bollinger_Band3_15_Minutes_Greater_Than_Equal_To], [Upper_Bollinger_Band3_15_Minutes_Less_Than_Equal_To], [Lower_Bollinger_Band3_Yearly_Greater_Than_Equal_To], [Lower_Bollinger_Band3_Yearly_Less_Than_Equal_To], [Lower_Bollinger_Band3_Quarterly_Greater_Than_Equal_To], [Lower_Bollinger_Band3_Quarterly_Less_Than_Equal_To], [Lower_Bollinger_Band3_Monthly_Greater_Than_Equal_To], [Lower_Bollinger_Band3_Monthly_Less_Than_Equal_To], [Lower_Bollinger_Band3_Weekly_Greater_Than_Equal_To], [Lower_Bollinger_Band3_Weekly_Less_Than_Equal_To], [Lower_Bollinger_Band3_Daily_Greater_Than_Equal_To], [Lower_Bollinger_Band3_Daily_Less_Than_Equal_To], [Lower_Bollinger_Band3_4_Hourly_Greater_Than_Equal_To], [Lower_Bollinger_Band3_4_Hourly_Less_Than_Equal_To], [Lower_Bollinger_Band3_1_Hourly_Greater_Than_Equal_To], [Lower_Bollinger_Band3_1_Hourly_Less_Than_Equal_To], [Lower_Bollinger_Band3_15_Minutes_Greater_Than_Equal_To], [Lower_Bollinger_Band3_15_Minutes_Less_Than_Equal_To], [Upper_Bollinger_Band2_Yearly_Greater_Than_Equal_To], [Upper_Bollinger_Band2_Yearly_Less_Than_Equal_To], [Upper_Bollinger_Band2_Quarterly_Greater_Than_Equal_To], [Upper_Bollinger_Band2_Quarterly_Less_Than_Equal_To], [Upper_Bollinger_Band2_Monthly_Greater_Than_Equal_To], [Upper_Bollinger_Band2_Monthly_Less_Than_Equal_To], [Upper_Bollinger_Band2_Weekly_Greater_Than_Equal_To], [Upper_Bollinger_Band2_Weekly_Less_Than_Equal_To], [Upper_Bollinger_Band2_Daily_Greater_Than_Equal_To], [Upper_Bollinger_Band2_Daily_Less_Than_Equal_To], [Upper_Bollinger_Band2_4_Hourly_Greater_Than_Equal_To], [Upper_Bollinger_Band2_4_Hourly_Less_Than_Equal_To], [Upper_Bollinger_Band2_1_Hourly_Greater_Than_Equal_To], [Upper_Bollinger_Band2_1_Hourly_Less_Than_Equal_To], [Upper_Bollinger_Band2_15_Minutes_Greater_Than_Equal_To], [Upper_Bollinger_Band2_15_Minutes_Less_Than_Equal_To], [Lower_Bollinger_Band2_Yearly_Greater_Than_Equal_To], [Lower_Bollinger_Band2_Yearly_Less_Than_Equal_To], [Lower_Bollinger_Band2_Quarterly_Greater_Than_Equal_To], [Lower_Bollinger_Band2_Quarterly_Less_Than_Equal_To], [Lower_Bollinger_Band2_Monthly_Greater_Than_Equal_To], [Lower_Bollinger_Band2_Monthly_Less_Than_Equal_To], [Lower_Bollinger_Band2_Weekly_Greater_Than_Equal_To], [Lower_Bollinger_Band2_Weekly_Less_Than_Equal_To], [Lower_Bollinger_Band2_Daily_Greater_Than_Equal_To], [Lower_Bollinger_Band2_Daily_Less_Than_Equal_To], [Lower_Bollinger_Band2_4_Hourly_Greater_Than_Equal_To], [Lower_Bollinger_Band2_4_Hourly_Less_Than_Equal_To], [Lower_Bollinger_Band2_1_Hourly_Greater_Than_Equal_To], [Lower_Bollinger_Band2_1_Hourly_Less_Than_Equal_To], [Lower_Bollinger_Band2_15_Minutes_Greater_Than_Equal_To], [Lower_Bollinger_Band2_15_Minutes_Less_Than_Equal_To], [Volume_Yearly_Greater_Than_Equal_To], [Volume_Yearly_Less_Than_Equal_To], [Volume_Quarterly_Greater_Than_Equal_To], [Volume_Quarterly_Less_Than_Equal_To], [Volume_Monthly_Greater_Than_Equal_To], [Volume_Monthly_Less_Than_Equal_To], [Volume_Weekly_Greater_Than_Equal_To], [Volume_Weekly_Less_Than_Equal_To], [Volume_Daily_Greater_Than_Equal_To], [Volume_Daily_Less_Than_Equal_To], [Volume_4_Hourly_Greater_Than_Equal_To], [Volume_4_Hourly_Less_Than_Equal_To], [Volume_1_Hourly_Greater_Than_Equal_To], [Volume_1_Hourly_Less_Than_Equal_To], [Volume_15_Minutes_Greater_Than_Equal_To], [Volume_15_Minutes_Less_Than_Equal_To], [Adx_Up_Tick_Yearly_Greater_Than_Equal_To], [Adx_Down_Tick_Yearly_Less_Than_Equal_To], [Adx_Up_Tick_Quarterly_Greater_Than_Equal_To], [Adx_Down_Tick_Quarterly_Less_Than_Equal_To], [Adx_Up_Tick_Monthly_Greater_Than_Equal_To], [Adx_Down_Tick_Monthly_Less_Than_Equal_To], [Adx_Up_Tick_Weekly_Greater_Than_Equal_To], [Adx_Down_Tick_Weekly_Less_Than_Equal_To], [Adx_Up_Tick_Daily_Greater_Than_Equal_To], [Adx_Down_Tick_Daily_Less_Than_Equal_To], [Adx_Up_Tick_4_Hourly_Greater_Than_Equal_To], [Adx_Down_Tick_4_Hourly_Less_Than_Equal_To], [Adx_Up_Tick_1_Hourly_Greater_Than_Equal_To], [Adx_Down_Tick_1_Hourly_Less_Than_Equal_To], [Adx_Up_Tick_15_Minutes_Greater_Than_Equal_To], [Adx_Down_Tick_15_Minutes_Less_Than_Equal_To])
--select [Batch_No], [Created_Date], [Stock_Name], [Segments], [Symbol], [% Chg], [price], [volume], [Macd_Yearly_Crosses_Above], [Macd_Yearly_Crosses_Below], [Macd_Quarterly_Crosses_Above], [Macd_Quarterly_Crosses_Below], [Macd_Monthly_Crosses_Above], [Macd_Monthly_Crosses_Below], [Macd_Weekly_Crosses_Above], [Macd_Weekly_Crosses_Below], [Macd_Daily_Crosses_Above], [Macd_Daily_Crosses_Below], [Macd_4_Hourly_Crosses_Above], [Macd_4_Hourly_Crosses_Below], [Macd_1_Hourly_Crosses_Above], [Macd_1_Hourly_Crosses_Below], [Macd_15_Minutes_Crosses_Above], [Macd_15_Minutes_Crosses_Below], [Stochastic_Yearly_Crosses_Above], [Stochastic_Yearly_Crosses_Below], [Stochastic_Quarterly_Crosses_Above], [Stochastic_Quarterly_Crosses_Below], [Stochastic_Monthly_Crosses_Above], [Stochastic_Monthly_Crosses_Below], [Stochastic_Weekly_Crosses_Above], [Stochastic_Weekly_Crosses_Below], [Stochastic_Daily_Crosses_Above], [Stochastic_Daily_Crosses_Below], [Stochastic_4_Hourly_Crosses_Above], [Stochastic_4_Hourly_Crosses_Below], [Stochastic_1_Hourly_Crosses_Above], [Stochastic_1_Hourly_Crosses_Below], [Stochastic_15_Minutes_Crosses_Above], [Stochastic_15_Minutes_Crosses_Below], [Ema_5_13_Yearly_Crosses_Above], [Ema_5_13_Yearly_Crosses_Below], [Ema_5_13_Quarterly_Crosses_Above], [Ema_5_13_Quarterly_Crosses_Below], [Ema_5_13_Monthly_Crosses_Above], [Ema_5_13_Monthly_Crosses_Below], [Ema_5_13_Weekly_Crosses_Above], [Ema_5_13_Weekly_Crosses_Below], [Ema_5_13_Daily_Crosses_Above], [Ema_5_13_Daily_Crosses_Below], [Ema_5_13_4_Hourly_Crosses_Above], [Ema_5_13_4_Hourly_Crosses_Below], [Ema_5_13_1_Hourly_Crosses_Above], [Ema_5_13_1_Hourly_Crosses_Below], [Ema_5_13_15_Minutes_Crosses_Above], [Ema_5_13_15_Minutes_Crosses_Below], [Ema_13_26_Yearly_Crosses_Above], [Ema_13_26_Yearly_Crosses_Below], [Ema_13_26_Quarterly_Crosses_Above], [Ema_13_26_Quarterly_Crosses_Below], [Ema_13_26_Monthly_Crosses_Above], [Ema_13_26_Monthly_Crosses_Below], [Ema_13_26_Weekly_Crosses_Above], [Ema_13_26_Weekly_Crosses_Below], [Ema_13_26_Daily_Crosses_Above], [Ema_13_26_Daily_Crosses_Below], [Ema_13_26_4_Hourly_Crosses_Above], [Ema_13_26_4_Hourly_Crosses_Below], [Ema_13_26_1_Hourly_Crosses_Above], [Ema_13_26_1_Hourly_Crosses_Below], [Ema_13_26_15_Minutes_Crosses_Above], [Ema_13_26_15_Minutes_Crosses_Below], [Ema_50_100_Yearly_Crosses_Above], [Ema_50_100_Yearly_Crosses_Below], [Ema_50_100_Quarterly_Crosses_Above], [Ema_50_100_Quarterly_Crosses_Below], [Ema_50_100_Monthly_Crosses_Above], [Ema_50_100_Monthly_Crosses_Below], [Ema_50_100_Weekly_Crosses_Above], [Ema_50_100_Weekly_Crosses_Below], [Ema_50_100_Daily_Crosses_Above], [Ema_50_100_Daily_Crosses_Below], [Ema_50_100_4_Hourly_Crosses_Above], [Ema_50_100_4_Hourly_Crosses_Below], [Ema_50_100_1_Hourly_Crosses_Above], [Ema_50_100_1_Hourly_Crosses_Below], [Ema_50_100_15_Minutes_Crosses_Above], [Ema_50_100_15_Minutes_Crosses_Below], [Ema_100_200_Yearly_Crosses_Above], [Ema_100_200_Yearly_Crosses_Below], [Ema_100_200_Quarterly_Crosses_Above], [Ema_100_200_Quarterly_Crosses_Below], [Ema_100_200_Monthly_Crosses_Above], [Ema_100_200_Monthly_Crosses_Below], [Ema_100_200_Weekly_Crosses_Above], [Ema_100_200_Weekly_Crosses_Below], [Ema_100_200_Daily_Crosses_Above], [Ema_100_200_Daily_Crosses_Below], [Ema_100_200_4_Hourly_Crosses_Above], [Ema_100_200_4_Hourly_Crosses_Below], [Ema_100_200_1_Hourly_Crosses_Above], [Ema_100_200_1_Hourly_Crosses_Below], [Ema_100_200_15_Minutes_Crosses_Above], [Ema_100_200_15_Minutes_Crosses_Below], [Adx_Yearly_Crosses_Above], [Adx_Yearly_Crosses_Below], [Adx_Quarterly_Crosses_Above], [Adx_Quarterly_Crosses_Below], [Adx_Monthly_Crosses_Above], [Adx_Monthly_Crosses_Below], [Adx_Weekly_Crosses_Above], [Adx_Weekly_Crosses_Below], [Adx_Daily_Crosses_Above], [Adx_Daily_Crosses_Below], [Adx_4_Hourly_Crosses_Above], [Adx_4_Hourly_Crosses_Below], [Adx_1_Hourly_Crosses_Above], [Adx_1_Hourly_Crosses_Below], [Adx_15_Minutes_Crosses_Above], [Adx_15_Minutes_Crosses_Below], [Rsi_Yearly_Crosses_Above], [Rsi_Yearly_Crosses_Below], [Rsi_Quarterly_Crosses_Above], [Rsi_Quarterly_Crosses_Below], [Rsi_Monthly_Crosses_Above], [Rsi_Monthly_Crosses_Below], [Rsi_Weekly_Crosses_Above], [Rsi_Weekly_Crosses_Below], [Rsi_Daily_Crosses_Above], [Rsi_Daily_Crosses_Below], [Rsi_4_Hourly_Crosses_Above], [Rsi_4_Hourly_Crosses_Below], [Rsi_1_Hourly_Crosses_Above], [Rsi_1_Hourly_Crosses_Below], [Rsi_15_Minutes_Crosses_Above], [Rsi_15_Minutes_Crosses_Below], [Upper_Bollinger_Band3_Yearly_Greater_Than_Equal_To], [Upper_Bollinger_Band3_Yearly_Less_Than_Equal_To], [Upper_Bollinger_Band3_Quarterly_Greater_Than_Equal_To], [Upper_Bollinger_Band3_Quarterly_Less_Than_Equal_To], [Upper_Bollinger_Band3_Monthly_Greater_Than_Equal_To], [Upper_Bollinger_Band3_Monthly_Less_Than_Equal_To], [Upper_Bollinger_Band3_Weekly_Greater_Than_Equal_To], [Upper_Bollinger_Band3_Weekly_Less_Than_Equal_To], [Upper_Bollinger_Band3_Daily_Greater_Than_Equal_To], [Upper_Bollinger_Band3_Daily_Less_Than_Equal_To], [Upper_Bollinger_Band3_4_Hourly_Greater_Than_Equal_To], [Upper_Bollinger_Band3_4_Hourly_Less_Than_Equal_To], [Upper_Bollinger_Band3_1_Hourly_Greater_Than_Equal_To], [Upper_Bollinger_Band3_1_Hourly_Less_Than_Equal_To], [Upper_Bollinger_Band3_15_Minutes_Greater_Than_Equal_To], [Upper_Bollinger_Band3_15_Minutes_Less_Than_Equal_To], [Lower_Bollinger_Band3_Yearly_Greater_Than_Equal_To], [Lower_Bollinger_Band3_Yearly_Less_Than_Equal_To], [Lower_Bollinger_Band3_Quarterly_Greater_Than_Equal_To], [Lower_Bollinger_Band3_Quarterly_Less_Than_Equal_To], [Lower_Bollinger_Band3_Monthly_Greater_Than_Equal_To], [Lower_Bollinger_Band3_Monthly_Less_Than_Equal_To], [Lower_Bollinger_Band3_Weekly_Greater_Than_Equal_To], [Lower_Bollinger_Band3_Weekly_Less_Than_Equal_To], [Lower_Bollinger_Band3_Daily_Greater_Than_Equal_To], [Lower_Bollinger_Band3_Daily_Less_Than_Equal_To], [Lower_Bollinger_Band3_4_Hourly_Greater_Than_Equal_To], [Lower_Bollinger_Band3_4_Hourly_Less_Than_Equal_To], [Lower_Bollinger_Band3_1_Hourly_Greater_Than_Equal_To], [Lower_Bollinger_Band3_1_Hourly_Less_Than_Equal_To], [Lower_Bollinger_Band3_15_Minutes_Greater_Than_Equal_To], [Lower_Bollinger_Band3_15_Minutes_Less_Than_Equal_To], [Upper_Bollinger_Band2_Yearly_Greater_Than_Equal_To], [Upper_Bollinger_Band2_Yearly_Less_Than_Equal_To], [Upper_Bollinger_Band2_Quarterly_Greater_Than_Equal_To], [Upper_Bollinger_Band2_Quarterly_Less_Than_Equal_To], [Upper_Bollinger_Band2_Monthly_Greater_Than_Equal_To], [Upper_Bollinger_Band2_Monthly_Less_Than_Equal_To], [Upper_Bollinger_Band2_Weekly_Greater_Than_Equal_To], [Upper_Bollinger_Band2_Weekly_Less_Than_Equal_To], [Upper_Bollinger_Band2_Daily_Greater_Than_Equal_To], [Upper_Bollinger_Band2_Daily_Less_Than_Equal_To], [Upper_Bollinger_Band2_4_Hourly_Greater_Than_Equal_To], [Upper_Bollinger_Band2_4_Hourly_Less_Than_Equal_To], [Upper_Bollinger_Band2_1_Hourly_Greater_Than_Equal_To], [Upper_Bollinger_Band2_1_Hourly_Less_Than_Equal_To], [Upper_Bollinger_Band2_15_Minutes_Greater_Than_Equal_To], [Upper_Bollinger_Band2_15_Minutes_Less_Than_Equal_To], [Lower_Bollinger_Band2_Yearly_Greater_Than_Equal_To], [Lower_Bollinger_Band2_Yearly_Less_Than_Equal_To], [Lower_Bollinger_Band2_Quarterly_Greater_Than_Equal_To], [Lower_Bollinger_Band2_Quarterly_Less_Than_Equal_To], [Lower_Bollinger_Band2_Monthly_Greater_Than_Equal_To], [Lower_Bollinger_Band2_Monthly_Less_Than_Equal_To], [Lower_Bollinger_Band2_Weekly_Greater_Than_Equal_To], [Lower_Bollinger_Band2_Weekly_Less_Than_Equal_To], [Lower_Bollinger_Band2_Daily_Greater_Than_Equal_To], [Lower_Bollinger_Band2_Daily_Less_Than_Equal_To], [Lower_Bollinger_Band2_4_Hourly_Greater_Than_Equal_To], [Lower_Bollinger_Band2_4_Hourly_Less_Than_Equal_To], [Lower_Bollinger_Band2_1_Hourly_Greater_Than_Equal_To], [Lower_Bollinger_Band2_1_Hourly_Less_Than_Equal_To], [Lower_Bollinger_Band2_15_Minutes_Greater_Than_Equal_To], [Lower_Bollinger_Band2_15_Minutes_Less_Than_Equal_To], [Volume_Yearly_Greater_Than_Equal_To], [Volume_Yearly_Less_Than_Equal_To], [Volume_Quarterly_Greater_Than_Equal_To], [Volume_Quarterly_Less_Than_Equal_To], [Volume_Monthly_Greater_Than_Equal_To], [Volume_Monthly_Less_Than_Equal_To], [Volume_Weekly_Greater_Than_Equal_To], [Volume_Weekly_Less_Than_Equal_To], [Volume_Daily_Greater_Than_Equal_To], [Volume_Daily_Less_Than_Equal_To], [Volume_4_Hourly_Greater_Than_Equal_To], [Volume_4_Hourly_Less_Than_Equal_To], [Volume_1_Hourly_Greater_Than_Equal_To], [Volume_1_Hourly_Less_Than_Equal_To], [Volume_15_Minutes_Greater_Than_Equal_To], [Volume_15_Minutes_Less_Than_Equal_To], [Adx_Up_Tick_Yearly_Greater_Than_Equal_To], [Adx_Down_Tick_Yearly_Less_Than_Equal_To], [Adx_Up_Tick_Quarterly_Greater_Than_Equal_To], [Adx_Down_Tick_Quarterly_Less_Than_Equal_To], [Adx_Up_Tick_Monthly_Greater_Than_Equal_To], [Adx_Down_Tick_Monthly_Less_Than_Equal_To], [Adx_Up_Tick_Weekly_Greater_Than_Equal_To], [Adx_Down_Tick_Weekly_Less_Than_Equal_To], [Adx_Up_Tick_Daily_Greater_Than_Equal_To], [Adx_Down_Tick_Daily_Less_Than_Equal_To], [Adx_Up_Tick_4_Hourly_Greater_Than_Equal_To], [Adx_Down_Tick_4_Hourly_Less_Than_Equal_To], [Adx_Up_Tick_1_Hourly_Greater_Than_Equal_To], [Adx_Down_Tick_1_Hourly_Less_Than_Equal_To], [Adx_Up_Tick_15_Minutes_Greater_Than_Equal_To], [Adx_Down_Tick_15_Minutes_Less_Than_Equal_To]
...
from [dbo].[Analyse_Stocks_1]
;
select * from _sis.Master_Stocks_In_Segments order by sno;
...
insert into _sis.Analyse_Stocks_1
( [Batch_No], [Created_Date], [Stock_Name], [Segments], [Symbol], [% Chg], [Price], [Volume], [Bullish_Triple_Screen_Strong_Monthly], [Bullish_Triple_Screen_Strong_Weekly], [Bullish_Triple_Screen_Strong_Daily], [Bullish_Triple_Screen_Strong_4_Hourly], [Bullish_Triple_Screen_Strong_1_Hourly], [Bullish_Triple_Screen_Strong_15_Minutes], [Bullish_Triple_Screen_Strong_Correction_Monthly], [Bullish_Triple_Screen_Strong_Correction_Weekly], [Bullish_Triple_Screen_Strong_Correction_Daily], [Bullish_Triple_Screen_Strong_Correction_4_Hourly], [Bullish_Triple_Screen_Strong_Correction_1_Hourly], [Bullish_Triple_Screen_Strong_Correction_15_Minutes], [Bullish_Double_Screen_Strong_Quarterly], [Bullish_Double_Screen_Strong_Monthly], [Bullish_Double_Screen_Strong_Weekly], [Bullish_Double_Screen_Strong_Daily], [Bullish_Double_Screen_Strong_4_Hourly], [Bullish_Double_Screen_Strong_1_Hourly], [Bullish_Double_Screen_Strong_15_Minutes], [Bullish_Double_Screen_Strong_Correction_Quarterly], [Bullish_Double_Screen_Strong_Correction_Monthly], [Bullish_Double_Screen_Strong_Correction_Weekly], [Bullish_Double_Screen_Strong_Correction_Daily], [Bullish_Double_Screen_Strong_Correction_4_Hourly], [Bullish_Double_Screen_Strong_Correction_1_Hourly], [Bullish_Double_Screen_Strong_Correction_15_Minutes], [Bullish_Single_Screen_Yearly], [Bullish_Single_Screen_Quarterly], [Bullish_Single_Screen_Monthly], [Bullish_Single_Screen_Weekly], [Bullish_Single_Screen_Daily], [Bullish_Single_Screen_4_Hourly], [Bullish_Single_Screen_1_Hourly], [Bullish_Single_Screen_15_Minutes], [Bearish_Triple_Screen_Strong_Monthly], [Bearish_Triple_Screen_Strong_Weekly], [Bearish_Triple_Screen_Strong_Daily], [Bearish_Triple_Screen_Strong_4_Hourly], [Bearish_Triple_Screen_Strong_1_Hourly], [Bearish_Triple_Screen_Strong_15_Minutes], [Bearish_Triple_Screen_Strong_Correction_Monthly], [Bearish_Triple_Screen_Strong_Correction_Weekly], [Bearish_Triple_Screen_Strong_Correction_Daily], [Bearish_Triple_Screen_Strong_Correction_4_Hourly], [Bearish_Triple_Screen_Strong_Correction_1_Hourly], [Bearish_Triple_Screen_Strong_Correction_15_Minutes], [Bearish_Double_Screen_Strong_Quarterly], [Bearish_Double_Screen_Strong_Monthly], [Bearish_Double_Screen_Strong_Weekly], [Bearish_Double_Screen_Strong_Daily], [Bearish_Double_Screen_Strong_4_Hourly], [Bearish_Double_Screen_Strong_1_Hourly], [Bearish_Double_Screen_Strong_15_Minutes], [Bearish_Double_Screen_Strong_Correction_Quarterly], [Bearish_Double_Screen_Strong_Correction_Monthly], [Bearish_Double_Screen_Strong_Correction_Weekly], [Bearish_Double_Screen_Strong_Correction_Daily], [Bearish_Double_Screen_Strong_Correction_4_Hourly], [Bearish_Double_Screen_Strong_Correction_1_Hourly], [Bearish_Double_Screen_Strong_Correction_15_Minutes], [Bearish_Single_Screen_Yearly], [Bearish_Single_Screen_Quarterly], [Bearish_Single_Screen_Monthly], [Bearish_Single_Screen_Weekly], [Bearish_Single_Screen_Daily], [Bearish_Single_Screen_4_Hourly], [Bearish_Single_Screen_1_Hourly], [Bearish_Single_Screen_15_Minutes], [Macd_Yearly_Crosses_Above], [Macd_Yearly_Crosses_Below], [Macd_Quarterly_Crosses_Above], [Macd_Quarterly_Crosses_Below], [Macd_Monthly_Crosses_Above], [Macd_Monthly_Crosses_Below], [Macd_Weekly_Crosses_Above], [Macd_Weekly_Crosses_Below], [Macd_Daily_Crosses_Above], [Macd_Daily_Crosses_Below], [Macd_4_Hourly_Crosses_Above], [Macd_4_Hourly_Crosses_Below], [Macd_1_Hourly_Crosses_Above], [Macd_1_Hourly_Crosses_Below], [Macd_15_Minutes_Crosses_Above], [Macd_15_Minutes_Crosses_Below], [Stochastic_Yearly_Crosses_Above], [Stochastic_Yearly_Crosses_Below], [Stochastic_Quarterly_Crosses_Above], [Stochastic_Quarterly_Crosses_Below], [Stochastic_Monthly_Crosses_Above], [Stochastic_Monthly_Crosses_Below], [Stochastic_Weekly_Crosses_Above], [Stochastic_Weekly_Crosses_Below], [Stochastic_Daily_Crosses_Above], [Stochastic_Daily_Crosses_Below], [Stochastic_4_Hourly_Crosses_Above], [Stochastic_4_Hourly_Crosses_Below], [Stochastic_1_Hourly_Crosses_Above], [Stochastic_1_Hourly_Crosses_Below], [Stochastic_15_Minutes_Crosses_Above], [Stochastic_15_Minutes_Crosses_Below], [Ema_5_13_Yearly_Crosses_Above], [Ema_5_13_Yearly_Crosses_Below], [Ema_5_13_Quarterly_Crosses_Above], [Ema_5_13_Quarterly_Crosses_Below], [Ema_5_13_Monthly_Crosses_Above], [Ema_5_13_Monthly_Crosses_Below], [Ema_5_13_Weekly_Crosses_Above], [Ema_5_13_Weekly_Crosses_Below], [Ema_5_13_Daily_Crosses_Above], [Ema_5_13_Daily_Crosses_Below], [Ema_5_13_4_Hourly_Crosses_Above], [Ema_5_13_4_Hourly_Crosses_Below], [Ema_5_13_1_Hourly_Crosses_Above], [Ema_5_13_1_Hourly_Crosses_Below], [Ema_5_13_15_Minutes_Crosses_Above], [Ema_5_13_15_Minutes_Crosses_Below], [Ema_13_26_Yearly_Crosses_Above], [Ema_13_26_Yearly_Crosses_Below], [Ema_13_26_Quarterly_Crosses_Above], [Ema_13_26_Quarterly_Crosses_Below], [Ema_13_26_Monthly_Crosses_Above], [Ema_13_26_Monthly_Crosses_Below], [Ema_13_26_Weekly_Crosses_Above], [Ema_13_26_Weekly_Crosses_Below], [Ema_13_26_Daily_Crosses_Above], [Ema_13_26_Daily_Crosses_Below], [Ema_13_26_4_Hourly_Crosses_Above], [Ema_13_26_4_Hourly_Crosses_Below], [Ema_13_26_1_Hourly_Crosses_Above], [Ema_13_26_1_Hourly_Crosses_Below], [Ema_13_26_15_Minutes_Crosses_Above], [Ema_13_26_15_Minutes_Crosses_Below], [Ema_50_100_Yearly_Crosses_Above], [Ema_50_100_Yearly_Crosses_Below], [Ema_50_100_Quarterly_Crosses_Above], [Ema_50_100_Quarterly_Crosses_Below], [Ema_50_100_Monthly_Crosses_Above], [Ema_50_100_Monthly_Crosses_Below], [Ema_50_100_Weekly_Crosses_Above], [Ema_50_100_Weekly_Crosses_Below], [Ema_50_100_Daily_Crosses_Above], [Ema_50_100_Daily_Crosses_Below], [Ema_50_100_4_Hourly_Crosses_Above], [Ema_50_100_4_Hourly_Crosses_Below], [Ema_50_100_1_Hourly_Crosses_Above], [Ema_50_100_1_Hourly_Crosses_Below], [Ema_50_100_15_Minutes_Crosses_Above], [Ema_50_100_15_Minutes_Crosses_Below], [Ema_100_200_Yearly_Crosses_Above], [Ema_100_200_Yearly_Crosses_Below], [Ema_100_200_Quarterly_Crosses_Above], [Ema_100_200_Quarterly_Crosses_Below], [Ema_100_200_Monthly_Crosses_Above], [Ema_100_200_Monthly_Crosses_Below], [Ema_100_200_Weekly_Crosses_Above], [Ema_100_200_Weekly_Crosses_Below], [Ema_100_200_Daily_Crosses_Above], [Ema_100_200_Daily_Crosses_Below], [Ema_100_200_4_Hourly_Crosses_Above], [Ema_100_200_4_Hourly_Crosses_Below], [Ema_100_200_1_Hourly_Crosses_Above], [Ema_100_200_1_Hourly_Crosses_Below], [Ema_100_200_15_Minutes_Crosses_Above], [Ema_100_200_15_Minutes_Crosses_Below], [Adx_Yearly_Crosses_Above], [Adx_Yearly_Crosses_Below], [Adx_Quarterly_Crosses_Above], [Adx_Quarterly_Crosses_Below], [Adx_Monthly_Crosses_Above], [Adx_Monthly_Crosses_Below], [Adx_Weekly_Crosses_Above], [Adx_Weekly_Crosses_Below], [Adx_Daily_Crosses_Above], [Adx_Daily_Crosses_Below], [Adx_4_Hourly_Crosses_Above], [Adx_4_Hourly_Crosses_Below], [Adx_1_Hourly_Crosses_Above], [Adx_1_Hourly_Crosses_Below], [Adx_15_Minutes_Crosses_Above], [Adx_15_Minutes_Crosses_Below], [Rsi_Yearly_Crosses_Above], [Rsi_Yearly_Crosses_Below], [Rsi_Quarterly_Crosses_Above], [Rsi_Quarterly_Crosses_Below], [Rsi_Monthly_Crosses_Above], [Rsi_Monthly_Crosses_Below], [Rsi_Weekly_Crosses_Above], [Rsi_Weekly_Crosses_Below], [Rsi_Daily_Crosses_Above], [Rsi_Daily_Crosses_Below], [Rsi_4_Hourly_Crosses_Above], [Rsi_4_Hourly_Crosses_Below], [Rsi_1_Hourly_Crosses_Above], [Rsi_1_Hourly_Crosses_Below], [Rsi_15_Minutes_Crosses_Above], [Rsi_15_Minutes_Crosses_Below], [Upper_Bollinger_Band3_Yearly_Greater_Than_Equal_To], [Upper_Bollinger_Band3_Yearly_Less_Than_Equal_To], [Upper_Bollinger_Band3_Quarterly_Greater_Than_Equal_To], [Upper_Bollinger_Band3_Quarterly_Less_Than_Equal_To], [Upper_Bollinger_Band3_Monthly_Greater_Than_Equal_To], [Upper_Bollinger_Band3_Monthly_Less_Than_Equal_To], [Upper_Bollinger_Band3_Weekly_Greater_Than_Equal_To], [Upper_Bollinger_Band3_Weekly_Less_Than_Equal_To], [Upper_Bollinger_Band3_Daily_Greater_Than_Equal_To], [Upper_Bollinger_Band3_Daily_Less_Than_Equal_To], [Upper_Bollinger_Band3_4_Hourly_Greater_Than_Equal_To], [Upper_Bollinger_Band3_4_Hourly_Less_Than_Equal_To], [Upper_Bollinger_Band3_1_Hourly_Greater_Than_Equal_To], [Upper_Bollinger_Band3_1_Hourly_Less_Than_Equal_To], [Upper_Bollinger_Band3_15_Minutes_Greater_Than_Equal_To], [Upper_Bollinger_Band3_15_Minutes_Less_Than_Equal_To], [Lower_Bollinger_Band3_Yearly_Greater_Than_Equal_To], [Lower_Bollinger_Band3_Yearly_Less_Than_Equal_To], [Lower_Bollinger_Band3_Quarterly_Greater_Than_Equal_To], [Lower_Bollinger_Band3_Quarterly_Less_Than_Equal_To], [Lower_Bollinger_Band3_Monthly_Greater_Than_Equal_To], [Lower_Bollinger_Band3_Monthly_Less_Than_Equal_To], [Lower_Bollinger_Band3_Weekly_Greater_Than_Equal_To], [Lower_Bollinger_Band3_Weekly_Less_Than_Equal_To], [Lower_Bollinger_Band3_Daily_Greater_Than_Equal_To], [Lower_Bollinger_Band3_Daily_Less_Than_Equal_To], [Lower_Bollinger_Band3_4_Hourly_Greater_Than_Equal_To], [Lower_Bollinger_Band3_4_Hourly_Less_Than_Equal_To], [Lower_Bollinger_Band3_1_Hourly_Greater_Than_Equal_To], [Lower_Bollinger_Band3_1_Hourly_Less_Than_Equal_To], [Lower_Bollinger_Band3_15_Minutes_Greater_Than_Equal_To], [Lower_Bollinger_Band3_15_Minutes_Less_Than_Equal_To], [Upper_Bollinger_Band2_Yearly_Greater_Than_Equal_To], [Upper_Bollinger_Band2_Yearly_Less_Than_Equal_To], [Upper_Bollinger_Band2_Quarterly_Greater_Than_Equal_To], [Upper_Bollinger_Band2_Quarterly_Less_Than_Equal_To], [Upper_Bollinger_Band2_Monthly_Greater_Than_Equal_To], [Upper_Bollinger_Band2_Monthly_Less_Than_Equal_To], [Upper_Bollinger_Band2_Weekly_Greater_Than_Equal_To], [Upper_Bollinger_Band2_Weekly_Less_Than_Equal_To], [Upper_Bollinger_Band2_Daily_Greater_Than_Equal_To], [Upper_Bollinger_Band2_Daily_Less_Than_Equal_To], [Upper_Bollinger_Band2_4_Hourly_Greater_Than_Equal_To], [Upper_Bollinger_Band2_4_Hourly_Less_Than_Equal_To], [Upper_Bollinger_Band2_1_Hourly_Greater_Than_Equal_To], [Upper_Bollinger_Band2_1_Hourly_Less_Than_Equal_To], [Upper_Bollinger_Band2_15_Minutes_Greater_Than_Equal_To], [Upper_Bollinger_Band2_15_Minutes_Less_Than_Equal_To], [Lower_Bollinger_Band2_Yearly_Greater_Than_Equal_To], [Lower_Bollinger_Band2_Yearly_Less_Than_Equal_To], [Lower_Bollinger_Band2_Quarterly_Greater_Than_Equal_To], [Lower_Bollinger_Band2_Quarterly_Less_Than_Equal_To], [Lower_Bollinger_Band2_Monthly_Greater_Than_Equal_To], [Lower_Bollinger_Band2_Monthly_Less_Than_Equal_To], [Lower_Bollinger_Band2_Weekly_Greater_Than_Equal_To], [Lower_Bollinger_Band2_Weekly_Less_Than_Equal_To], [Lower_Bollinger_Band2_Daily_Greater_Than_Equal_To], [Lower_Bollinger_Band2_Daily_Less_Than_Equal_To], [Lower_Bollinger_Band2_4_Hourly_Greater_Than_Equal_To], [Lower_Bollinger_Band2_4_Hourly_Less_Than_Equal_To], [Lower_Bollinger_Band2_1_Hourly_Greater_Than_Equal_To], [Lower_Bollinger_Band2_1_Hourly_Less_Than_Equal_To], [Lower_Bollinger_Band2_15_Minutes_Greater_Than_Equal_To], [Lower_Bollinger_Band2_15_Minutes_Less_Than_Equal_To], [Volume_Yearly_Greater_Than_Equal_To], [Volume_Yearly_Less_Than_Equal_To], [Volume_Quarterly_Greater_Than_Equal_To], [Volume_Quarterly_Less_Than_Equal_To], [Volume_Monthly_Greater_Than_Equal_To], [Volume_Monthly_Less_Than_Equal_To], [Volume_Weekly_Greater_Than_Equal_To], [Volume_Weekly_Less_Than_Equal_To], [Volume_Daily_Greater_Than_Equal_To], [Volume_Daily_Less_Than_Equal_To], [Volume_4_Hourly_Greater_Than_Equal_To], [Volume_4_Hourly_Less_Than_Equal_To], [Volume_1_Hourly_Greater_Than_Equal_To], [Volume_1_Hourly_Less_Than_Equal_To], [Volume_15_Minutes_Greater_Than_Equal_To], [Volume_15_Minutes_Less_Than_Equal_To], [Adx_Up_Tick_Yearly_Greater_Than_Equal_To], [Adx_Down_Tick_Yearly_Less_Than_Equal_To], [Adx_Up_Tick_Quarterly_Greater_Than_Equal_To], [Adx_Down_Tick_Quarterly_Less_Than_Equal_To], [Adx_Up_Tick_Monthly_Greater_Than_Equal_To], [Adx_Down_Tick_Monthly_Less_Than_Equal_To], [Adx_Up_Tick_Weekly_Greater_Than_Equal_To], [Adx_Down_Tick_Weekly_Less_Than_Equal_To], [Adx_Up_Tick_Daily_Greater_Than_Equal_To], [Adx_Down_Tick_Daily_Less_Than_Equal_To], [Adx_Up_Tick_4_Hourly_Greater_Than_Equal_To], [Adx_Down_Tick_4_Hourly_Less_Than_Equal_To], [Adx_Up_Tick_1_Hourly_Greater_Than_Equal_To], [Adx_Down_Tick_1_Hourly_Less_Than_Equal_To], [Adx_Up_Tick_15_Minutes_Greater_Than_Equal_To], [Adx_Down_Tick_15_Minutes_Less_Than_Equal_To])
select [Batch_No], [Created_Date], [Stock_Name], [Segments], [Symbol], [% Chg], [Price], [Volume], [Bullish_Triple_Screen_Strong_Monthly], [Bullish_Triple_Screen_Strong_Weekly], [Bullish_Triple_Screen_Strong_Daily], [Bullish_Triple_Screen_Strong_4_Hourly], [Bullish_Triple_Screen_Strong_1_Hourly], [Bullish_Triple_Screen_Strong_15_Minutes], [Bullish_Triple_Screen_Strong_Correction_Monthly], [Bullish_Triple_Screen_Strong_Correction_Weekly], [Bullish_Triple_Screen_Strong_Correction_Daily], [Bullish_Triple_Screen_Strong_Correction_4_Hourly], [Bullish_Triple_Screen_Strong_Correction_1_Hourly], [Bullish_Triple_Screen_Strong_Correction_15_Minutes], [Bullish_Double_Screen_Strong_Quarterly], [Bullish_Double_Screen_Strong_Monthly], [Bullish_Double_Screen_Strong_Weekly], [Bullish_Double_Screen_Strong_Daily], [Bullish_Double_Screen_Strong_4_Hourly], [Bullish_Double_Screen_Strong_1_Hourly], [Bullish_Double_Screen_Strong_15_Minutes], [Bullish_Double_Screen_Strong_Correction_Quarterly], [Bullish_Double_Screen_Strong_Correction_Monthly], [Bullish_Double_Screen_Strong_Correction_Weekly], [Bullish_Double_Screen_Strong_Correction_Daily], [Bullish_Double_Screen_Strong_Correction_4_Hourly], [Bullish_Double_Screen_Strong_Correction_1_Hourly], [Bullish_Double_Screen_Strong_Correction_15_Minutes], [Bullish_Single_Screen_Yearly], [Bullish_Single_Screen_Quarterly], [Bullish_Single_Screen_Monthly], [Bullish_Single_Screen_Weekly], [Bullish_Single_Screen_Daily], [Bullish_Single_Screen_4_Hourly], [Bullish_Single_Screen_1_Hourly], [Bullish_Single_Screen_15_Minutes], [Bearish_Triple_Screen_Strong_Monthly], [Bearish_Triple_Screen_Strong_Weekly], [Bearish_Triple_Screen_Strong_Daily], [Bearish_Triple_Screen_Strong_4_Hourly], [Bearish_Triple_Screen_Strong_1_Hourly], [Bearish_Triple_Screen_Strong_15_Minutes], [Bearish_Triple_Screen_Strong_Correction_Monthly], [Bearish_Triple_Screen_Strong_Correction_Weekly], [Bearish_Triple_Screen_Strong_Correction_Daily], [Bearish_Triple_Screen_Strong_Correction_4_Hourly], [Bearish_Triple_Screen_Strong_Correction_1_Hourly], [Bearish_Triple_Screen_Strong_Correction_15_Minutes], [Bearish_Double_Screen_Strong_Quarterly], [Bearish_Double_Screen_Strong_Monthly], [Bearish_Double_Screen_Strong_Weekly], [Bearish_Double_Screen_Strong_Daily], [Bearish_Double_Screen_Strong_4_Hourly], [Bearish_Double_Screen_Strong_1_Hourly], [Bearish_Double_Screen_Strong_15_Minutes], [Bearish_Double_Screen_Strong_Correction_Quarterly], [Bearish_Double_Screen_Strong_Correction_Monthly], [Bearish_Double_Screen_Strong_Correction_Weekly], [Bearish_Double_Screen_Strong_Correction_Daily], [Bearish_Double_Screen_Strong_Correction_4_Hourly], [Bearish_Double_Screen_Strong_Correction_1_Hourly], [Bearish_Double_Screen_Strong_Correction_15_Minutes], [Bearish_Single_Screen_Yearly], [Bearish_Single_Screen_Quarterly], [Bearish_Single_Screen_Monthly], [Bearish_Single_Screen_Weekly], [Bearish_Single_Screen_Daily], [Bearish_Single_Screen_4_Hourly], [Bearish_Single_Screen_1_Hourly], [Bearish_Single_Screen_15_Minutes], [Macd_Yearly_Crosses_Above], [Macd_Yearly_Crosses_Below], [Macd_Quarterly_Crosses_Above], [Macd_Quarterly_Crosses_Below], [Macd_Monthly_Crosses_Above], [Macd_Monthly_Crosses_Below], [Macd_Weekly_Crosses_Above], [Macd_Weekly_Crosses_Below], [Macd_Daily_Crosses_Above], [Macd_Daily_Crosses_Below], [Macd_4_Hourly_Crosses_Above], [Macd_4_Hourly_Crosses_Below], [Macd_1_Hourly_Crosses_Above], [Macd_1_Hourly_Crosses_Below], [Macd_15_Minutes_Crosses_Above], [Macd_15_Minutes_Crosses_Below], [Stochastic_Yearly_Crosses_Above], [Stochastic_Yearly_Crosses_Below], [Stochastic_Quarterly_Crosses_Above], [Stochastic_Quarterly_Crosses_Below], [Stochastic_Monthly_Crosses_Above], [Stochastic_Monthly_Crosses_Below], [Stochastic_Weekly_Crosses_Above], [Stochastic_Weekly_Crosses_Below], [Stochastic_Daily_Crosses_Above], [Stochastic_Daily_Crosses_Below], [Stochastic_4_Hourly_Crosses_Above], [Stochastic_4_Hourly_Crosses_Below], [Stochastic_1_Hourly_Crosses_Above], [Stochastic_1_Hourly_Crosses_Below], [Stochastic_15_Minutes_Crosses_Above], [Stochastic_15_Minutes_Crosses_Below], [Ema_5_13_Yearly_Crosses_Above], [Ema_5_13_Yearly_Crosses_Below], [Ema_5_13_Quarterly_Crosses_Above], [Ema_5_13_Quarterly_Crosses_Below], [Ema_5_13_Monthly_Crosses_Above], [Ema_5_13_Monthly_Crosses_Below], [Ema_5_13_Weekly_Crosses_Above], [Ema_5_13_Weekly_Crosses_Below], [Ema_5_13_Daily_Crosses_Above], [Ema_5_13_Daily_Crosses_Below], [Ema_5_13_4_Hourly_Crosses_Above], [Ema_5_13_4_Hourly_Crosses_Below], [Ema_5_13_1_Hourly_Crosses_Above], [Ema_5_13_1_Hourly_Crosses_Below], [Ema_5_13_15_Minutes_Crosses_Above], [Ema_5_13_15_Minutes_Crosses_Below], [Ema_13_26_Yearly_Crosses_Above], [Ema_13_26_Yearly_Crosses_Below], [Ema_13_26_Quarterly_Crosses_Above], [Ema_13_26_Quarterly_Crosses_Below], [Ema_13_26_Monthly_Crosses_Above], [Ema_13_26_Monthly_Crosses_Below], [Ema_13_26_Weekly_Crosses_Above], [Ema_13_26_Weekly_Crosses_Below], [Ema_13_26_Daily_Crosses_Above], [Ema_13_26_Daily_Crosses_Below], [Ema_13_26_4_Hourly_Crosses_Above], [Ema_13_26_4_Hourly_Crosses_Below], [Ema_13_26_1_Hourly_Crosses_Above], [Ema_13_26_1_Hourly_Crosses_Below], [Ema_13_26_15_Minutes_Crosses_Above], [Ema_13_26_15_Minutes_Crosses_Below], [Ema_50_100_Yearly_Crosses_Above], [Ema_50_100_Yearly_Crosses_Below], [Ema_50_100_Quarterly_Crosses_Above], [Ema_50_100_Quarterly_Crosses_Below], [Ema_50_100_Monthly_Crosses_Above], [Ema_50_100_Monthly_Crosses_Below], [Ema_50_100_Weekly_Crosses_Above], [Ema_50_100_Weekly_Crosses_Below], [Ema_50_100_Daily_Crosses_Above], [Ema_50_100_Daily_Crosses_Below], [Ema_50_100_4_Hourly_Crosses_Above], [Ema_50_100_4_Hourly_Crosses_Below], [Ema_50_100_1_Hourly_Crosses_Above], [Ema_50_100_1_Hourly_Crosses_Below], [Ema_50_100_15_Minutes_Crosses_Above], [Ema_50_100_15_Minutes_Crosses_Below], [Ema_100_200_Yearly_Crosses_Above], [Ema_100_200_Yearly_Crosses_Below], [Ema_100_200_Quarterly_Crosses_Above], [Ema_100_200_Quarterly_Crosses_Below], [Ema_100_200_Monthly_Crosses_Above], [Ema_100_200_Monthly_Crosses_Below], [Ema_100_200_Weekly_Crosses_Above], [Ema_100_200_Weekly_Crosses_Below], [Ema_100_200_Daily_Crosses_Above], [Ema_100_200_Daily_Crosses_Below], [Ema_100_200_4_Hourly_Crosses_Above], [Ema_100_200_4_Hourly_Crosses_Below], [Ema_100_200_1_Hourly_Crosses_Above], [Ema_100_200_1_Hourly_Crosses_Below], [Ema_100_200_15_Minutes_Crosses_Above], [Ema_100_200_15_Minutes_Crosses_Below], [Adx_Yearly_Crosses_Above], [Adx_Yearly_Crosses_Below], [Adx_Quarterly_Crosses_Above], [Adx_Quarterly_Crosses_Below], [Adx_Monthly_Crosses_Above], [Adx_Monthly_Crosses_Below], [Adx_Weekly_Crosses_Above], [Adx_Weekly_Crosses_Below], [Adx_Daily_Crosses_Above], [Adx_Daily_Crosses_Below], [Adx_4_Hourly_Crosses_Above], [Adx_4_Hourly_Crosses_Below], [Adx_1_Hourly_Crosses_Above], [Adx_1_Hourly_Crosses_Below], [Adx_15_Minutes_Crosses_Above], [Adx_15_Minutes_Crosses_Below], [Rsi_Yearly_Crosses_Above], [Rsi_Yearly_Crosses_Below], [Rsi_Quarterly_Crosses_Above], [Rsi_Quarterly_Crosses_Below], [Rsi_Monthly_Crosses_Above], [Rsi_Monthly_Crosses_Below], [Rsi_Weekly_Crosses_Above], [Rsi_Weekly_Crosses_Below], [Rsi_Daily_Crosses_Above], [Rsi_Daily_Crosses_Below], [Rsi_4_Hourly_Crosses_Above], [Rsi_4_Hourly_Crosses_Below], [Rsi_1_Hourly_Crosses_Above], [Rsi_1_Hourly_Crosses_Below], [Rsi_15_Minutes_Crosses_Above], [Rsi_15_Minutes_Crosses_Below], [Upper_Bollinger_Band3_Yearly_Greater_Than_Equal_To], [Upper_Bollinger_Band3_Yearly_Less_Than_Equal_To], [Upper_Bollinger_Band3_Quarterly_Greater_Than_Equal_To], [Upper_Bollinger_Band3_Quarterly_Less_Than_Equal_To], [Upper_Bollinger_Band3_Monthly_Greater_Than_Equal_To], [Upper_Bollinger_Band3_Monthly_Less_Than_Equal_To], [Upper_Bollinger_Band3_Weekly_Greater_Than_Equal_To], [Upper_Bollinger_Band3_Weekly_Less_Than_Equal_To], [Upper_Bollinger_Band3_Daily_Greater_Than_Equal_To], [Upper_Bollinger_Band3_Daily_Less_Than_Equal_To], [Upper_Bollinger_Band3_4_Hourly_Greater_Than_Equal_To], [Upper_Bollinger_Band3_4_Hourly_Less_Than_Equal_To], [Upper_Bollinger_Band3_1_Hourly_Greater_Than_Equal_To], [Upper_Bollinger_Band3_1_Hourly_Less_Than_Equal_To], [Upper_Bollinger_Band3_15_Minutes_Greater_Than_Equal_To], [Upper_Bollinger_Band3_15_Minutes_Less_Than_Equal_To], [Lower_Bollinger_Band3_Yearly_Greater_Than_Equal_To], [Lower_Bollinger_Band3_Yearly_Less_Than_Equal_To], [Lower_Bollinger_Band3_Quarterly_Greater_Than_Equal_To], [Lower_Bollinger_Band3_Quarterly_Less_Than_Equal_To], [Lower_Bollinger_Band3_Monthly_Greater_Than_Equal_To], [Lower_Bollinger_Band3_Monthly_Less_Than_Equal_To], [Lower_Bollinger_Band3_Weekly_Greater_Than_Equal_To], [Lower_Bollinger_Band3_Weekly_Less_Than_Equal_To], [Lower_Bollinger_Band3_Daily_Greater_Than_Equal_To], [Lower_Bollinger_Band3_Daily_Less_Than_Equal_To], [Lower_Bollinger_Band3_4_Hourly_Greater_Than_Equal_To], [Lower_Bollinger_Band3_4_Hourly_Less_Than_Equal_To], [Lower_Bollinger_Band3_1_Hourly_Greater_Than_Equal_To], [Lower_Bollinger_Band3_1_Hourly_Less_Than_Equal_To], [Lower_Bollinger_Band3_15_Minutes_Greater_Than_Equal_To], [Lower_Bollinger_Band3_15_Minutes_Less_Than_Equal_To], [Upper_Bollinger_Band2_Yearly_Greater_Than_Equal_To], [Upper_Bollinger_Band2_Yearly_Less_Than_Equal_To], [Upper_Bollinger_Band2_Quarterly_Greater_Than_Equal_To], [Upper_Bollinger_Band2_Quarterly_Less_Than_Equal_To], [Upper_Bollinger_Band2_Monthly_Greater_Than_Equal_To], [Upper_Bollinger_Band2_Monthly_Less_Than_Equal_To], [Upper_Bollinger_Band2_Weekly_Greater_Than_Equal_To], [Upper_Bollinger_Band2_Weekly_Less_Than_Equal_To], [Upper_Bollinger_Band2_Daily_Greater_Than_Equal_To], [Upper_Bollinger_Band2_Daily_Less_Than_Equal_To], [Upper_Bollinger_Band2_4_Hourly_Greater_Than_Equal_To], [Upper_Bollinger_Band2_4_Hourly_Less_Than_Equal_To], [Upper_Bollinger_Band2_1_Hourly_Greater_Than_Equal_To], [Upper_Bollinger_Band2_1_Hourly_Less_Than_Equal_To], [Upper_Bollinger_Band2_15_Minutes_Greater_Than_Equal_To], [Upper_Bollinger_Band2_15_Minutes_Less_Than_Equal_To], [Lower_Bollinger_Band2_Yearly_Greater_Than_Equal_To], [Lower_Bollinger_Band2_Yearly_Less_Than_Equal_To], [Lower_Bollinger_Band2_Quarterly_Greater_Than_Equal_To], [Lower_Bollinger_Band2_Quarterly_Less_Than_Equal_To], [Lower_Bollinger_Band2_Monthly_Greater_Than_Equal_To], [Lower_Bollinger_Band2_Monthly_Less_Than_Equal_To], [Lower_Bollinger_Band2_Weekly_Greater_Than_Equal_To], [Lower_Bollinger_Band2_Weekly_Less_Than_Equal_To], [Lower_Bollinger_Band2_Daily_Greater_Than_Equal_To], [Lower_Bollinger_Band2_Daily_Less_Than_Equal_To], [Lower_Bollinger_Band2_4_Hourly_Greater_Than_Equal_To], [Lower_Bollinger_Band2_4_Hourly_Less_Than_Equal_To], [Lower_Bollinger_Band2_1_Hourly_Greater_Than_Equal_To], [Lower_Bollinger_Band2_1_Hourly_Less_Than_Equal_To], [Lower_Bollinger_Band2_15_Minutes_Greater_Than_Equal_To], [Lower_Bollinger_Band2_15_Minutes_Less_Than_Equal_To], [Volume_Yearly_Greater_Than_Equal_To], [Volume_Yearly_Less_Than_Equal_To], [Volume_Quarterly_Greater_Than_Equal_To], [Volume_Quarterly_Less_Than_Equal_To], [Volume_Monthly_Greater_Than_Equal_To], [Volume_Monthly_Less_Than_Equal_To], [Volume_Weekly_Greater_Than_Equal_To], [Volume_Weekly_Less_Than_Equal_To], [Volume_Daily_Greater_Than_Equal_To], [Volume_Daily_Less_Than_Equal_To], [Volume_4_Hourly_Greater_Than_Equal_To], [Volume_4_Hourly_Less_Than_Equal_To], [Volume_1_Hourly_Greater_Than_Equal_To], [Volume_1_Hourly_Less_Than_Equal_To], [Volume_15_Minutes_Greater_Than_Equal_To], [Volume_15_Minutes_Less_Than_Equal_To], [Adx_Up_Tick_Yearly_Greater_Than_Equal_To], [Adx_Down_Tick_Yearly_Less_Than_Equal_To], [Adx_Up_Tick_Quarterly_Greater_Than_Equal_To], [Adx_Down_Tick_Quarterly_Less_Than_Equal_To], [Adx_Up_Tick_Monthly_Greater_Than_Equal_To], [Adx_Down_Tick_Monthly_Less_Than_Equal_To], [Adx_Up_Tick_Weekly_Greater_Than_Equal_To], [Adx_Down_Tick_Weekly_Less_Than_Equal_To], [Adx_Up_Tick_Daily_Greater_Than_Equal_To], [Adx_Down_Tick_Daily_Less_Than_Equal_To], [Adx_Up_Tick_4_Hourly_Greater_Than_Equal_To], [Adx_Down_Tick_4_Hourly_Less_Than_Equal_To], [Adx_Up_Tick_1_Hourly_Greater_Than_Equal_To], [Adx_Down_Tick_1_Hourly_Less_Than_Equal_To], [Adx_Up_Tick_15_Minutes_Greater_Than_Equal_To], [Adx_Down_Tick_15_Minutes_Less_Than_Equal_To]
from _sis.Analyse_Stocks
;
-- ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
from _sis.Analyse_Stocks a where a.Bullish_Triple_Screen_Strong_Monthly = 1
;
select * 
-- update a set a.Bullish_Triple_Screen_Strong_Weekly = 340 
from _sis.Analyse_Stocks a where a.Bullish_Triple_Screen_Strong_Weekly = 1
;
select * 
-- update a set a.Bullish_Triple_Screen_Strong_Daily = 330 
from _sis.Analyse_Stocks a where a.Bullish_Triple_Screen_Strong_Daily = 1
;
select * 
-- update a set a.Bullish_Triple_Screen_Strong_4_Hourly = 320 
from _sis.Analyse_Stocks a where a.Bullish_Triple_Screen_Strong_4_Hourly = 1
;
select * 
-- update a set a.Bullish_Triple_Screen_Strong_1_Hourly = 310 
from _sis.Analyse_Stocks a where a.Bullish_Triple_Screen_Strong_1_Hourly = 1
;
select * 
-- update a set a.Bullish_Triple_Screen_Strong_15_Minutes = 310 
from _sis.Analyse_Stocks a where a.Bullish_Triple_Screen_Strong_15_Minutes = 1
;
-- ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
select * 
-- update a set a.[Sum of Screens]= isnull(Bullish_Triple_Screen_Strong_Monthly,0)+isnull(Bullish_Triple_Screen_Strong_Weekly,0)+isnull(Bullish_Triple_Screen_Strong_Daily,0)+isnull(Bullish_Triple_Screen_Strong_4_Hourly,0)+isnull(Bullish_Triple_Screen_Strong_1_Hourly,0)+isnull(Bullish_Triple_Screen_Strong_15_Minutes,0)
from _sis.Analyse_Stocks a ;
update a set a.[Length of Segments] = len(a.Segments) from _sis.Analyse_Stocks a ;
select * from _sis.Analyse_Stocks a 
where Batch_No >=10 and a.[Sum of Screens] > 0 and a.[Length of Segments] > 10
order by a.[Sum of Screens] desc,a.[Length of Segments] desc,Batch_No desc
;
-- ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
select * 
from _sis.Analyse_Stocks
where [Sum of Screens] > 10 and [Length of Segments] > 10 
and Batch_No = (select max(batch_no) from _sis.Analyse_Stocks)
order by Batch_No desc,[Sum of Screens] desc;

select distinct Batch_No,[Sum of Screens],Stock_Name,Segments,Symbol,[% Chg],Price,Volume
from _sis.Analyse_15Minutes_Stocks 
where [Sum of Screens] > 10 and [Length of Segments] > 10 
and Batch_No = (select max(batch_no) from _sis.Analyse_15Minutes_Stocks)
order by Batch_No desc,[Sum of Screens] desc;


select * 
-- update a set [Trade Type] = isnull([Trade Type],'') + 'Bullish;', [Trade Type Details] = isnull([Trade Type Details],'') + 'Bullish - Strong Triple Screen;'
from [_sis].[Analyse_Stocks] a where 
...
select * 
-- update a set [Trade Type] = isnull([Trade Type],'') + 'Bullish;', [Trade Type Details] = isnull([Trade Type Details],'') + 'Bullish - Strong Triple Screen Correction;'
from [_sis].[Analyse_Stocks] a where 
...
;
select * 
-- update a set [Trade Type] = isnull([Trade Type],'') + 'Bullish;', [Trade Type Details] = isnull([Trade Type Details],'') + 'Bullish - Strong Double Screen;'
from [_sis].[Analyse_Stocks] a where 
...
;
select * 
-- update a set [Trade Type] = isnull([Trade Type],'') + 'Bullish;', [Trade Type Details] = isnull([Trade Type Details],'') + 'Bullish - Strong Double Screen Correction;'
from [_sis].[Analyse_Stocks] a where 
...
;
select * 
-- update a set [Trade Type] = isnull([Trade Type],'') + 'Bullish;', [Trade Type Details] = isnull([Trade Type Details],'') + 'Bullish - Single Screen;'
from [_sis].[Analyse_Stocks] a where 
...
;
select * 
-- update a set [Trade Type] = isnull([Trade Type],'') + 'Bearish;', [Trade Type Details] = isnull([Trade Type Details],'') + 'Bearish - Strong Triple Screen;'
from [_sis].[Analyse_Stocks] a where 
...
;
select * 
-- update a set [Trade Type] = isnull([Trade Type],'') + 'Bearish;', [Trade Type Details] = isnull([Trade Type Details],'') + 'Bearish - Strong Triple Screen Correction;'
from [_sis].[Analyse_Stocks] a where 
...
;
select * 
-- update a set [Trade Type] = isnull([Trade Type],'') + 'Bearish;',[Trade Type Details] = isnull([Trade Type Details],'') + 'Bearish - Strong Double Screen;'
from [_sis].[Analyse_Stocks] a where 
...
;
select * 
-- update a set [Trade Type] = isnull([Trade Type],'') + 'Bearish;',[Trade Type Details] = isnull([Trade Type Details],'') + 'Bearish - Strong Double Screen Correction;'
from [_sis].[Analyse_Stocks] a where 
...
;
select * 
-- update a set [Trade Type] = isnull([Trade Type],'') + 'Bearish;',[Trade Type Details] = isnull([Trade Type Details],'') + 'Bearish - Single Screen;'
from [_sis].[Analyse_Stocks] a where 
...
;
-- insert into [_sis].[Analyse_15Minutes_Stocks] ( [Batch_No], [Sum of Screens], [Length of Segments],[Trade Type], [Trade Type Details], [Length of Trade Type], [Length of Trade Type Details], [Created_Date], [Stock_Name], [Segments], [Symbol], [% Chg], [Price], [Volume], [Bullish_Triple_Screen_Strong_Monthly], [Bullish_Triple_Screen_Strong_Weekly], [Bullish_Triple_Screen_Strong_Daily], [Bullish_Triple_Screen_Strong_4_Hourly], [Bullish_Triple_Screen_Strong_1_Hourly], [Bullish_Triple_Screen_Strong_15_Minutes], [Bullish_Triple_Screen_Strong_Correction_Monthly], [Bullish_Triple_Screen_Strong_Correction_Weekly], [Bullish_Triple_Screen_Strong_Correction_Daily], [Bullish_Triple_Screen_Strong_Correction_4_Hourly], [Bullish_Triple_Screen_Strong_Correction_1_Hourly], [Bullish_Triple_Screen_Strong_Correction_15_Minutes], [Bullish_Double_Screen_Strong_Quarterly], [Bullish_Double_Screen_Strong_Monthly], [Bullish_Double_Screen_Strong_Weekly], [Bullish_Double_Screen_Strong_Daily], [Bullish_Double_Screen_Strong_4_Hourly], [Bullish_Double_Screen_Strong_1_Hourly], [Bullish_Double_Screen_Strong_15_Minutes], [Bullish_Double_Screen_Strong_Correction_Quarterly], [Bullish_Double_Screen_Strong_Correction_Monthly], [Bullish_Double_Screen_Strong_Correction_Weekly], [Bullish_Double_Screen_Strong_Correction_Daily], [Bullish_Double_Screen_Strong_Correction_4_Hourly], [Bullish_Double_Screen_Strong_Correction_1_Hourly], [Bullish_Double_Screen_Strong_Correction_15_Minutes], [Bullish_Single_Screen_Yearly], [Bullish_Single_Screen_Quarterly], [Bullish_Single_Screen_Monthly], [Bullish_Single_Screen_Weekly], [Bullish_Single_Screen_Daily], [Bullish_Single_Screen_4_Hourly], [Bullish_Single_Screen_1_Hourly], [Bullish_Single_Screen_15_Minutes], [Bearish_Triple_Screen_Strong_Monthly], [Bearish_Triple_Screen_Strong_Weekly], [Bearish_Triple_Screen_Strong_Daily], [Bearish_Triple_Screen_Strong_4_Hourly], [Bearish_Triple_Screen_Strong_1_Hourly], [Bearish_Triple_Screen_Strong_15_Minutes], [Bearish_Triple_Screen_Strong_Correction_Monthly], [Bearish_Triple_Screen_Strong_Correction_Weekly], [Bearish_Triple_Screen_Strong_Correction_Daily], [Bearish_Triple_Screen_Strong_Correction_4_Hourly], [Bearish_Triple_Screen_Strong_Correction_1_Hourly], [Bearish_Triple_Screen_Strong_Correction_15_Minutes], [Bearish_Double_Screen_Strong_Quarterly], [Bearish_Double_Screen_Strong_Monthly], [Bearish_Double_Screen_Strong_Weekly], [Bearish_Double_Screen_Strong_Daily], [Bearish_Double_Screen_Strong_4_Hourly], [Bearish_Double_Screen_Strong_1_Hourly], [Bearish_Double_Screen_Strong_15_Minutes], [Bearish_Double_Screen_Strong_Correction_Quarterly], [Bearish_Double_Screen_Strong_Correction_Monthly], [Bearish_Double_Screen_Strong_Correction_Weekly], [Bearish_Double_Screen_Strong_Correction_Daily], [Bearish_Double_Screen_Strong_Correction_4_Hourly], [Bearish_Double_Screen_Strong_Correction_1_Hourly], [Bearish_Double_Screen_Strong_Correction_15_Minutes], [Bearish_Single_Screen_Yearly], [Bearish_Single_Screen_Quarterly], [Bearish_Single_Screen_Monthly], [Bearish_Single_Screen_Weekly], [Bearish_Single_Screen_Daily], [Bearish_Single_Screen_4_Hourly], [Bearish_Single_Screen_1_Hourly], [Bearish_Single_Screen_15_Minutes], [Macd_Yearly_Crosses_Above], [Macd_Yearly_Crosses_Below], [Macd_Quarterly_Crosses_Above], [Macd_Quarterly_Crosses_Below], [Macd_Monthly_Crosses_Above], [Macd_Monthly_Crosses_Below], [Macd_Weekly_Crosses_Above], [Macd_Weekly_Crosses_Below], [Macd_Daily_Crosses_Above], [Macd_Daily_Crosses_Below], [Macd_4_Hourly_Crosses_Above], [Macd_4_Hourly_Crosses_Below], [Macd_1_Hourly_Crosses_Above], [Macd_1_Hourly_Crosses_Below], [Macd_15_Minutes_Crosses_Above], [Macd_15_Minutes_Crosses_Below], [Stochastic_Yearly_Crosses_Above], [Stochastic_Yearly_Crosses_Below], [Stochastic_Quarterly_Crosses_Above], [Stochastic_Quarterly_Crosses_Below], [Stochastic_Monthly_Crosses_Above], [Stochastic_Monthly_Crosses_Below], [Stochastic_Weekly_Crosses_Above], [Stochastic_Weekly_Crosses_Below], [Stochastic_Daily_Crosses_Above], [Stochastic_Daily_Crosses_Below], [Stochastic_4_Hourly_Crosses_Above], [Stochastic_4_Hourly_Crosses_Below], [Stochastic_1_Hourly_Crosses_Above], [Stochastic_1_Hourly_Crosses_Below], [Stochastic_15_Minutes_Crosses_Above], [Stochastic_15_Minutes_Crosses_Below], [Ema_5_13_Yearly_Crosses_Above], [Ema_5_13_Yearly_Crosses_Below], [Ema_5_13_Quarterly_Crosses_Above], [Ema_5_13_Quarterly_Crosses_Below], [Ema_5_13_Monthly_Crosses_Above], [Ema_5_13_Monthly_Crosses_Below], [Ema_5_13_Weekly_Crosses_Above], [Ema_5_13_Weekly_Crosses_Below], [Ema_5_13_Daily_Crosses_Above], [Ema_5_13_Daily_Crosses_Below], [Ema_5_13_4_Hourly_Crosses_Above], [Ema_5_13_4_Hourly_Crosses_Below], [Ema_5_13_1_Hourly_Crosses_Above], [Ema_5_13_1_Hourly_Crosses_Below], [Ema_5_13_15_Minutes_Crosses_Above], [Ema_5_13_15_Minutes_Crosses_Below], [Ema_13_26_Yearly_Crosses_Above], [Ema_13_26_Yearly_Crosses_Below], [Ema_13_26_Quarterly_Crosses_Above], [Ema_13_26_Quarterly_Crosses_Below], [Ema_13_26_Monthly_Crosses_Above], [Ema_13_26_Monthly_Crosses_Below], [Ema_13_26_Weekly_Crosses_Above], [Ema_13_26_Weekly_Crosses_Below], [Ema_13_26_Daily_Crosses_Above], [Ema_13_26_Daily_Crosses_Below], [Ema_13_26_4_Hourly_Crosses_Above], [Ema_13_26_4_Hourly_Crosses_Below], [Ema_13_26_1_Hourly_Crosses_Above], [Ema_13_26_1_Hourly_Crosses_Below], [Ema_13_26_15_Minutes_Crosses_Above], [Ema_13_26_15_Minutes_Crosses_Below], [Ema_50_100_Yearly_Crosses_Above], [Ema_50_100_Yearly_Crosses_Below], [Ema_50_100_Quarterly_Crosses_Above], [Ema_50_100_Quarterly_Crosses_Below], [Ema_50_100_Monthly_Crosses_Above], [Ema_50_100_Monthly_Crosses_Below], [Ema_50_100_Weekly_Crosses_Above], [Ema_50_100_Weekly_Crosses_Below], [Ema_50_100_Daily_Crosses_Above], [Ema_50_100_Daily_Crosses_Below], [Ema_50_100_4_Hourly_Crosses_Above], [Ema_50_100_4_Hourly_Crosses_Below], [Ema_50_100_1_Hourly_Crosses_Above], [Ema_50_100_1_Hourly_Crosses_Below], [Ema_50_100_15_Minutes_Crosses_Above], [Ema_50_100_15_Minutes_Crosses_Below], [Ema_100_200_Yearly_Crosses_Above], [Ema_100_200_Yearly_Crosses_Below], [Ema_100_200_Quarterly_Crosses_Above], [Ema_100_200_Quarterly_Crosses_Below], [Ema_100_200_Monthly_Crosses_Above], [Ema_100_200_Monthly_Crosses_Below], [Ema_100_200_Weekly_Crosses_Above], [Ema_100_200_Weekly_Crosses_Below], [Ema_100_200_Daily_Crosses_Above], [Ema_100_200_Daily_Crosses_Below], [Ema_100_200_4_Hourly_Crosses_Above], [Ema_100_200_4_Hourly_Crosses_Below], [Ema_100_200_1_Hourly_Crosses_Above], [Ema_100_200_1_Hourly_Crosses_Below], [Ema_100_200_15_Minutes_Crosses_Above], [Ema_100_200_15_Minutes_Crosses_Below], [Adx_Yearly_Crosses_Above], [Adx_Yearly_Crosses_Below], [Adx_Quarterly_Crosses_Above], [Adx_Quarterly_Crosses_Below], [Adx_Monthly_Crosses_Above], [Adx_Monthly_Crosses_Below], [Adx_Weekly_Crosses_Above], [Adx_Weekly_Crosses_Below], [Adx_Daily_Crosses_Above], [Adx_Daily_Crosses_Below], [Adx_4_Hourly_Crosses_Above], [Adx_4_Hourly_Crosses_Below], [Adx_1_Hourly_Crosses_Above], [Adx_1_Hourly_Crosses_Below], [Adx_15_Minutes_Crosses_Above], [Adx_15_Minutes_Crosses_Below], [Rsi_Yearly_Crosses_Above], [Rsi_Yearly_Crosses_Below], [Rsi_Quarterly_Crosses_Above], [Rsi_Quarterly_Crosses_Below], [Rsi_Monthly_Crosses_Above], [Rsi_Monthly_Crosses_Below], [Rsi_Weekly_Crosses_Above], [Rsi_Weekly_Crosses_Below], [Rsi_Daily_Crosses_Above], [Rsi_Daily_Crosses_Below], [Rsi_4_Hourly_Crosses_Above], [Rsi_4_Hourly_Crosses_Below], [Rsi_1_Hourly_Crosses_Above], [Rsi_1_Hourly_Crosses_Below], [Rsi_15_Minutes_Crosses_Above], [Rsi_15_Minutes_Crosses_Below], [Upper_Bollinger_Band3_Yearly_Greater_Than_Equal_To], [Upper_Bollinger_Band3_Yearly_Less_Than_Equal_To], [Upper_Bollinger_Band3_Quarterly_Greater_Than_Equal_To], [Upper_Bollinger_Band3_Quarterly_Less_Than_Equal_To], [Upper_Bollinger_Band3_Monthly_Greater_Than_Equal_To], [Upper_Bollinger_Band3_Monthly_Less_Than_Equal_To], [Upper_Bollinger_Band3_Weekly_Greater_Than_Equal_To], [Upper_Bollinger_Band3_Weekly_Less_Than_Equal_To], [Upper_Bollinger_Band3_Daily_Greater_Than_Equal_To], [Upper_Bollinger_Band3_Daily_Less_Than_Equal_To], [Upper_Bollinger_Band3_4_Hourly_Greater_Than_Equal_To], [Upper_Bollinger_Band3_4_Hourly_Less_Than_Equal_To], [Upper_Bollinger_Band3_1_Hourly_Greater_Than_Equal_To], [Upper_Bollinger_Band3_1_Hourly_Less_Than_Equal_To], [Upper_Bollinger_Band3_15_Minutes_Greater_Than_Equal_To], [Upper_Bollinger_Band3_15_Minutes_Less_Than_Equal_To], [Lower_Bollinger_Band3_Yearly_Greater_Than_Equal_To], [Lower_Bollinger_Band3_Yearly_Less_Than_Equal_To], [Lower_Bollinger_Band3_Quarterly_Greater_Than_Equal_To], [Lower_Bollinger_Band3_Quarterly_Less_Than_Equal_To], [Lower_Bollinger_Band3_Monthly_Greater_Than_Equal_To], [Lower_Bollinger_Band3_Monthly_Less_Than_Equal_To], [Lower_Bollinger_Band3_Weekly_Greater_Than_Equal_To], [Lower_Bollinger_Band3_Weekly_Less_Than_Equal_To], [Lower_Bollinger_Band3_Daily_Greater_Than_Equal_To], [Lower_Bollinger_Band3_Daily_Less_Than_Equal_To], [Lower_Bollinger_Band3_4_Hourly_Greater_Than_Equal_To], [Lower_Bollinger_Band3_4_Hourly_Less_Than_Equal_To], [Lower_Bollinger_Band3_1_Hourly_Greater_Than_Equal_To], [Lower_Bollinger_Band3_1_Hourly_Less_Than_Equal_To], [Lower_Bollinger_Band3_15_Minutes_Greater_Than_Equal_To], [Lower_Bollinger_Band3_15_Minutes_Less_Than_Equal_To], [Upper_Bollinger_Band2_Yearly_Greater_Than_Equal_To], [Upper_Bollinger_Band2_Yearly_Less_Than_Equal_To], [Upper_Bollinger_Band2_Quarterly_Greater_Than_Equal_To], [Upper_Bollinger_Band2_Quarterly_Less_Than_Equal_To], [Upper_Bollinger_Band2_Monthly_Greater_Than_Equal_To], [Upper_Bollinger_Band2_Monthly_Less_Than_Equal_To], [Upper_Bollinger_Band2_Weekly_Greater_Than_Equal_To], [Upper_Bollinger_Band2_Weekly_Less_Than_Equal_To], [Upper_Bollinger_Band2_Daily_Greater_Than_Equal_To], [Upper_Bollinger_Band2_Daily_Less_Than_Equal_To], [Upper_Bollinger_Band2_4_Hourly_Greater_Than_Equal_To], [Upper_Bollinger_Band2_4_Hourly_Less_Than_Equal_To], [Upper_Bollinger_Band2_1_Hourly_Greater_Than_Equal_To], [Upper_Bollinger_Band2_1_Hourly_Less_Than_Equal_To], [Upper_Bollinger_Band2_15_Minutes_Greater_Than_Equal_To], [Upper_Bollinger_Band2_15_Minutes_Less_Than_Equal_To], [Lower_Bollinger_Band2_Yearly_Greater_Than_Equal_To], [Lower_Bollinger_Band2_Yearly_Less_Than_Equal_To], [Lower_Bollinger_Band2_Quarterly_Greater_Than_Equal_To], [Lower_Bollinger_Band2_Quarterly_Less_Than_Equal_To], [Lower_Bollinger_Band2_Monthly_Greater_Than_Equal_To], [Lower_Bollinger_Band2_Monthly_Less_Than_Equal_To], [Lower_Bollinger_Band2_Weekly_Greater_Than_Equal_To], [Lower_Bollinger_Band2_Weekly_Less_Than_Equal_To], [Lower_Bollinger_Band2_Daily_Greater_Than_Equal_To], [Lower_Bollinger_Band2_Daily_Less_Than_Equal_To], [Lower_Bollinger_Band2_4_Hourly_Greater_Than_Equal_To], [Lower_Bollinger_Band2_4_Hourly_Less_Than_Equal_To], [Lower_Bollinger_Band2_1_Hourly_Greater_Than_Equal_To], [Lower_Bollinger_Band2_1_Hourly_Less_Than_Equal_To], [Lower_Bollinger_Band2_15_Minutes_Greater_Than_Equal_To], [Lower_Bollinger_Band2_15_Minutes_Less_Than_Equal_To], [Volume_Yearly_Greater_Than_Equal_To], [Volume_Yearly_Less_Than_Equal_To], [Volume_Quarterly_Greater_Than_Equal_To], [Volume_Quarterly_Less_Than_Equal_To], [Volume_Monthly_Greater_Than_Equal_To], [Volume_Monthly_Less_Than_Equal_To], [Volume_Weekly_Greater_Than_Equal_To], [Volume_Weekly_Less_Than_Equal_To], [Volume_Daily_Greater_Than_Equal_To], [Volume_Daily_Less_Than_Equal_To], [Volume_4_Hourly_Greater_Than_Equal_To], [Volume_4_Hourly_Less_Than_Equal_To], [Volume_1_Hourly_Greater_Than_Equal_To], [Volume_1_Hourly_Less_Than_Equal_To], [Volume_15_Minutes_Greater_Than_Equal_To], [Volume_15_Minutes_Less_Than_Equal_To], [Adx_Up_Tick_Yearly_Greater_Than_Equal_To], [Adx_Down_Tick_Yearly_Less_Than_Equal_To], [Adx_Up_Tick_Quarterly_Greater_Than_Equal_To], [Adx_Down_Tick_Quarterly_Less_Than_Equal_To], [Adx_Up_Tick_Monthly_Greater_Than_Equal_To], [Adx_Down_Tick_Monthly_Less_Than_Equal_To], [Adx_Up_Tick_Weekly_Greater_Than_Equal_To], [Adx_Down_Tick_Weekly_Less_Than_Equal_To], [Adx_Up_Tick_Daily_Greater_Than_Equal_To], [Adx_Down_Tick_Daily_Less_Than_Equal_To], [Adx_Up_Tick_4_Hourly_Greater_Than_Equal_To], [Adx_Down_Tick_4_Hourly_Less_Than_Equal_To], [Adx_Up_Tick_1_Hourly_Greater_Than_Equal_To], [Adx_Down_Tick_1_Hourly_Less_Than_Equal_To], [Adx_Up_Tick_15_Minutes_Greater_Than_Equal_To], [Adx_Down_Tick_15_Minutes_Less_Than_Equal_To])
select [Batch_No], [Sum of Screens], [Length of Segments],[Trade Type], [Trade Type Details], [Length of Trade Type], [Length of Trade Type Details], [Created_Date], [Stock_Name], [Segments], [Symbol], [% Chg], [Price], [Volume], [Bullish_Triple_Screen_Strong_Monthly], [Bullish_Triple_Screen_Strong_Weekly], [Bullish_Triple_Screen_Strong_Daily], [Bullish_Triple_Screen_Strong_4_Hourly], [Bullish_Triple_Screen_Strong_1_Hourly], [Bullish_Triple_Screen_Strong_15_Minutes], [Bullish_Triple_Screen_Strong_Correction_Monthly], [Bullish_Triple_Screen_Strong_Correction_Weekly], [Bullish_Triple_Screen_Strong_Correction_Daily], [Bullish_Triple_Screen_Strong_Correction_4_Hourly], [Bullish_Triple_Screen_Strong_Correction_1_Hourly], [Bullish_Triple_Screen_Strong_Correction_15_Minutes], [Bullish_Double_Screen_Strong_Quarterly], [Bullish_Double_Screen_Strong_Monthly], [Bullish_Double_Screen_Strong_Weekly], [Bullish_Double_Screen_Strong_Daily], [Bullish_Double_Screen_Strong_4_Hourly], [Bullish_Double_Screen_Strong_1_Hourly], [Bullish_Double_Screen_Strong_15_Minutes], [Bullish_Double_Screen_Strong_Correction_Quarterly], [Bullish_Double_Screen_Strong_Correction_Monthly], [Bullish_Double_Screen_Strong_Correction_Weekly], [Bullish_Double_Screen_Strong_Correction_Daily], [Bullish_Double_Screen_Strong_Correction_4_Hourly], [Bullish_Double_Screen_Strong_Correction_1_Hourly], [Bullish_Double_Screen_Strong_Correction_15_Minutes], [Bullish_Single_Screen_Yearly], [Bullish_Single_Screen_Quarterly], [Bullish_Single_Screen_Monthly], [Bullish_Single_Screen_Weekly], [Bullish_Single_Screen_Daily], [Bullish_Single_Screen_4_Hourly], [Bullish_Single_Screen_1_Hourly], [Bullish_Single_Screen_15_Minutes], [Bearish_Triple_Screen_Strong_Monthly], [Bearish_Triple_Screen_Strong_Weekly], [Bearish_Triple_Screen_Strong_Daily], [Bearish_Triple_Screen_Strong_4_Hourly], [Bearish_Triple_Screen_Strong_1_Hourly], [Bearish_Triple_Screen_Strong_15_Minutes], [Bearish_Triple_Screen_Strong_Correction_Monthly], [Bearish_Triple_Screen_Strong_Correction_Weekly], [Bearish_Triple_Screen_Strong_Correction_Daily], [Bearish_Triple_Screen_Strong_Correction_4_Hourly], [Bearish_Triple_Screen_Strong_Correction_1_Hourly], [Bearish_Triple_Screen_Strong_Correction_15_Minutes], [Bearish_Double_Screen_Strong_Quarterly], [Bearish_Double_Screen_Strong_Monthly], [Bearish_Double_Screen_Strong_Weekly], [Bearish_Double_Screen_Strong_Daily], [Bearish_Double_Screen_Strong_4_Hourly], [Bearish_Double_Screen_Strong_1_Hourly], [Bearish_Double_Screen_Strong_15_Minutes], [Bearish_Double_Screen_Strong_Correction_Quarterly], [Bearish_Double_Screen_Strong_Correction_Monthly], [Bearish_Double_Screen_Strong_Correction_Weekly], [Bearish_Double_Screen_Strong_Correction_Daily], [Bearish_Double_Screen_Strong_Correction_4_Hourly], [Bearish_Double_Screen_Strong_Correction_1_Hourly], [Bearish_Double_Screen_Strong_Correction_15_Minutes], [Bearish_Single_Screen_Yearly], [Bearish_Single_Screen_Quarterly], [Bearish_Single_Screen_Monthly], [Bearish_Single_Screen_Weekly], [Bearish_Single_Screen_Daily], [Bearish_Single_Screen_4_Hourly], [Bearish_Single_Screen_1_Hourly], [Bearish_Single_Screen_15_Minutes], [Macd_Yearly_Crosses_Above], [Macd_Yearly_Crosses_Below], [Macd_Quarterly_Crosses_Above], [Macd_Quarterly_Crosses_Below], [Macd_Monthly_Crosses_Above], [Macd_Monthly_Crosses_Below], [Macd_Weekly_Crosses_Above], [Macd_Weekly_Crosses_Below], [Macd_Daily_Crosses_Above], [Macd_Daily_Crosses_Below], [Macd_4_Hourly_Crosses_Above], [Macd_4_Hourly_Crosses_Below], [Macd_1_Hourly_Crosses_Above], [Macd_1_Hourly_Crosses_Below], [Macd_15_Minutes_Crosses_Above], [Macd_15_Minutes_Crosses_Below], [Stochastic_Yearly_Crosses_Above], [Stochastic_Yearly_Crosses_Below], [Stochastic_Quarterly_Crosses_Above], [Stochastic_Quarterly_Crosses_Below], [Stochastic_Monthly_Crosses_Above], [Stochastic_Monthly_Crosses_Below], [Stochastic_Weekly_Crosses_Above], [Stochastic_Weekly_Crosses_Below], [Stochastic_Daily_Crosses_Above], [Stochastic_Daily_Crosses_Below], [Stochastic_4_Hourly_Crosses_Above], [Stochastic_4_Hourly_Crosses_Below], [Stochastic_1_Hourly_Crosses_Above], [Stochastic_1_Hourly_Crosses_Below], [Stochastic_15_Minutes_Crosses_Above], [Stochastic_15_Minutes_Crosses_Below], [Ema_5_13_Yearly_Crosses_Above], [Ema_5_13_Yearly_Crosses_Below], [Ema_5_13_Quarterly_Crosses_Above], [Ema_5_13_Quarterly_Crosses_Below], [Ema_5_13_Monthly_Crosses_Above], [Ema_5_13_Monthly_Crosses_Below], [Ema_5_13_Weekly_Crosses_Above], [Ema_5_13_Weekly_Crosses_Below], [Ema_5_13_Daily_Crosses_Above], [Ema_5_13_Daily_Crosses_Below], [Ema_5_13_4_Hourly_Crosses_Above], [Ema_5_13_4_Hourly_Crosses_Below], [Ema_5_13_1_Hourly_Crosses_Above], [Ema_5_13_1_Hourly_Crosses_Below], [Ema_5_13_15_Minutes_Crosses_Above], [Ema_5_13_15_Minutes_Crosses_Below], [Ema_13_26_Yearly_Crosses_Above], [Ema_13_26_Yearly_Crosses_Below], [Ema_13_26_Quarterly_Crosses_Above], [Ema_13_26_Quarterly_Crosses_Below], [Ema_13_26_Monthly_Crosses_Above], [Ema_13_26_Monthly_Crosses_Below], [Ema_13_26_Weekly_Crosses_Above], [Ema_13_26_Weekly_Crosses_Below], [Ema_13_26_Daily_Crosses_Above], [Ema_13_26_Daily_Crosses_Below], [Ema_13_26_4_Hourly_Crosses_Above], [Ema_13_26_4_Hourly_Crosses_Below], [Ema_13_26_1_Hourly_Crosses_Above], [Ema_13_26_1_Hourly_Crosses_Below], [Ema_13_26_15_Minutes_Crosses_Above], [Ema_13_26_15_Minutes_Crosses_Below], [Ema_50_100_Yearly_Crosses_Above], [Ema_50_100_Yearly_Crosses_Below], [Ema_50_100_Quarterly_Crosses_Above], [Ema_50_100_Quarterly_Crosses_Below], [Ema_50_100_Monthly_Crosses_Above], [Ema_50_100_Monthly_Crosses_Below], [Ema_50_100_Weekly_Crosses_Above], [Ema_50_100_Weekly_Crosses_Below], [Ema_50_100_Daily_Crosses_Above], [Ema_50_100_Daily_Crosses_Below], [Ema_50_100_4_Hourly_Crosses_Above], [Ema_50_100_4_Hourly_Crosses_Below], [Ema_50_100_1_Hourly_Crosses_Above], [Ema_50_100_1_Hourly_Crosses_Below], [Ema_50_100_15_Minutes_Crosses_Above], [Ema_50_100_15_Minutes_Crosses_Below], [Ema_100_200_Yearly_Crosses_Above], [Ema_100_200_Yearly_Crosses_Below], [Ema_100_200_Quarterly_Crosses_Above], [Ema_100_200_Quarterly_Crosses_Below], [Ema_100_200_Monthly_Crosses_Above], [Ema_100_200_Monthly_Crosses_Below], [Ema_100_200_Weekly_Crosses_Above], [Ema_100_200_Weekly_Crosses_Below], [Ema_100_200_Daily_Crosses_Above], [Ema_100_200_Daily_Crosses_Below], [Ema_100_200_4_Hourly_Crosses_Above], [Ema_100_200_4_Hourly_Crosses_Below], [Ema_100_200_1_Hourly_Crosses_Above], [Ema_100_200_1_Hourly_Crosses_Below], [Ema_100_200_15_Minutes_Crosses_Above], [Ema_100_200_15_Minutes_Crosses_Below], [Adx_Yearly_Crosses_Above], [Adx_Yearly_Crosses_Below], [Adx_Quarterly_Crosses_Above], [Adx_Quarterly_Crosses_Below], [Adx_Monthly_Crosses_Above], [Adx_Monthly_Crosses_Below], [Adx_Weekly_Crosses_Above], [Adx_Weekly_Crosses_Below], [Adx_Daily_Crosses_Above], [Adx_Daily_Crosses_Below], [Adx_4_Hourly_Crosses_Above], [Adx_4_Hourly_Crosses_Below], [Adx_1_Hourly_Crosses_Above], [Adx_1_Hourly_Crosses_Below], [Adx_15_Minutes_Crosses_Above], [Adx_15_Minutes_Crosses_Below], [Rsi_Yearly_Crosses_Above], [Rsi_Yearly_Crosses_Below], [Rsi_Quarterly_Crosses_Above], [Rsi_Quarterly_Crosses_Below], [Rsi_Monthly_Crosses_Above], [Rsi_Monthly_Crosses_Below], [Rsi_Weekly_Crosses_Above], [Rsi_Weekly_Crosses_Below], [Rsi_Daily_Crosses_Above], [Rsi_Daily_Crosses_Below], [Rsi_4_Hourly_Crosses_Above], [Rsi_4_Hourly_Crosses_Below], [Rsi_1_Hourly_Crosses_Above], [Rsi_1_Hourly_Crosses_Below], [Rsi_15_Minutes_Crosses_Above], [Rsi_15_Minutes_Crosses_Below], [Upper_Bollinger_Band3_Yearly_Greater_Than_Equal_To], [Upper_Bollinger_Band3_Yearly_Less_Than_Equal_To], [Upper_Bollinger_Band3_Quarterly_Greater_Than_Equal_To], [Upper_Bollinger_Band3_Quarterly_Less_Than_Equal_To], [Upper_Bollinger_Band3_Monthly_Greater_Than_Equal_To], [Upper_Bollinger_Band3_Monthly_Less_Than_Equal_To], [Upper_Bollinger_Band3_Weekly_Greater_Than_Equal_To], [Upper_Bollinger_Band3_Weekly_Less_Than_Equal_To], [Upper_Bollinger_Band3_Daily_Greater_Than_Equal_To], [Upper_Bollinger_Band3_Daily_Less_Than_Equal_To], [Upper_Bollinger_Band3_4_Hourly_Greater_Than_Equal_To], [Upper_Bollinger_Band3_4_Hourly_Less_Than_Equal_To], [Upper_Bollinger_Band3_1_Hourly_Greater_Than_Equal_To], [Upper_Bollinger_Band3_1_Hourly_Less_Than_Equal_To], [Upper_Bollinger_Band3_15_Minutes_Greater_Than_Equal_To], [Upper_Bollinger_Band3_15_Minutes_Less_Than_Equal_To], [Lower_Bollinger_Band3_Yearly_Greater_Than_Equal_To], [Lower_Bollinger_Band3_Yearly_Less_Than_Equal_To], [Lower_Bollinger_Band3_Quarterly_Greater_Than_Equal_To], [Lower_Bollinger_Band3_Quarterly_Less_Than_Equal_To], [Lower_Bollinger_Band3_Monthly_Greater_Than_Equal_To], [Lower_Bollinger_Band3_Monthly_Less_Than_Equal_To], [Lower_Bollinger_Band3_Weekly_Greater_Than_Equal_To], [Lower_Bollinger_Band3_Weekly_Less_Than_Equal_To], [Lower_Bollinger_Band3_Daily_Greater_Than_Equal_To], [Lower_Bollinger_Band3_Daily_Less_Than_Equal_To], [Lower_Bollinger_Band3_4_Hourly_Greater_Than_Equal_To], [Lower_Bollinger_Band3_4_Hourly_Less_Than_Equal_To], [Lower_Bollinger_Band3_1_Hourly_Greater_Than_Equal_To], [Lower_Bollinger_Band3_1_Hourly_Less_Than_Equal_To], [Lower_Bollinger_Band3_15_Minutes_Greater_Than_Equal_To], [Lower_Bollinger_Band3_15_Minutes_Less_Than_Equal_To], [Upper_Bollinger_Band2_Yearly_Greater_Than_Equal_To], [Upper_Bollinger_Band2_Yearly_Less_Than_Equal_To], [Upper_Bollinger_Band2_Quarterly_Greater_Than_Equal_To], [Upper_Bollinger_Band2_Quarterly_Less_Than_Equal_To], [Upper_Bollinger_Band2_Monthly_Greater_Than_Equal_To], [Upper_Bollinger_Band2_Monthly_Less_Than_Equal_To], [Upper_Bollinger_Band2_Weekly_Greater_Than_Equal_To], [Upper_Bollinger_Band2_Weekly_Less_Than_Equal_To], [Upper_Bollinger_Band2_Daily_Greater_Than_Equal_To], [Upper_Bollinger_Band2_Daily_Less_Than_Equal_To], [Upper_Bollinger_Band2_4_Hourly_Greater_Than_Equal_To], [Upper_Bollinger_Band2_4_Hourly_Less_Than_Equal_To], [Upper_Bollinger_Band2_1_Hourly_Greater_Than_Equal_To], [Upper_Bollinger_Band2_1_Hourly_Less_Than_Equal_To], [Upper_Bollinger_Band2_15_Minutes_Greater_Than_Equal_To], [Upper_Bollinger_Band2_15_Minutes_Less_Than_Equal_To], [Lower_Bollinger_Band2_Yearly_Greater_Than_Equal_To], [Lower_Bollinger_Band2_Yearly_Less_Than_Equal_To], [Lower_Bollinger_Band2_Quarterly_Greater_Than_Equal_To], [Lower_Bollinger_Band2_Quarterly_Less_Than_Equal_To], [Lower_Bollinger_Band2_Monthly_Greater_Than_Equal_To], [Lower_Bollinger_Band2_Monthly_Less_Than_Equal_To], [Lower_Bollinger_Band2_Weekly_Greater_Than_Equal_To], [Lower_Bollinger_Band2_Weekly_Less_Than_Equal_To], [Lower_Bollinger_Band2_Daily_Greater_Than_Equal_To], [Lower_Bollinger_Band2_Daily_Less_Than_Equal_To], [Lower_Bollinger_Band2_4_Hourly_Greater_Than_Equal_To], [Lower_Bollinger_Band2_4_Hourly_Less_Than_Equal_To], [Lower_Bollinger_Band2_1_Hourly_Greater_Than_Equal_To], [Lower_Bollinger_Band2_1_Hourly_Less_Than_Equal_To], [Lower_Bollinger_Band2_15_Minutes_Greater_Than_Equal_To], [Lower_Bollinger_Band2_15_Minutes_Less_Than_Equal_To], [Volume_Yearly_Greater_Than_Equal_To], [Volume_Yearly_Less_Than_Equal_To], [Volume_Quarterly_Greater_Than_Equal_To], [Volume_Quarterly_Less_Than_Equal_To], [Volume_Monthly_Greater_Than_Equal_To], [Volume_Monthly_Less_Than_Equal_To], [Volume_Weekly_Greater_Than_Equal_To], [Volume_Weekly_Less_Than_Equal_To], [Volume_Daily_Greater_Than_Equal_To], [Volume_Daily_Less_Than_Equal_To], [Volume_4_Hourly_Greater_Than_Equal_To], [Volume_4_Hourly_Less_Than_Equal_To], [Volume_1_Hourly_Greater_Than_Equal_To], [Volume_1_Hourly_Less_Than_Equal_To], [Volume_15_Minutes_Greater_Than_Equal_To], [Volume_15_Minutes_Less_Than_Equal_To], [Adx_Up_Tick_Yearly_Greater_Than_Equal_To], [Adx_Down_Tick_Yearly_Less_Than_Equal_To], [Adx_Up_Tick_Quarterly_Greater_Than_Equal_To], [Adx_Down_Tick_Quarterly_Less_Than_Equal_To], [Adx_Up_Tick_Monthly_Greater_Than_Equal_To], [Adx_Down_Tick_Monthly_Less_Than_Equal_To], [Adx_Up_Tick_Weekly_Greater_Than_Equal_To], [Adx_Down_Tick_Weekly_Less_Than_Equal_To], [Adx_Up_Tick_Daily_Greater_Than_Equal_To], [Adx_Down_Tick_Daily_Less_Than_Equal_To], [Adx_Up_Tick_4_Hourly_Greater_Than_Equal_To], [Adx_Down_Tick_4_Hourly_Less_Than_Equal_To], [Adx_Up_Tick_1_Hourly_Greater_Than_Equal_To], [Adx_Down_Tick_1_Hourly_Less_Than_Equal_To], [Adx_Up_Tick_15_Minutes_Greater_Than_Equal_To], [Adx_Down_Tick_15_Minutes_Less_Than_Equal_To]
from [_sis].[Analyse_15Minutes_Stocks-1]
;
select 
((LEN([Trade Type]) - LEN(REPLACE([Trade Type], 'Bullish', ''))) / LEN('Bullish')) as Bullish_Type
,((LEN([Trade Type]) - LEN(REPLACE([Trade Type], 'Bearish', ''))) / LEN('Bearish')) as Bearish_Type
,case when ((LEN([Trade Type]) - LEN(REPLACE([Trade Type], 'Bullish', ''))) / LEN('Bullish') ) -
((LEN([Trade Type]) - LEN(REPLACE([Trade Type], 'Bearish', ''))) / LEN('Bearish')) > 0 then 'Bullish' else 'Bearish' end as TradingView
,*
from _sis.Analyse_Stocks
where [Sum of Screens] > 10 and [Length of Segments] > 10 
and Batch_No = (select max(batch_no) from _sis.Analyse_Stocks)
order by Batch_No desc,[Sum of Screens] desc,[Length of Trade Type] desc, [Length of Trade Type Details] desc;
;

-- insert into [_sis].[Analyse_Stocks] ([Batch_No], [Sum of Screens], [Length of Segments], [Trade Type], [Length of Trade Type], [Trade Type Details], [Length of Trade Type Details], [Created_Date], [Stock_Name], [Segments], [Symbol], [% Chg], [Price], [Volume], [Bullish_Triple_Screen_Strong_Monthly], [Bullish_Triple_Screen_Strong_Weekly], [Bullish_Triple_Screen_Strong_Daily], [Bullish_Triple_Screen_Strong_4_Hourly], [Bullish_Triple_Screen_Strong_1_Hourly], [Bullish_Triple_Screen_Strong_15_Minutes], [Bullish_Triple_Screen_Strong_Correction_Monthly], [Bullish_Triple_Screen_Strong_Correction_Weekly], [Bullish_Triple_Screen_Strong_Correction_Daily], [Bullish_Triple_Screen_Strong_Correction_4_Hourly], [Bullish_Triple_Screen_Strong_Correction_1_Hourly], [Bullish_Triple_Screen_Strong_Correction_15_Minutes], [Bullish_Double_Screen_Strong_Quarterly], [Bullish_Double_Screen_Strong_Monthly], [Bullish_Double_Screen_Strong_Weekly], [Bullish_Double_Screen_Strong_Daily], [Bullish_Double_Screen_Strong_4_Hourly], [Bullish_Double_Screen_Strong_1_Hourly], [Bullish_Double_Screen_Strong_15_Minutes], [Bullish_Double_Screen_Strong_Correction_Quarterly], [Bullish_Double_Screen_Strong_Correction_Monthly], [Bullish_Double_Screen_Strong_Correction_Weekly], [Bullish_Double_Screen_Strong_Correction_Daily], [Bullish_Double_Screen_Strong_Correction_4_Hourly], [Bullish_Double_Screen_Strong_Correction_1_Hourly], [Bullish_Double_Screen_Strong_Correction_15_Minutes], [Bullish_Single_Screen_Yearly], [Bullish_Single_Screen_Quarterly], [Bullish_Single_Screen_Monthly], [Bullish_Single_Screen_Weekly], [Bullish_Single_Screen_Daily], [Bullish_Single_Screen_4_Hourly], [Bullish_Single_Screen_1_Hourly], [Bullish_Single_Screen_15_Minutes], [Bearish_Triple_Screen_Strong_Monthly], [Bearish_Triple_Screen_Strong_Weekly], [Bearish_Triple_Screen_Strong_Daily], [Bearish_Triple_Screen_Strong_4_Hourly], [Bearish_Triple_Screen_Strong_1_Hourly], [Bearish_Triple_Screen_Strong_15_Minutes], [Bearish_Triple_Screen_Strong_Correction_Monthly], [Bearish_Triple_Screen_Strong_Correction_Weekly], [Bearish_Triple_Screen_Strong_Correction_Daily], [Bearish_Triple_Screen_Strong_Correction_4_Hourly], [Bearish_Triple_Screen_Strong_Correction_1_Hourly], [Bearish_Triple_Screen_Strong_Correction_15_Minutes], [Bearish_Double_Screen_Strong_Quarterly], [Bearish_Double_Screen_Strong_Monthly], [Bearish_Double_Screen_Strong_Weekly], [Bearish_Double_Screen_Strong_Daily], [Bearish_Double_Screen_Strong_4_Hourly], [Bearish_Double_Screen_Strong_1_Hourly], [Bearish_Double_Screen_Strong_15_Minutes], [Bearish_Double_Screen_Strong_Correction_Quarterly], [Bearish_Double_Screen_Strong_Correction_Monthly], [Bearish_Double_Screen_Strong_Correction_Weekly], [Bearish_Double_Screen_Strong_Correction_Daily], [Bearish_Double_Screen_Strong_Correction_4_Hourly], [Bearish_Double_Screen_Strong_Correction_1_Hourly], [Bearish_Double_Screen_Strong_Correction_15_Minutes], [Bearish_Single_Screen_Yearly], [Bearish_Single_Screen_Quarterly], [Bearish_Single_Screen_Monthly], [Bearish_Single_Screen_Weekly], [Bearish_Single_Screen_Daily], [Bearish_Single_Screen_4_Hourly], [Bearish_Single_Screen_1_Hourly], [Bearish_Single_Screen_15_Minutes], [Macd_Yearly_Crosses_Above], [Macd_Yearly_Crosses_Below], [Macd_Quarterly_Crosses_Above], [Macd_Quarterly_Crosses_Below], [Macd_Monthly_Crosses_Above], [Macd_Monthly_Crosses_Below], [Macd_Weekly_Crosses_Above], [Macd_Weekly_Crosses_Below], [Macd_Daily_Crosses_Above], [Macd_Daily_Crosses_Below], [Macd_4_Hourly_Crosses_Above], [Macd_4_Hourly_Crosses_Below], [Macd_1_Hourly_Crosses_Above], [Macd_1_Hourly_Crosses_Below], [Macd_15_Minutes_Crosses_Above], [Macd_15_Minutes_Crosses_Below], [Stochastic_Yearly_Crosses_Above], [Stochastic_Yearly_Crosses_Below], [Stochastic_Quarterly_Crosses_Above], [Stochastic_Quarterly_Crosses_Below], [Stochastic_Monthly_Crosses_Above], [Stochastic_Monthly_Crosses_Below], [Stochastic_Weekly_Crosses_Above], [Stochastic_Weekly_Crosses_Below], [Stochastic_Daily_Crosses_Above], [Stochastic_Daily_Crosses_Below], [Stochastic_4_Hourly_Crosses_Above], [Stochastic_4_Hourly_Crosses_Below], [Stochastic_1_Hourly_Crosses_Above], [Stochastic_1_Hourly_Crosses_Below], [Stochastic_15_Minutes_Crosses_Above], [Stochastic_15_Minutes_Crosses_Below], [Ema_5_13_Yearly_Crosses_Above], [Ema_5_13_Yearly_Crosses_Below], [Ema_5_13_Quarterly_Crosses_Above], [Ema_5_13_Quarterly_Crosses_Below], [Ema_5_13_Monthly_Crosses_Above], [Ema_5_13_Monthly_Crosses_Below], [Ema_5_13_Weekly_Crosses_Above], [Ema_5_13_Weekly_Crosses_Below], [Ema_5_13_Daily_Crosses_Above], [Ema_5_13_Daily_Crosses_Below], [Ema_5_13_4_Hourly_Crosses_Above], [Ema_5_13_4_Hourly_Crosses_Below], [Ema_5_13_1_Hourly_Crosses_Above], [Ema_5_13_1_Hourly_Crosses_Below], [Ema_5_13_15_Minutes_Crosses_Above], [Ema_5_13_15_Minutes_Crosses_Below], [Ema_13_26_Yearly_Crosses_Above], [Ema_13_26_Yearly_Crosses_Below], [Ema_13_26_Quarterly_Crosses_Above], [Ema_13_26_Quarterly_Crosses_Below], [Ema_13_26_Monthly_Crosses_Above], [Ema_13_26_Monthly_Crosses_Below], [Ema_13_26_Weekly_Crosses_Above], [Ema_13_26_Weekly_Crosses_Below], [Ema_13_26_Daily_Crosses_Above], [Ema_13_26_Daily_Crosses_Below], [Ema_13_26_4_Hourly_Crosses_Above], [Ema_13_26_4_Hourly_Crosses_Below], [Ema_13_26_1_Hourly_Crosses_Above], [Ema_13_26_1_Hourly_Crosses_Below], [Ema_13_26_15_Minutes_Crosses_Above], [Ema_13_26_15_Minutes_Crosses_Below], [Ema_50_100_Yearly_Crosses_Above], [Ema_50_100_Yearly_Crosses_Below], [Ema_50_100_Quarterly_Crosses_Above], [Ema_50_100_Quarterly_Crosses_Below], [Ema_50_100_Monthly_Crosses_Above], [Ema_50_100_Monthly_Crosses_Below], [Ema_50_100_Weekly_Crosses_Above], [Ema_50_100_Weekly_Crosses_Below], [Ema_50_100_Daily_Crosses_Above], [Ema_50_100_Daily_Crosses_Below], [Ema_50_100_4_Hourly_Crosses_Above], [Ema_50_100_4_Hourly_Crosses_Below], [Ema_50_100_1_Hourly_Crosses_Above], [Ema_50_100_1_Hourly_Crosses_Below], [Ema_50_100_15_Minutes_Crosses_Above], [Ema_50_100_15_Minutes_Crosses_Below], [Ema_100_200_Yearly_Crosses_Above], [Ema_100_200_Yearly_Crosses_Below], [Ema_100_200_Quarterly_Crosses_Above], [Ema_100_200_Quarterly_Crosses_Below], [Ema_100_200_Monthly_Crosses_Above], [Ema_100_200_Monthly_Crosses_Below], [Ema_100_200_Weekly_Crosses_Above], [Ema_100_200_Weekly_Crosses_Below], [Ema_100_200_Daily_Crosses_Above], [Ema_100_200_Daily_Crosses_Below], [Ema_100_200_4_Hourly_Crosses_Above], [Ema_100_200_4_Hourly_Crosses_Below], [Ema_100_200_1_Hourly_Crosses_Above], [Ema_100_200_1_Hourly_Crosses_Below], [Ema_100_200_15_Minutes_Crosses_Above], [Ema_100_200_15_Minutes_Crosses_Below], [Adx_Yearly_Crosses_Above], [Adx_Yearly_Crosses_Below], [Adx_Quarterly_Crosses_Above], [Adx_Quarterly_Crosses_Below], [Adx_Monthly_Crosses_Above], [Adx_Monthly_Crosses_Below], [Adx_Weekly_Crosses_Above], [Adx_Weekly_Crosses_Below], [Adx_Daily_Crosses_Above], [Adx_Daily_Crosses_Below], [Adx_4_Hourly_Crosses_Above], [Adx_4_Hourly_Crosses_Below], [Adx_1_Hourly_Crosses_Above], [Adx_1_Hourly_Crosses_Below], [Adx_15_Minutes_Crosses_Above], [Adx_15_Minutes_Crosses_Below], [Rsi_Yearly_Crosses_Above], [Rsi_Yearly_Crosses_Below], [Rsi_Quarterly_Crosses_Above], [Rsi_Quarterly_Crosses_Below], [Rsi_Monthly_Crosses_Above], [Rsi_Monthly_Crosses_Below], [Rsi_Weekly_Crosses_Above], [Rsi_Weekly_Crosses_Below], [Rsi_Daily_Crosses_Above], [Rsi_Daily_Crosses_Below], [Rsi_4_Hourly_Crosses_Above], [Rsi_4_Hourly_Crosses_Below], [Rsi_1_Hourly_Crosses_Above], [Rsi_1_Hourly_Crosses_Below], [Rsi_15_Minutes_Crosses_Above], [Rsi_15_Minutes_Crosses_Below], [Upper_Bollinger_Band3_Yearly_Greater_Than_Equal_To], [Upper_Bollinger_Band3_Yearly_Less_Than_Equal_To], [Upper_Bollinger_Band3_Quarterly_Greater_Than_Equal_To], [Upper_Bollinger_Band3_Quarterly_Less_Than_Equal_To], [Upper_Bollinger_Band3_Monthly_Greater_Than_Equal_To], [Upper_Bollinger_Band3_Monthly_Less_Than_Equal_To], [Upper_Bollinger_Band3_Weekly_Greater_Than_Equal_To], [Upper_Bollinger_Band3_Weekly_Less_Than_Equal_To], [Upper_Bollinger_Band3_Daily_Greater_Than_Equal_To], [Upper_Bollinger_Band3_Daily_Less_Than_Equal_To], [Upper_Bollinger_Band3_4_Hourly_Greater_Than_Equal_To], [Upper_Bollinger_Band3_4_Hourly_Less_Than_Equal_To], [Upper_Bollinger_Band3_1_Hourly_Greater_Than_Equal_To], [Upper_Bollinger_Band3_1_Hourly_Less_Than_Equal_To], [Upper_Bollinger_Band3_15_Minutes_Greater_Than_Equal_To], [Upper_Bollinger_Band3_15_Minutes_Less_Than_Equal_To], [Lower_Bollinger_Band3_Yearly_Greater_Than_Equal_To], [Lower_Bollinger_Band3_Yearly_Less_Than_Equal_To], [Lower_Bollinger_Band3_Quarterly_Greater_Than_Equal_To], [Lower_Bollinger_Band3_Quarterly_Less_Than_Equal_To], [Lower_Bollinger_Band3_Monthly_Greater_Than_Equal_To], [Lower_Bollinger_Band3_Monthly_Less_Than_Equal_To], [Lower_Bollinger_Band3_Weekly_Greater_Than_Equal_To], [Lower_Bollinger_Band3_Weekly_Less_Than_Equal_To], [Lower_Bollinger_Band3_Daily_Greater_Than_Equal_To], [Lower_Bollinger_Band3_Daily_Less_Than_Equal_To], [Lower_Bollinger_Band3_4_Hourly_Greater_Than_Equal_To], [Lower_Bollinger_Band3_4_Hourly_Less_Than_Equal_To], [Lower_Bollinger_Band3_1_Hourly_Greater_Than_Equal_To], [Lower_Bollinger_Band3_1_Hourly_Less_Than_Equal_To], [Lower_Bollinger_Band3_15_Minutes_Greater_Than_Equal_To], [Lower_Bollinger_Band3_15_Minutes_Less_Than_Equal_To], [Upper_Bollinger_Band2_Yearly_Greater_Than_Equal_To], [Upper_Bollinger_Band2_Yearly_Less_Than_Equal_To], [Upper_Bollinger_Band2_Quarterly_Greater_Than_Equal_To], [Upper_Bollinger_Band2_Quarterly_Less_Than_Equal_To], [Upper_Bollinger_Band2_Monthly_Greater_Than_Equal_To], [Upper_Bollinger_Band2_Monthly_Less_Than_Equal_To], [Upper_Bollinger_Band2_Weekly_Greater_Than_Equal_To], [Upper_Bollinger_Band2_Weekly_Less_Than_Equal_To], [Upper_Bollinger_Band2_Daily_Greater_Than_Equal_To], [Upper_Bollinger_Band2_Daily_Less_Than_Equal_To], [Upper_Bollinger_Band2_4_Hourly_Greater_Than_Equal_To], [Upper_Bollinger_Band2_4_Hourly_Less_Than_Equal_To], [Upper_Bollinger_Band2_1_Hourly_Greater_Than_Equal_To], [Upper_Bollinger_Band2_1_Hourly_Less_Than_Equal_To], [Upper_Bollinger_Band2_15_Minutes_Greater_Than_Equal_To], [Upper_Bollinger_Band2_15_Minutes_Less_Than_Equal_To], [Lower_Bollinger_Band2_Yearly_Greater_Than_Equal_To], [Lower_Bollinger_Band2_Yearly_Less_Than_Equal_To], [Lower_Bollinger_Band2_Quarterly_Greater_Than_Equal_To], [Lower_Bollinger_Band2_Quarterly_Less_Than_Equal_To], [Lower_Bollinger_Band2_Monthly_Greater_Than_Equal_To], [Lower_Bollinger_Band2_Monthly_Less_Than_Equal_To], [Lower_Bollinger_Band2_Weekly_Greater_Than_Equal_To], [Lower_Bollinger_Band2_Weekly_Less_Than_Equal_To], [Lower_Bollinger_Band2_Daily_Greater_Than_Equal_To], [Lower_Bollinger_Band2_Daily_Less_Than_Equal_To], [Lower_Bollinger_Band2_4_Hourly_Greater_Than_Equal_To], [Lower_Bollinger_Band2_4_Hourly_Less_Than_Equal_To], [Lower_Bollinger_Band2_1_Hourly_Greater_Than_Equal_To], [Lower_Bollinger_Band2_1_Hourly_Less_Than_Equal_To], [Lower_Bollinger_Band2_15_Minutes_Greater_Than_Equal_To], [Lower_Bollinger_Band2_15_Minutes_Less_Than_Equal_To], [Volume_Yearly_Greater_Than_Equal_To], [Volume_Yearly_Less_Than_Equal_To], [Volume_Quarterly_Greater_Than_Equal_To], [Volume_Quarterly_Less_Than_Equal_To], [Volume_Monthly_Greater_Than_Equal_To], [Volume_Monthly_Less_Than_Equal_To], [Volume_Weekly_Greater_Than_Equal_To], [Volume_Weekly_Less_Than_Equal_To], [Volume_Daily_Greater_Than_Equal_To], [Volume_Daily_Less_Than_Equal_To], [Volume_4_Hourly_Greater_Than_Equal_To], [Volume_4_Hourly_Less_Than_Equal_To], [Volume_1_Hourly_Greater_Than_Equal_To], [Volume_1_Hourly_Less_Than_Equal_To], [Volume_15_Minutes_Greater_Than_Equal_To], [Volume_15_Minutes_Less_Than_Equal_To], [Adx_Up_Tick_Yearly_Greater_Than_Equal_To], [Adx_Down_Tick_Yearly_Less_Than_Equal_To], [Adx_Up_Tick_Quarterly_Greater_Than_Equal_To], [Adx_Down_Tick_Quarterly_Less_Than_Equal_To], [Adx_Up_Tick_Monthly_Greater_Than_Equal_To], [Adx_Down_Tick_Monthly_Less_Than_Equal_To], [Adx_Up_Tick_Weekly_Greater_Than_Equal_To], [Adx_Down_Tick_Weekly_Less_Than_Equal_To], [Adx_Up_Tick_Daily_Greater_Than_Equal_To], [Adx_Down_Tick_Daily_Less_Than_Equal_To], [Adx_Up_Tick_4_Hourly_Greater_Than_Equal_To], [Adx_Down_Tick_4_Hourly_Less_Than_Equal_To], [Adx_Up_Tick_1_Hourly_Greater_Than_Equal_To], [Adx_Down_Tick_1_Hourly_Less_Than_Equal_To], [Adx_Up_Tick_15_Minutes_Greater_Than_Equal_To], [Adx_Down_Tick_15_Minutes_Less_Than_Equal_To], [Trading View])
select [Batch_No], [Sum of Screens], [Length of Segments], [Trade Type], [Length of Trade Type], [Trade Type Details], [Length of Trade Type Details], [Created_Date], [Stock_Name], [Segments], [Symbol], [% Chg], [Price], [Volume], [Bullish_Triple_Screen_Strong_Monthly], [Bullish_Triple_Screen_Strong_Weekly], [Bullish_Triple_Screen_Strong_Daily], [Bullish_Triple_Screen_Strong_4_Hourly], [Bullish_Triple_Screen_Strong_1_Hourly], [Bullish_Triple_Screen_Strong_15_Minutes], [Bullish_Triple_Screen_Strong_Correction_Monthly], [Bullish_Triple_Screen_Strong_Correction_Weekly], [Bullish_Triple_Screen_Strong_Correction_Daily], [Bullish_Triple_Screen_Strong_Correction_4_Hourly], [Bullish_Triple_Screen_Strong_Correction_1_Hourly], [Bullish_Triple_Screen_Strong_Correction_15_Minutes], [Bullish_Double_Screen_Strong_Quarterly], [Bullish_Double_Screen_Strong_Monthly], [Bullish_Double_Screen_Strong_Weekly], [Bullish_Double_Screen_Strong_Daily], [Bullish_Double_Screen_Strong_4_Hourly], [Bullish_Double_Screen_Strong_1_Hourly], [Bullish_Double_Screen_Strong_15_Minutes], [Bullish_Double_Screen_Strong_Correction_Quarterly], [Bullish_Double_Screen_Strong_Correction_Monthly], [Bullish_Double_Screen_Strong_Correction_Weekly], [Bullish_Double_Screen_Strong_Correction_Daily], [Bullish_Double_Screen_Strong_Correction_4_Hourly], [Bullish_Double_Screen_Strong_Correction_1_Hourly], [Bullish_Double_Screen_Strong_Correction_15_Minutes], [Bullish_Single_Screen_Yearly], [Bullish_Single_Screen_Quarterly], [Bullish_Single_Screen_Monthly], [Bullish_Single_Screen_Weekly], [Bullish_Single_Screen_Daily], [Bullish_Single_Screen_4_Hourly], [Bullish_Single_Screen_1_Hourly], [Bullish_Single_Screen_15_Minutes], [Bearish_Triple_Screen_Strong_Monthly], [Bearish_Triple_Screen_Strong_Weekly], [Bearish_Triple_Screen_Strong_Daily], [Bearish_Triple_Screen_Strong_4_Hourly], [Bearish_Triple_Screen_Strong_1_Hourly], [Bearish_Triple_Screen_Strong_15_Minutes], [Bearish_Triple_Screen_Strong_Correction_Monthly], [Bearish_Triple_Screen_Strong_Correction_Weekly], [Bearish_Triple_Screen_Strong_Correction_Daily], [Bearish_Triple_Screen_Strong_Correction_4_Hourly], [Bearish_Triple_Screen_Strong_Correction_1_Hourly], [Bearish_Triple_Screen_Strong_Correction_15_Minutes], [Bearish_Double_Screen_Strong_Quarterly], [Bearish_Double_Screen_Strong_Monthly], [Bearish_Double_Screen_Strong_Weekly], [Bearish_Double_Screen_Strong_Daily], [Bearish_Double_Screen_Strong_4_Hourly], [Bearish_Double_Screen_Strong_1_Hourly], [Bearish_Double_Screen_Strong_15_Minutes], [Bearish_Double_Screen_Strong_Correction_Quarterly], [Bearish_Double_Screen_Strong_Correction_Monthly], [Bearish_Double_Screen_Strong_Correction_Weekly], [Bearish_Double_Screen_Strong_Correction_Daily], [Bearish_Double_Screen_Strong_Correction_4_Hourly], [Bearish_Double_Screen_Strong_Correction_1_Hourly], [Bearish_Double_Screen_Strong_Correction_15_Minutes], [Bearish_Single_Screen_Yearly], [Bearish_Single_Screen_Quarterly], [Bearish_Single_Screen_Monthly], [Bearish_Single_Screen_Weekly], [Bearish_Single_Screen_Daily], [Bearish_Single_Screen_4_Hourly], [Bearish_Single_Screen_1_Hourly], [Bearish_Single_Screen_15_Minutes], [Macd_Yearly_Crosses_Above], [Macd_Yearly_Crosses_Below], [Macd_Quarterly_Crosses_Above], [Macd_Quarterly_Crosses_Below], [Macd_Monthly_Crosses_Above], [Macd_Monthly_Crosses_Below], [Macd_Weekly_Crosses_Above], [Macd_Weekly_Crosses_Below], [Macd_Daily_Crosses_Above], [Macd_Daily_Crosses_Below], [Macd_4_Hourly_Crosses_Above], [Macd_4_Hourly_Crosses_Below], [Macd_1_Hourly_Crosses_Above], [Macd_1_Hourly_Crosses_Below], [Macd_15_Minutes_Crosses_Above], [Macd_15_Minutes_Crosses_Below], [Stochastic_Yearly_Crosses_Above], [Stochastic_Yearly_Crosses_Below], [Stochastic_Quarterly_Crosses_Above], [Stochastic_Quarterly_Crosses_Below], [Stochastic_Monthly_Crosses_Above], [Stochastic_Monthly_Crosses_Below], [Stochastic_Weekly_Crosses_Above], [Stochastic_Weekly_Crosses_Below], [Stochastic_Daily_Crosses_Above], [Stochastic_Daily_Crosses_Below], [Stochastic_4_Hourly_Crosses_Above], [Stochastic_4_Hourly_Crosses_Below], [Stochastic_1_Hourly_Crosses_Above], [Stochastic_1_Hourly_Crosses_Below], [Stochastic_15_Minutes_Crosses_Above], [Stochastic_15_Minutes_Crosses_Below], [Ema_5_13_Yearly_Crosses_Above], [Ema_5_13_Yearly_Crosses_Below], [Ema_5_13_Quarterly_Crosses_Above], [Ema_5_13_Quarterly_Crosses_Below], [Ema_5_13_Monthly_Crosses_Above], [Ema_5_13_Monthly_Crosses_Below], [Ema_5_13_Weekly_Crosses_Above], [Ema_5_13_Weekly_Crosses_Below], [Ema_5_13_Daily_Crosses_Above], [Ema_5_13_Daily_Crosses_Below], [Ema_5_13_4_Hourly_Crosses_Above], [Ema_5_13_4_Hourly_Crosses_Below], [Ema_5_13_1_Hourly_Crosses_Above], [Ema_5_13_1_Hourly_Crosses_Below], [Ema_5_13_15_Minutes_Crosses_Above], [Ema_5_13_15_Minutes_Crosses_Below], [Ema_13_26_Yearly_Crosses_Above], [Ema_13_26_Yearly_Crosses_Below], [Ema_13_26_Quarterly_Crosses_Above], [Ema_13_26_Quarterly_Crosses_Below], [Ema_13_26_Monthly_Crosses_Above], [Ema_13_26_Monthly_Crosses_Below], [Ema_13_26_Weekly_Crosses_Above], [Ema_13_26_Weekly_Crosses_Below], [Ema_13_26_Daily_Crosses_Above], [Ema_13_26_Daily_Crosses_Below], [Ema_13_26_4_Hourly_Crosses_Above], [Ema_13_26_4_Hourly_Crosses_Below], [Ema_13_26_1_Hourly_Crosses_Above], [Ema_13_26_1_Hourly_Crosses_Below], [Ema_13_26_15_Minutes_Crosses_Above], [Ema_13_26_15_Minutes_Crosses_Below], [Ema_50_100_Yearly_Crosses_Above], [Ema_50_100_Yearly_Crosses_Below], [Ema_50_100_Quarterly_Crosses_Above], [Ema_50_100_Quarterly_Crosses_Below], [Ema_50_100_Monthly_Crosses_Above], [Ema_50_100_Monthly_Crosses_Below], [Ema_50_100_Weekly_Crosses_Above], [Ema_50_100_Weekly_Crosses_Below], [Ema_50_100_Daily_Crosses_Above], [Ema_50_100_Daily_Crosses_Below], [Ema_50_100_4_Hourly_Crosses_Above], [Ema_50_100_4_Hourly_Crosses_Below], [Ema_50_100_1_Hourly_Crosses_Above], [Ema_50_100_1_Hourly_Crosses_Below], [Ema_50_100_15_Minutes_Crosses_Above], [Ema_50_100_15_Minutes_Crosses_Below], [Ema_100_200_Yearly_Crosses_Above], [Ema_100_200_Yearly_Crosses_Below], [Ema_100_200_Quarterly_Crosses_Above], [Ema_100_200_Quarterly_Crosses_Below], [Ema_100_200_Monthly_Crosses_Above], [Ema_100_200_Monthly_Crosses_Below], [Ema_100_200_Weekly_Crosses_Above], [Ema_100_200_Weekly_Crosses_Below], [Ema_100_200_Daily_Crosses_Above], [Ema_100_200_Daily_Crosses_Below], [Ema_100_200_4_Hourly_Crosses_Above], [Ema_100_200_4_Hourly_Crosses_Below], [Ema_100_200_1_Hourly_Crosses_Above], [Ema_100_200_1_Hourly_Crosses_Below], [Ema_100_200_15_Minutes_Crosses_Above], [Ema_100_200_15_Minutes_Crosses_Below], [Adx_Yearly_Crosses_Above], [Adx_Yearly_Crosses_Below], [Adx_Quarterly_Crosses_Above], [Adx_Quarterly_Crosses_Below], [Adx_Monthly_Crosses_Above], [Adx_Monthly_Crosses_Below], [Adx_Weekly_Crosses_Above], [Adx_Weekly_Crosses_Below], [Adx_Daily_Crosses_Above], [Adx_Daily_Crosses_Below], [Adx_4_Hourly_Crosses_Above], [Adx_4_Hourly_Crosses_Below], [Adx_1_Hourly_Crosses_Above], [Adx_1_Hourly_Crosses_Below], [Adx_15_Minutes_Crosses_Above], [Adx_15_Minutes_Crosses_Below], [Rsi_Yearly_Crosses_Above], [Rsi_Yearly_Crosses_Below], [Rsi_Quarterly_Crosses_Above], [Rsi_Quarterly_Crosses_Below], [Rsi_Monthly_Crosses_Above], [Rsi_Monthly_Crosses_Below], [Rsi_Weekly_Crosses_Above], [Rsi_Weekly_Crosses_Below], [Rsi_Daily_Crosses_Above], [Rsi_Daily_Crosses_Below], [Rsi_4_Hourly_Crosses_Above], [Rsi_4_Hourly_Crosses_Below], [Rsi_1_Hourly_Crosses_Above], [Rsi_1_Hourly_Crosses_Below], [Rsi_15_Minutes_Crosses_Above], [Rsi_15_Minutes_Crosses_Below], [Upper_Bollinger_Band3_Yearly_Greater_Than_Equal_To], [Upper_Bollinger_Band3_Yearly_Less_Than_Equal_To], [Upper_Bollinger_Band3_Quarterly_Greater_Than_Equal_To], [Upper_Bollinger_Band3_Quarterly_Less_Than_Equal_To], [Upper_Bollinger_Band3_Monthly_Greater_Than_Equal_To], [Upper_Bollinger_Band3_Monthly_Less_Than_Equal_To], [Upper_Bollinger_Band3_Weekly_Greater_Than_Equal_To], [Upper_Bollinger_Band3_Weekly_Less_Than_Equal_To], [Upper_Bollinger_Band3_Daily_Greater_Than_Equal_To], [Upper_Bollinger_Band3_Daily_Less_Than_Equal_To], [Upper_Bollinger_Band3_4_Hourly_Greater_Than_Equal_To], [Upper_Bollinger_Band3_4_Hourly_Less_Than_Equal_To], [Upper_Bollinger_Band3_1_Hourly_Greater_Than_Equal_To], [Upper_Bollinger_Band3_1_Hourly_Less_Than_Equal_To], [Upper_Bollinger_Band3_15_Minutes_Greater_Than_Equal_To], [Upper_Bollinger_Band3_15_Minutes_Less_Than_Equal_To], [Lower_Bollinger_Band3_Yearly_Greater_Than_Equal_To], [Lower_Bollinger_Band3_Yearly_Less_Than_Equal_To], [Lower_Bollinger_Band3_Quarterly_Greater_Than_Equal_To], [Lower_Bollinger_Band3_Quarterly_Less_Than_Equal_To], [Lower_Bollinger_Band3_Monthly_Greater_Than_Equal_To], [Lower_Bollinger_Band3_Monthly_Less_Than_Equal_To], [Lower_Bollinger_Band3_Weekly_Greater_Than_Equal_To], [Lower_Bollinger_Band3_Weekly_Less_Than_Equal_To], [Lower_Bollinger_Band3_Daily_Greater_Than_Equal_To], [Lower_Bollinger_Band3_Daily_Less_Than_Equal_To], [Lower_Bollinger_Band3_4_Hourly_Greater_Than_Equal_To], [Lower_Bollinger_Band3_4_Hourly_Less_Than_Equal_To], [Lower_Bollinger_Band3_1_Hourly_Greater_Than_Equal_To], [Lower_Bollinger_Band3_1_Hourly_Less_Than_Equal_To], [Lower_Bollinger_Band3_15_Minutes_Greater_Than_Equal_To], [Lower_Bollinger_Band3_15_Minutes_Less_Than_Equal_To], [Upper_Bollinger_Band2_Yearly_Greater_Than_Equal_To], [Upper_Bollinger_Band2_Yearly_Less_Than_Equal_To], [Upper_Bollinger_Band2_Quarterly_Greater_Than_Equal_To], [Upper_Bollinger_Band2_Quarterly_Less_Than_Equal_To], [Upper_Bollinger_Band2_Monthly_Greater_Than_Equal_To], [Upper_Bollinger_Band2_Monthly_Less_Than_Equal_To], [Upper_Bollinger_Band2_Weekly_Greater_Than_Equal_To], [Upper_Bollinger_Band2_Weekly_Less_Than_Equal_To], [Upper_Bollinger_Band2_Daily_Greater_Than_Equal_To], [Upper_Bollinger_Band2_Daily_Less_Than_Equal_To], [Upper_Bollinger_Band2_4_Hourly_Greater_Than_Equal_To], [Upper_Bollinger_Band2_4_Hourly_Less_Than_Equal_To], [Upper_Bollinger_Band2_1_Hourly_Greater_Than_Equal_To], [Upper_Bollinger_Band2_1_Hourly_Less_Than_Equal_To], [Upper_Bollinger_Band2_15_Minutes_Greater_Than_Equal_To], [Upper_Bollinger_Band2_15_Minutes_Less_Than_Equal_To], [Lower_Bollinger_Band2_Yearly_Greater_Than_Equal_To], [Lower_Bollinger_Band2_Yearly_Less_Than_Equal_To], [Lower_Bollinger_Band2_Quarterly_Greater_Than_Equal_To], [Lower_Bollinger_Band2_Quarterly_Less_Than_Equal_To], [Lower_Bollinger_Band2_Monthly_Greater_Than_Equal_To], [Lower_Bollinger_Band2_Monthly_Less_Than_Equal_To], [Lower_Bollinger_Band2_Weekly_Greater_Than_Equal_To], [Lower_Bollinger_Band2_Weekly_Less_Than_Equal_To], [Lower_Bollinger_Band2_Daily_Greater_Than_Equal_To], [Lower_Bollinger_Band2_Daily_Less_Than_Equal_To], [Lower_Bollinger_Band2_4_Hourly_Greater_Than_Equal_To], [Lower_Bollinger_Band2_4_Hourly_Less_Than_Equal_To], [Lower_Bollinger_Band2_1_Hourly_Greater_Than_Equal_To], [Lower_Bollinger_Band2_1_Hourly_Less_Than_Equal_To], [Lower_Bollinger_Band2_15_Minutes_Greater_Than_Equal_To], [Lower_Bollinger_Band2_15_Minutes_Less_Than_Equal_To], [Volume_Yearly_Greater_Than_Equal_To], [Volume_Yearly_Less_Than_Equal_To], [Volume_Quarterly_Greater_Than_Equal_To], [Volume_Quarterly_Less_Than_Equal_To], [Volume_Monthly_Greater_Than_Equal_To], [Volume_Monthly_Less_Than_Equal_To], [Volume_Weekly_Greater_Than_Equal_To], [Volume_Weekly_Less_Than_Equal_To], [Volume_Daily_Greater_Than_Equal_To], [Volume_Daily_Less_Than_Equal_To], [Volume_4_Hourly_Greater_Than_Equal_To], [Volume_4_Hourly_Less_Than_Equal_To], [Volume_1_Hourly_Greater_Than_Equal_To], [Volume_1_Hourly_Less_Than_Equal_To], [Volume_15_Minutes_Greater_Than_Equal_To], [Volume_15_Minutes_Less_Than_Equal_To], [Adx_Up_Tick_Yearly_Greater_Than_Equal_To], [Adx_Down_Tick_Yearly_Less_Than_Equal_To], [Adx_Up_Tick_Quarterly_Greater_Than_Equal_To], [Adx_Down_Tick_Quarterly_Less_Than_Equal_To], [Adx_Up_Tick_Monthly_Greater_Than_Equal_To], [Adx_Down_Tick_Monthly_Less_Than_Equal_To], [Adx_Up_Tick_Weekly_Greater_Than_Equal_To], [Adx_Down_Tick_Weekly_Less_Than_Equal_To], [Adx_Up_Tick_Daily_Greater_Than_Equal_To], [Adx_Down_Tick_Daily_Less_Than_Equal_To], [Adx_Up_Tick_4_Hourly_Greater_Than_Equal_To], [Adx_Down_Tick_4_Hourly_Less_Than_Equal_To], [Adx_Up_Tick_1_Hourly_Greater_Than_Equal_To], [Adx_Down_Tick_1_Hourly_Less_Than_Equal_To], [Adx_Up_Tick_15_Minutes_Greater_Than_Equal_To], [Adx_Down_Tick_15_Minutes_Less_Than_Equal_To], [Trading View]
from [_sis].[Analyse_Stocks-1]
;
...
from _sis.Analyse_15Minutes_Stocks order by Created_Date
) b on a.Sno = b.Sno
;
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
select * -- rn,Batch_No,[Trading View],[Trade Type Details], Stock_Name,Segments,Symbol,[% Chg],Price,Volume
from (
	select row_number() over(partition by [Batch_No], [Trading View], [Trade Type Details],[Stock_Name], [Segments], [Symbol] order by Sno desc) as rn,* 
	from _sis.Analyse_15Minutes_Stocks where Batch_No = (select max(batch_no) from _sis.Analyse_15Minutes_Stocks) 
	and [length of Segments] > 10 and [sum of screens] > 10
) a where rn = 1
order by [Trading View] desc,[sum of screens] desc, [length of Trade Type Details] desc,[Length of Segments] desc,[length of trade type] desc
;
select rn,Batch_No,[Trading View],[Trade Type Details], Stock_Name,Segments,Symbol,[% Chg],Price,Volume
from (
	select row_number() over(partition by [Batch_No], [Trading View], [Trade Type Details],[Stock_Name], [Segments], [Symbol] order by Sno desc) as rn ,*
	from _sis.Analyse_Stocks where Batch_No = (select max(batch_no) from _sis.Analyse_Stocks) 
	and [length of Segments] > 5 and [sum of screens] > 10 and volume >10000
) a where rn = 1
order by [Trading View] desc,[sum of screens] desc, [length of Trade Type Details] desc,[Length of Segments] desc,[length of trade type] desc
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
-- when (((LEN([Trade Type]) - LEN(REPLACE([Trade Type], 'Bullish', ''))) / LEN('Bullish') ) - ((LEN([Trade Type]) - LEN(REPLACE([Trade Type], 'Bearish', ''))) / LEN('Bearish'))) 
-- > 0 then 'Bullish' 
-- when (((LEN([Trade Type]) - LEN(REPLACE([Trade Type], 'Bullish', ''))) / LEN('Bullish') ) - ((LEN([Trade Type]) - LEN(REPLACE([Trade Type], 'Bearish', ''))) / LEN('Bearish'))) 
...
;
--------------------------------------------------------------------------------------------------------------------------------
select a.Symbol,b.sno,c.Sector,d.Industry,e.[ISIN Code],f.[Company Name],g.Series
from (select distinct symbol from _sis.Stocks_Industry_Sector_Wise) a
left join (
	select Symbol, STRING_AGG(sno, '; ') as sno 
	from (select distinct symbol,sno from _sis.Stocks_Industry_Sector_Wise) a
	group by Symbol) b
on a.Symbol = b.Symbol
left join (
	select Symbol, STRING_AGG(Sector, '; ') as Sector
	from (select distinct symbol,Sector from _sis.Stocks_Industry_Sector_Wise) a
	group by Symbol) c
on a.Symbol = c.Symbol
left join (
	select Symbol, STRING_AGG(Industry, '; ') as Industry
	from (select distinct symbol,Industry from _sis.Stocks_Industry_Sector_Wise) a
	group by Symbol) d
on a.Symbol = d.Symbol
left join (
	select Symbol, STRING_AGG([ISIN Code], '; ') as [ISIN Code]
	from (select distinct symbol,[ISIN Code] from _sis.Stocks_Industry_Sector_Wise) a
	group by Symbol) e
on a.Symbol = e.Symbol
left join (
	select Symbol, STRING_AGG([Company Name], '; ') as [Company Name]
	from (select distinct symbol,[Company Name] from _sis.Stocks_Industry_Sector_Wise) a
	group by Symbol) f
on a.Symbol = f.Symbol
left join (
	select Symbol, STRING_AGG(Series, '; ') as Series
	from (select distinct symbol,Series from _sis.Stocks_Industry_Sector_Wise) a
	group by Symbol) g
...
--------------------------------------------------------------------------------------------------------------------------------
CREATE FUNCTION dbo.InitCapWithSpaces_temp(@InputString VARCHAR(MAX))
RETURNS VARCHAR(MAX)
AS
BEGIN
...
from _sis.Stocks_Industry_Sector_Wise;
...
--------------------------------------------------------------------------------------------------------------------------------
select a.Symbol,c.Sector,d.Industry,e.[ISIN Code],f.[Company Name],g.Series
-- into _sis.Stocks_Industry_Sector_Wise_distinct
from (select distinct symbol from _sis.Stocks_Industry_Sector_Wise) a
left join (
...
;
--------------------------------------------------------------------------------------------------------------------------------
select a.Symbol,a.Segments,a.Stock_Name,b.Sector,b.Industry,b.[ISIN Code],b.[Company Name],b.Series
into _sis.Master_Stocks_In_Segments1
from [_sis].[Master_Stocks_In_Segments] a
...
-- UPDATE _sis.Master_Stocks_In_Segments SET sno = CTE.sno
select *
FROM _sis.Master_Stocks_In_Segments
JOIN CTE
ON _sis.Master_Stocks_In_Segments.Symbol = CTE.Symbol;
--------------------------------------------------------------------------------------------------------------------------------
-- update a set Industry = b.Industry ,ISIN_Code = b.[ISIN Code] ,Series = b.Series
select * 
from [_sis].[Analyse_15Minutes_Stocks] a
inner join [_sis].[Master_Stocks_In_Segments] b
on a.Symbol = b.Symbol;
--------------------------------------------------------------------------------------------------------------------------------
...
--------------------------------------------------------------------------------------------------------------------------------
-- update [_sis].[Master_Stocks_In_Segments] set Segments = replace(segments,'  ',' ');
--------------------------------------------------------------------------------------------------------------------------------
--select * from [_sis].[Master_Stocks_In_Segments]
;with cte as 
...
select * from _sis.Cash_15Minutes_Stocks
...
GROUP BY symbol, batch_no;
--==============================================================================================================================
-- alter table [_sis].[Analyse_15Minutes_Stocks] add price_action varchar(max)
--------------------------------------------------------------------------------------------------------------------------------
-- price action 
;WITH AdjustedValues AS (
    SELECT 
...
from [_sis].Analyse_15Minutes_Stocks a join Price_Action_Final b 
on a.Symbol = b.symbol and a.Batch_No = b.batch_no
;
--------------------------------------------------------------------------------------------------------------------------------
-- select batch_no, symbol, created_date, price_action from [_sis].[Analyse_Stocks]
...
;
--------------------------------------------------------------------------------------------------------------------------------
INSERT INTO _sis.Analyse_15Minutes_Stocks__Price_Action_table (Row_id,Batch_no,symbol, Timeframe, Value)
SELECT ROW_NUMBER() OVER (PARTITION BY s.batch_no,s.symbol ORDER BY outerJson.[key],abs(innerJson.[value])) AS Row_Id,
	s.Batch_no,s.symbol,
    outerJson.[key] AS Timeframe,
    innerJson.[value] AS Value
FROM [_sis].[Analyse_15Minutes_Stocks] s
...
SELECT top 1000
	...
	p.Stock_Name,
	p.created_date
FROM [_sis].[Analyse_15Minutes_Stocks] p
INNER JOIN [_sis].[Analyse_15Minutes_Stocks__Price_Action_table] c 
ON p.batch_no = c.batch_no AND p.symbol = c.symbol;
--------------------------------------------------------------------------------------------------------------------------------
SELECT * FROM _SIS.Cash_15Minutes_Stocks
WHERE SYMBOL like 'ADANIPORTS'
;
select Symbol,Stock_Name,* from _sis.Master_Stocks_In_Segments
;
--------------------------------------------------------------------------------------------------------------------------------
;with cte as (
	select distinct [trade type details] as ttd,trim(value) as value ,replace(replace(replace([trade type details],'; ',';'),'(',''),')','') as ttds
	from [_sis].[Analyse_Stocks] cross apply STRING_SPLIT(replace(replace([trade type details],'(',''),')',''), ';')
	where Batch_No = 13 and [trade type details] is not null
) 
select * from cte a left join [_sis].[ScreenSort] b
...
;
--------------------------------------------------------------------------------------------------------------------------------
-- select * from _sis.ScreenSort; _sis.Analyse_Stocks
;WITH SplitSignals AS (
    SELECT distinct
        batch_no,sno,[trade type details],
        TRIM(value) AS Signal
...
select * 
-- update a set [trade type details] = SortedSignalString
from _sis.Analyse_15Minutes_Stocks a
inner join final b on a.Batch_No = b.Batch_No and a.Sno = b.Sno
;

select top 1000 * from _sis.Analyse_15Minutes_Stocks where [Trade Type Details] is not null
;

--------------------------------------------------------------------------------------------------------------------------------
select top 1000 * from _sis.Analyse_Stocks with (nolock) order by Batch_No desc;
select top 100 * from _sis.Analyse_Stocks
select * from _sis.Screen_Name_Values

update  _sis.Analyse_Stocks
set [Trade Type] = null
,[Trade Type Details] = null


select * from _sis.ScreenSort

select distinct [trade type details] from _sis.Analyse_Stocks;
select  * from _sis.ScreenSort;
--------------------------------------------------------------------------------------------------------------------------------

select top 1000 * from _sis.Analyse_Stocks where Batch_No = 22;

order by [Length of Trade Type Details] desc;

--------------------------------------------------------------------------------------------------------------------------------
select top 10000 * from _sis.Analyse_Stocks 
where segments like '%Nifty 50%' 
and batch_no = (select max(batch_no) from _sis.Analyse_Stocks)
order by Batch_No desc,[Sum of Screens] desc;

select top 1000 * from [_sis].[cash_stocks] 
where Direction = 'Shockers'
order by batch_no desc,sr# ;

select * from [_sis].[Screen_Name_Values];

select distinct top 10 batch_no,created_date from _sis.Analyse_Stocks order by 1 desc

select top 1000 * from _sis.Analyse_Stocks order by Batch_No desc

/*
alter table _sis.Analyse_Stocks add volume__shockers varchar(255);
alter table _sis.Analyse_15Minutes_Stocks add volume__quarterly__shockers bit null;
alter table _sis.Analyse_15Minutes_Stocks add volume__monthly__shockers bit null;
alter table _sis.Analyse_15Minutes_Stocks add volume__weekly__shockers bit null;
alter table _sis.Analyse_15Minutes_Stocks add volume__daily__shockers bit null;
alter table _sis.Analyse_15Minutes_Stocks add volume__4_hourly__shockers bit null;
alter table _sis.Analyse_15Minutes_Stocks add volume__1_hourly__shockers bit null;
alter table _sis.Analyse_15Minutes_Stocks add volume__15_minutes__shockers bit null;
*/
--------------------------------------------------------------------------------------------------------------------------------
--select top 1000 volume__shockers,* from _sis.Analyse_15Minutes_Stocks 
...
SELECT TOP (1000) 
      ...
      ,[price_action]
      ,[Trade Type]
      ,[Length of Trade Type]
      ,[Length of Trade Type Details]
      ,[Length of Segments]
      ,[Sum of Bullish Screen]
      ,[Sum of Bearish Screen]
      ,[sector_order]
      ,[sector_sum]
      ,[Series]

	  ,*
  FROM [Stocks_Analysis].[_sis].[Analyse_Stocks]
  where volume__shockers is not null
order by Batch_No desc, [Length of Segments] desc, [Sum of Screens] desc
...
into [_sis].[Analyse_15Minutes_Stocks_new]
from [_sis].[Analyse_15Minutes_Stocks]
;
--------------------------------------------------------------------------------------------------------------------------------
select row_number() over (partition by Batch_No order by 
Batch_No desc, 
[Trading View - Order] asc, 
[Volume_Shockers] desc, 
[Segments - Order] desc, 
[Trade Type Details - Sum] desc
	) as report_sort_order
,[Sno], [Batch_No], [Created_Date],[Symbol], [Trading View], [Trading View - Order], [Segments], [Segments - Order], [Volume_Shockers], [Volume_Shockers - Sum], [Trade Type Details], [Trade Type Details - Sum], [Industry], [Stock_Name], [% Chg], [Price], [Volume], [Series], [Trade Type], [Trade Type - Length], [Trade Type - Bullish Sum], [Trade Type - Bearish Sum], [Trade Type Details - Length], [Segments - Length], [Segments - Sum], [price_action], [ISIN_Code], [Bullish_Triple_Screen_Strong_Monthly], [Bullish_Triple_Screen_Strong_Weekly], [Bullish_Triple_Screen_Strong_Daily], [Bullish_Triple_Screen_Strong_4_Hourly], [Bullish_Triple_Screen_Strong_1_Hourly], [Bullish_Triple_Screen_Strong_15_Minutes], [Bullish_Triple_Screen_Strong_Correction_Monthly], [Bullish_Triple_Screen_Strong_Correction_Weekly], [Bullish_Triple_Screen_Strong_Correction_Daily], [Bullish_Triple_Screen_Strong_Correction_4_Hourly], [Bullish_Triple_Screen_Strong_Correction_1_Hourly], [Bullish_Triple_Screen_Strong_Correction_15_Minutes], [Bullish_Double_Screen_Strong_Quarterly], [Bullish_Double_Screen_Strong_Monthly], [Bullish_Double_Screen_Strong_Weekly], [Bullish_Double_Screen_Strong_Daily], [Bullish_Double_Screen_Strong_4_Hourly], [Bullish_Double_Screen_Strong_1_Hourly], [Bullish_Double_Screen_Strong_15_Minutes], [Bullish_Double_Screen_Strong_Correction_Quarterly], [Bullish_Double_Screen_Strong_Correction_Monthly], [Bullish_Double_Screen_Strong_Correction_Weekly], [Bullish_Double_Screen_Strong_Correction_Daily], [Bullish_Double_Screen_Strong_Correction_4_Hourly], [Bullish_Double_Screen_Strong_Correction_1_Hourly], [Bullish_Double_Screen_Strong_Correction_15_Minutes], [Bullish_Single_Screen_Yearly], [Bullish_Single_Screen_Quarterly], [Bullish_Single_Screen_Monthly], [Bullish_Single_Screen_Weekly], [Bullish_Single_Screen_Daily], [Bullish_Single_Screen_4_Hourly], [Bullish_Single_Screen_1_Hourly], [Bullish_Single_Screen_15_Minutes], [Bearish_Triple_Screen_Strong_Monthly], [Bearish_Triple_Screen_Strong_Weekly], [Bearish_Triple_Screen_Strong_Daily], [Bearish_Triple_Screen_Strong_4_Hourly], [Bearish_Triple_Screen_Strong_1_Hourly], [Bearish_Triple_Screen_Strong_15_Minutes], [Bearish_Triple_Screen_Strong_Correction_Monthly], [Bearish_Triple_Screen_Strong_Correction_Weekly], [Bearish_Triple_Screen_Strong_Correction_Daily], [Bearish_Triple_Screen_Strong_Correction_4_Hourly], [Bearish_Triple_Screen_Strong_Correction_1_Hourly], [Bearish_Triple_Screen_Strong_Correction_15_Minutes], [Bearish_Double_Screen_Strong_Quarterly], [Bearish_Double_Screen_Strong_Monthly], [Bearish_Double_Screen_Strong_Weekly], [Bearish_Double_Screen_Strong_Daily], [Bearish_Double_Screen_Strong_4_Hourly], [Bearish_Double_Screen_Strong_1_Hourly], [Bearish_Double_Screen_Strong_15_Minutes], [Bearish_Double_Screen_Strong_Correction_Quarterly], [Bearish_Double_Screen_Strong_Correction_Monthly], [Bearish_Double_Screen_Strong_Correction_Weekly], [Bearish_Double_Screen_Strong_Correction_Daily], [Bearish_Double_Screen_Strong_Correction_4_Hourly], [Bearish_Double_Screen_Strong_Correction_1_Hourly], [Bearish_Double_Screen_Strong_Correction_15_Minutes], [Bearish_Single_Screen_Yearly], [Bearish_Single_Screen_Quarterly], [Bearish_Single_Screen_Monthly], [Bearish_Single_Screen_Weekly], [Bearish_Single_Screen_Daily], [Bearish_Single_Screen_4_Hourly], [Bearish_Single_Screen_1_Hourly], [Bearish_Single_Screen_15_Minutes], [Macd_Yearly_Crosses_Above], [Macd_Yearly_Crosses_Below], [Macd_Quarterly_Crosses_Above], [Macd_Quarterly_Crosses_Below], [Macd_Monthly_Crosses_Above], [Macd_Monthly_Crosses_Below], [Macd_Weekly_Crosses_Above], [Macd_Weekly_Crosses_Below], [Macd_Daily_Crosses_Above], [Macd_Daily_Crosses_Below], [Macd_4_Hourly_Crosses_Above], [Macd_4_Hourly_Crosses_Below], [Macd_1_Hourly_Crosses_Above], [Macd_1_Hourly_Crosses_Below], [Macd_15_Minutes_Crosses_Above], [Macd_15_Minutes_Crosses_Below], [Stochastic_Yearly_Crosses_Above], [Stochastic_Yearly_Crosses_Below], [Stochastic_Quarterly_Crosses_Above], [Stochastic_Quarterly_Crosses_Below], [Stochastic_Monthly_Crosses_Above], [Stochastic_Monthly_Crosses_Below], [Stochastic_Weekly_Crosses_Above], [Stochastic_Weekly_Crosses_Below], [Stochastic_Daily_Crosses_Above], [Stochastic_Daily_Crosses_Below], [Stochastic_4_Hourly_Crosses_Above], [Stochastic_4_Hourly_Crosses_Below], [Stochastic_1_Hourly_Crosses_Above], [Stochastic_1_Hourly_Crosses_Below], [Stochastic_15_Minutes_Crosses_Above], [Stochastic_15_Minutes_Crosses_Below], [Ema_5_13_Yearly_Crosses_Above], [Ema_5_13_Yearly_Crosses_Below], [Ema_5_13_Quarterly_Crosses_Above], [Ema_5_13_Quarterly_Crosses_Below], [Ema_5_13_Monthly_Crosses_Above], [Ema_5_13_Monthly_Crosses_Below], [Ema_5_13_Weekly_Crosses_Above], [Ema_5_13_Weekly_Crosses_Below], [Ema_5_13_Daily_Crosses_Above], [Ema_5_13_Daily_Crosses_Below], [Ema_5_13_4_Hourly_Crosses_Above], [Ema_5_13_4_Hourly_Crosses_Below], [Ema_5_13_1_Hourly_Crosses_Above], [Ema_5_13_1_Hourly_Crosses_Below], [Ema_5_13_15_Minutes_Crosses_Above], [Ema_5_13_15_Minutes_Crosses_Below], [Ema_13_26_Yearly_Crosses_Above], [Ema_13_26_Yearly_Crosses_Below], [Ema_13_26_Quarterly_Crosses_Above], [Ema_13_26_Quarterly_Crosses_Below], [Ema_13_26_Monthly_Crosses_Above], [Ema_13_26_Monthly_Crosses_Below], [Ema_13_26_Weekly_Crosses_Above], [Ema_13_26_Weekly_Crosses_Below], [Ema_13_26_Daily_Crosses_Above], [Ema_13_26_Daily_Crosses_Below], [Ema_13_26_4_Hourly_Crosses_Above], [Ema_13_26_4_Hourly_Crosses_Below], [Ema_13_26_1_Hourly_Crosses_Above], [Ema_13_26_1_Hourly_Crosses_Below], [Ema_13_26_15_Minutes_Crosses_Above], [Ema_13_26_15_Minutes_Crosses_Below], [Ema_50_100_Yearly_Crosses_Above], [Ema_50_100_Yearly_Crosses_Below], [Ema_50_100_Quarterly_Crosses_Above], [Ema_50_100_Quarterly_Crosses_Below], [Ema_50_100_Monthly_Crosses_Above], [Ema_50_100_Monthly_Crosses_Below], [Ema_50_100_Weekly_Crosses_Above], [Ema_50_100_Weekly_Crosses_Below], [Ema_50_100_Daily_Crosses_Above], [Ema_50_100_Daily_Crosses_Below], [Ema_50_100_4_Hourly_Crosses_Above], [Ema_50_100_4_Hourly_Crosses_Below], [Ema_50_100_1_Hourly_Crosses_Above], [Ema_50_100_1_Hourly_Crosses_Below], [Ema_50_100_15_Minutes_Crosses_Above], [Ema_50_100_15_Minutes_Crosses_Below], [Ema_100_200_Yearly_Crosses_Above], [Ema_100_200_Yearly_Crosses_Below], [Ema_100_200_Quarterly_Crosses_Above], [Ema_100_200_Quarterly_Crosses_Below], [Ema_100_200_Monthly_Crosses_Above], [Ema_100_200_Monthly_Crosses_Below], [Ema_100_200_Weekly_Crosses_Above], [Ema_100_200_Weekly_Crosses_Below], [Ema_100_200_Daily_Crosses_Above], [Ema_100_200_Daily_Crosses_Below], [Ema_100_200_4_Hourly_Crosses_Above], [Ema_100_200_4_Hourly_Crosses_Below], [Ema_100_200_1_Hourly_Crosses_Above], [Ema_100_200_1_Hourly_Crosses_Below], [Ema_100_200_15_Minutes_Crosses_Above], [Ema_100_200_15_Minutes_Crosses_Below], [Adx_Yearly_Crosses_Above], [Adx_Yearly_Crosses_Below], [Adx_Quarterly_Crosses_Above], [Adx_Quarterly_Crosses_Below], [Adx_Monthly_Crosses_Above], [Adx_Monthly_Crosses_Below], [Adx_Weekly_Crosses_Above], [Adx_Weekly_Crosses_Below], [Adx_Daily_Crosses_Above], [Adx_Daily_Crosses_Below], [Adx_4_Hourly_Crosses_Above], [Adx_4_Hourly_Crosses_Below], [Adx_1_Hourly_Crosses_Above], [Adx_1_Hourly_Crosses_Below], [Adx_15_Minutes_Crosses_Above], [Adx_15_Minutes_Crosses_Below], [Rsi_Yearly_Crosses_Above], [Rsi_Yearly_Crosses_Below], [Rsi_Quarterly_Crosses_Above], [Rsi_Quarterly_Crosses_Below], [Rsi_Monthly_Crosses_Above], [Rsi_Monthly_Crosses_Below], [Rsi_Weekly_Crosses_Above], [Rsi_Weekly_Crosses_Below], [Rsi_Daily_Crosses_Above], [Rsi_Daily_Crosses_Below], [Rsi_4_Hourly_Crosses_Above], [Rsi_4_Hourly_Crosses_Below], [Rsi_1_Hourly_Crosses_Above], [Rsi_1_Hourly_Crosses_Below], [Rsi_15_Minutes_Crosses_Above], [Rsi_15_Minutes_Crosses_Below], [Upper_Bollinger_Band3_Yearly_Greater_Than_Equal_To], [Upper_Bollinger_Band3_Yearly_Less_Than_Equal_To], [Upper_Bollinger_Band3_Quarterly_Greater_Than_Equal_To], [Upper_Bollinger_Band3_Quarterly_Less_Than_Equal_To], [Upper_Bollinger_Band3_Monthly_Greater_Than_Equal_To], [Upper_Bollinger_Band3_Monthly_Less_Than_Equal_To], [Upper_Bollinger_Band3_Weekly_Greater_Than_Equal_To], [Upper_Bollinger_Band3_Weekly_Less_Than_Equal_To], [Upper_Bollinger_Band3_Daily_Greater_Than_Equal_To], [Upper_Bollinger_Band3_Daily_Less_Than_Equal_To], [Upper_Bollinger_Band3_4_Hourly_Greater_Than_Equal_To], [Upper_Bollinger_Band3_4_Hourly_Less_Than_Equal_To], [Upper_Bollinger_Band3_1_Hourly_Greater_Than_Equal_To], [Upper_Bollinger_Band3_1_Hourly_Less_Than_Equal_To], [Upper_Bollinger_Band3_15_Minutes_Greater_Than_Equal_To], [Upper_Bollinger_Band3_15_Minutes_Less_Than_Equal_To], [Lower_Bollinger_Band3_Yearly_Greater_Than_Equal_To], [Lower_Bollinger_Band3_Yearly_Less_Than_Equal_To], [Lower_Bollinger_Band3_Quarterly_Greater_Than_Equal_To], [Lower_Bollinger_Band3_Quarterly_Less_Than_Equal_To], [Lower_Bollinger_Band3_Monthly_Greater_Than_Equal_To], [Lower_Bollinger_Band3_Monthly_Less_Than_Equal_To], [Lower_Bollinger_Band3_Weekly_Greater_Than_Equal_To], [Lower_Bollinger_Band3_Weekly_Less_Than_Equal_To], [Lower_Bollinger_Band3_Daily_Greater_Than_Equal_To], [Lower_Bollinger_Band3_Daily_Less_Than_Equal_To], [Lower_Bollinger_Band3_4_Hourly_Greater_Than_Equal_To], [Lower_Bollinger_Band3_4_Hourly_Less_Than_Equal_To], [Lower_Bollinger_Band3_1_Hourly_Greater_Than_Equal_To], [Lower_Bollinger_Band3_1_Hourly_Less_Than_Equal_To], [Lower_Bollinger_Band3_15_Minutes_Greater_Than_Equal_To], [Lower_Bollinger_Band3_15_Minutes_Less_Than_Equal_To], [Upper_Bollinger_Band2_Yearly_Greater_Than_Equal_To], [Upper_Bollinger_Band2_Yearly_Less_Than_Equal_To], [Upper_Bollinger_Band2_Quarterly_Greater_Than_Equal_To], [Upper_Bollinger_Band2_Quarterly_Less_Than_Equal_To], [Upper_Bollinger_Band2_Monthly_Greater_Than_Equal_To], [Upper_Bollinger_Band2_Monthly_Less_Than_Equal_To], [Upper_Bollinger_Band2_Weekly_Greater_Than_Equal_To], [Upper_Bollinger_Band2_Weekly_Less_Than_Equal_To], [Upper_Bollinger_Band2_Daily_Greater_Than_Equal_To], [Upper_Bollinger_Band2_Daily_Less_Than_Equal_To], [Upper_Bollinger_Band2_4_Hourly_Greater_Than_Equal_To], [Upper_Bollinger_Band2_4_Hourly_Less_Than_Equal_To], [Upper_Bollinger_Band2_1_Hourly_Greater_Than_Equal_To], [Upper_Bollinger_Band2_1_Hourly_Less_Than_Equal_To], [Upper_Bollinger_Band2_15_Minutes_Greater_Than_Equal_To], [Upper_Bollinger_Band2_15_Minutes_Less_Than_Equal_To], [Lower_Bollinger_Band2_Yearly_Greater_Than_Equal_To], [Lower_Bollinger_Band2_Yearly_Less_Than_Equal_To], [Lower_Bollinger_Band2_Quarterly_Greater_Than_Equal_To], [Lower_Bollinger_Band2_Quarterly_Less_Than_Equal_To], [Lower_Bollinger_Band2_Monthly_Greater_Than_Equal_To], [Lower_Bollinger_Band2_Monthly_Less_Than_Equal_To], [Lower_Bollinger_Band2_Weekly_Greater_Than_Equal_To], [Lower_Bollinger_Band2_Weekly_Less_Than_Equal_To], [Lower_Bollinger_Band2_Daily_Greater_Than_Equal_To], [Lower_Bollinger_Band2_Daily_Less_Than_Equal_To], [Lower_Bollinger_Band2_4_Hourly_Greater_Than_Equal_To], [Lower_Bollinger_Band2_4_Hourly_Less_Than_Equal_To], [Lower_Bollinger_Band2_1_Hourly_Greater_Than_Equal_To], [Lower_Bollinger_Band2_1_Hourly_Less_Than_Equal_To], [Lower_Bollinger_Band2_15_Minutes_Greater_Than_Equal_To], [Lower_Bollinger_Band2_15_Minutes_Less_Than_Equal_To], [Volume_Yearly_Greater_Than_Equal_To], [Volume_Yearly_Less_Than_Equal_To], [Volume_Quarterly_Greater_Than_Equal_To], [Volume_Quarterly_Less_Than_Equal_To], [Volume_Monthly_Greater_Than_Equal_To], [Volume_Monthly_Less_Than_Equal_To], [Volume_Weekly_Greater_Than_Equal_To], [Volume_Weekly_Less_Than_Equal_To], [Volume_Daily_Greater_Than_Equal_To], [Volume_Daily_Less_Than_Equal_To], [Volume_4_Hourly_Greater_Than_Equal_To], [Volume_4_Hourly_Less_Than_Equal_To], [Volume_1_Hourly_Greater_Than_Equal_To], [Volume_1_Hourly_Less_Than_Equal_To], [Volume_15_Minutes_Greater_Than_Equal_To], [Volume_15_Minutes_Less_Than_Equal_To], [Adx_Up_Tick_Yearly_Greater_Than_Equal_To], [Adx_Down_Tick_Yearly_Less_Than_Equal_To], [Adx_Up_Tick_Quarterly_Greater_Than_Equal_To], [Adx_Down_Tick_Quarterly_Less_Than_Equal_To], [Adx_Up_Tick_Monthly_Greater_Than_Equal_To], [Adx_Down_Tick_Monthly_Less_Than_Equal_To], [Adx_Up_Tick_Weekly_Greater_Than_Equal_To], [Adx_Down_Tick_Weekly_Less_Than_Equal_To], [Adx_Up_Tick_Daily_Greater_Than_Equal_To], [Adx_Down_Tick_Daily_Less_Than_Equal_To], [Adx_Up_Tick_4_Hourly_Greater_Than_Equal_To], [Adx_Down_Tick_4_Hourly_Less_Than_Equal_To], [Adx_Up_Tick_1_Hourly_Greater_Than_Equal_To], [Adx_Down_Tick_1_Hourly_Less_Than_Equal_To], [Adx_Up_Tick_15_Minutes_Greater_Than_Equal_To], [Adx_Down_Tick_15_Minutes_Less_Than_Equal_To], [volume__yearly__shockers], [volume__quarterly__shockers], [volume__monthly__shockers], [volume__weekly__shockers], [volume__daily__shockers], [volume__4_hourly__shockers], [volume__1_hourly__shockers], [volume__15_minutes__shockers]
--into [_sis].[Analyse_Stocks_new]
from [_sis].[Analyse_Stocks] where Batch_No = 52 and volume_shockers is not null
order by batch_no desc
;
--------------------------------------------------------------------------------------------------------------------------------
select * 
-- update a set [Volume_Shockers - Sum] = 
isnull([Volume_Shockers - Sum],0) + 
...
,[Segments - Order],[Segments - Sum],price_action
from (
	select row_number() over(partition by [Batch_No], [Trading View],[Trade Type Details],[Stock_Name], [Segments], [Symbol] order by Sno desc) as rn, 
	[Sno], [Batch_No], [Trade Type Details - Sum], [Trade Type - Bullish Sum], [Trade Type - Bearish Sum], [Segments - Length], [Trading View], [Trade Type], [Trade Type - Length], replace([Trade Type Details],';',';'+char(13)+char(10)) as 'Trade-Type-Details',[Trade Type Details], [Trade Type Details - Length], [Created_Date], [Stock_Name],replace([Segments],';',';' + char(13)+ char(10))as segment, [Segments], [Symbol], [% Chg], [Price], [Volume]
	,[Segments - Order],[Segments - Sum],price_action
	from _sis.Analyse_15Minutes_Stocks where Batch_No = (select max(batch_no) from _sis.Analyse_15Minutes_Stocks)
	-- from _sis.Analyse_Stocks where Batch_No = (select max(batch_no) from _sis.Analyse_Stocks)	 	
	and [Segments - Length] > 5 and [Trade Type Details - Sum] > 10 and [Segments - Length] > 25 and volume >1000
	--and Symbol in ('BSE','ARE&M','AXISBANK','COALINDIA','HAL','IREDA','OLAELEC','RELIANCE','SHREEGANES-X','SWSOLAR','TVSSCS','VBL','NIFTY50-INDEX','DEEPAKNTR','DLF','MUKTAARTS','WEBELSOLAR','COLPAL','REDINGTON','BHARATFORG','MUTHOOTFIN')
) a where rn = 1
...
,[Segments - Length], [Trade Type Details - Length], [Created_Date]
,[Segments - Order],[Segments - Sum],price_action
from (
	select row_number() over(partition by [Batch_No], [Trading View],[Trade Type Details],[Stock_Name], [Segments], [Symbol] order by Sno desc) as rn, 
	[Sno], [Batch_No], [Trade Type Details - Sum], [Trade Type - Bullish Sum], [Trade Type - Bearish Sum], [Segments - Length], [Trading View]
	, [Trade Type], [Trade Type - Length], replace([Trade Type Details],';',';'+char(13)+char(10)) as 'Trade-Type-Details',[Trade Type Details]
	, [Trade Type Details - Length], [Created_Date], [Stock_Name],replace([Segments],';',';' + char(13)+ char(10))as segment, [Segments], [Symbol]
	, [% Chg], [Price], [Volume]
	,[Segments - Order],[Segments - Sum],price_action
	--from _sis.Analyse_15Minutes_Stocks where Batch_No = (select max(batch_no) from _sis.Analyse_15Minutes_Stocks)
	 from _sis.Analyse_Stocks where Batch_No = (select max(batch_no) from _sis.Analyse_Stocks)
	 and [Trade Type - Length] > 25 and [Segments - Length] > 10 
	 and volume > 10000 and [Trade Type Details - Sum] > 10
	--and Symbol in ('BSE','ARE&M','AXISBANK','COALINDIA','HAL','IREDA','OLAELEC','RELIANCE','SHREEGANES-X','SWSOLAR','TVSSCS','VBL','NIFTY50-INDEX','DEEPAKNTR','DLF','MUKTAARTS','WEBELSOLAR','COLPAL','REDINGTON','BHARATFORG','MUTHOOTFIN')
) a where rn = 1
-- order by [Trading View] desc,[Trade Type Details - Sum] desc, [Trade Type Details - Length] desc,[Segments - Length] desc,[Trade Type - Length] desc
end
...
select row_number() over (partition by Batch_No order by Batch_No desc, [Trading View - Order] asc, [Segments - Order] desc, [Volume_Shockers] desc, [Trade Type Details - Sum] desc ) as report_sort_order
,[Sno], [Batch_No], [Created_Date],[Symbol], [Trading View], [Trading View - Order], [Segments], [Segments - Order], [Volume_Shockers], [Volume_Shockers - Sum], [Trade Type Details], [Trade Type Details - Sum], [Industry], [Stock_Name], [% Chg], [Price], [Volume], [Series], [Trade Type], [Trade Type - Length], [Trade Type - Bullish Sum], [Trade Type - Bearish Sum], [Trade Type Details - Length], [Segments - Length], [Segments - Sum], [price_action], [ISIN_Code], [Bullish_Triple_Screen_Strong_Monthly], [Bullish_Triple_Screen_Strong_Weekly], [Bullish_Triple_Screen_Strong_Daily], [Bullish_Triple_Screen_Strong_4_Hourly], [Bullish_Triple_Screen_Strong_1_Hourly], [Bullish_Triple_Screen_Strong_15_Minutes], [Bullish_Triple_Screen_Strong_Correction_Monthly], [Bullish_Triple_Screen_Strong_Correction_Weekly], [Bullish_Triple_Screen_Strong_Correction_Daily], [Bullish_Triple_Screen_Strong_Correction_4_Hourly], [Bullish_Triple_Screen_Strong_Correction_1_Hourly], [Bullish_Triple_Screen_Strong_Correction_15_Minutes], [Bullish_Double_Screen_Strong_Quarterly], [Bullish_Double_Screen_Strong_Monthly], [Bullish_Double_Screen_Strong_Weekly], [Bullish_Double_Screen_Strong_Daily], [Bullish_Double_Screen_Strong_4_Hourly], [Bullish_Double_Screen_Strong_1_Hourly], [Bullish_Double_Screen_Strong_15_Minutes], [Bullish_Double_Screen_Strong_Correction_Quarterly], [Bullish_Double_Screen_Strong_Correction_Monthly], [Bullish_Double_Screen_Strong_Correction_Weekly], [Bullish_Double_Screen_Strong_Correction_Daily], [Bullish_Double_Screen_Strong_Correction_4_Hourly], [Bullish_Double_Screen_Strong_Correction_1_Hourly], [Bullish_Double_Screen_Strong_Correction_15_Minutes], [Bullish_Single_Screen_Yearly], [Bullish_Single_Screen_Quarterly], [Bullish_Single_Screen_Monthly], [Bullish_Single_Screen_Weekly], [Bullish_Single_Screen_Daily], [Bullish_Single_Screen_4_Hourly], [Bullish_Single_Screen_1_Hourly], [Bullish_Single_Screen_15_Minutes], [Bearish_Triple_Screen_Strong_Monthly], [Bearish_Triple_Screen_Strong_Weekly], [Bearish_Triple_Screen_Strong_Daily], [Bearish_Triple_Screen_Strong_4_Hourly], [Bearish_Triple_Screen_Strong_1_Hourly], [Bearish_Triple_Screen_Strong_15_Minutes], [Bearish_Triple_Screen_Strong_Correction_Monthly], [Bearish_Triple_Screen_Strong_Correction_Weekly], [Bearish_Triple_Screen_Strong_Correction_Daily], [Bearish_Triple_Screen_Strong_Correction_4_Hourly], [Bearish_Triple_Screen_Strong_Correction_1_Hourly], [Bearish_Triple_Screen_Strong_Correction_15_Minutes], [Bearish_Double_Screen_Strong_Quarterly], [Bearish_Double_Screen_Strong_Monthly], [Bearish_Double_Screen_Strong_Weekly], [Bearish_Double_Screen_Strong_Daily], [Bearish_Double_Screen_Strong_4_Hourly], [Bearish_Double_Screen_Strong_1_Hourly], [Bearish_Double_Screen_Strong_15_Minutes], [Bearish_Double_Screen_Strong_Correction_Quarterly], [Bearish_Double_Screen_Strong_Correction_Monthly], [Bearish_Double_Screen_Strong_Correction_Weekly], [Bearish_Double_Screen_Strong_Correction_Daily], [Bearish_Double_Screen_Strong_Correction_4_Hourly], [Bearish_Double_Screen_Strong_Correction_1_Hourly], [Bearish_Double_Screen_Strong_Correction_15_Minutes], [Bearish_Single_Screen_Yearly], [Bearish_Single_Screen_Quarterly], [Bearish_Single_Screen_Monthly], [Bearish_Single_Screen_Weekly], [Bearish_Single_Screen_Daily], [Bearish_Single_Screen_4_Hourly], [Bearish_Single_Screen_1_Hourly], [Bearish_Single_Screen_15_Minutes], [Macd_Yearly_Crosses_Above], [Macd_Yearly_Crosses_Below], [Macd_Quarterly_Crosses_Above], [Macd_Quarterly_Crosses_Below], [Macd_Monthly_Crosses_Above], [Macd_Monthly_Crosses_Below], [Macd_Weekly_Crosses_Above], [Macd_Weekly_Crosses_Below], [Macd_Daily_Crosses_Above], [Macd_Daily_Crosses_Below], [Macd_4_Hourly_Crosses_Above], [Macd_4_Hourly_Crosses_Below], [Macd_1_Hourly_Crosses_Above], [Macd_1_Hourly_Crosses_Below], [Macd_15_Minutes_Crosses_Above], [Macd_15_Minutes_Crosses_Below], [Stochastic_Yearly_Crosses_Above], [Stochastic_Yearly_Crosses_Below], [Stochastic_Quarterly_Crosses_Above], [Stochastic_Quarterly_Crosses_Below], [Stochastic_Monthly_Crosses_Above], [Stochastic_Monthly_Crosses_Below], [Stochastic_Weekly_Crosses_Above], [Stochastic_Weekly_Crosses_Below], [Stochastic_Daily_Crosses_Above], [Stochastic_Daily_Crosses_Below], [Stochastic_4_Hourly_Crosses_Above], [Stochastic_4_Hourly_Crosses_Below], [Stochastic_1_Hourly_Crosses_Above], [Stochastic_1_Hourly_Crosses_Below], [Stochastic_15_Minutes_Crosses_Above], [Stochastic_15_Minutes_Crosses_Below], [Ema_5_13_Yearly_Crosses_Above], [Ema_5_13_Yearly_Crosses_Below], [Ema_5_13_Quarterly_Crosses_Above], [Ema_5_13_Quarterly_Crosses_Below], [Ema_5_13_Monthly_Crosses_Above], [Ema_5_13_Monthly_Crosses_Below], [Ema_5_13_Weekly_Crosses_Above], [Ema_5_13_Weekly_Crosses_Below], [Ema_5_13_Daily_Crosses_Above], [Ema_5_13_Daily_Crosses_Below], [Ema_5_13_4_Hourly_Crosses_Above], [Ema_5_13_4_Hourly_Crosses_Below], [Ema_5_13_1_Hourly_Crosses_Above], [Ema_5_13_1_Hourly_Crosses_Below], [Ema_5_13_15_Minutes_Crosses_Above], [Ema_5_13_15_Minutes_Crosses_Below], [Ema_13_26_Yearly_Crosses_Above], [Ema_13_26_Yearly_Crosses_Below], [Ema_13_26_Quarterly_Crosses_Above], [Ema_13_26_Quarterly_Crosses_Below], [Ema_13_26_Monthly_Crosses_Above], [Ema_13_26_Monthly_Crosses_Below], [Ema_13_26_Weekly_Crosses_Above], [Ema_13_26_Weekly_Crosses_Below], [Ema_13_26_Daily_Crosses_Above], [Ema_13_26_Daily_Crosses_Below], [Ema_13_26_4_Hourly_Crosses_Above], [Ema_13_26_4_Hourly_Crosses_Below], [Ema_13_26_1_Hourly_Crosses_Above], [Ema_13_26_1_Hourly_Crosses_Below], [Ema_13_26_15_Minutes_Crosses_Above], [Ema_13_26_15_Minutes_Crosses_Below], [Ema_50_100_Yearly_Crosses_Above], [Ema_50_100_Yearly_Crosses_Below], [Ema_50_100_Quarterly_Crosses_Above], [Ema_50_100_Quarterly_Crosses_Below], [Ema_50_100_Monthly_Crosses_Above], [Ema_50_100_Monthly_Crosses_Below], [Ema_50_100_Weekly_Crosses_Above], [Ema_50_100_Weekly_Crosses_Below], [Ema_50_100_Daily_Crosses_Above], [Ema_50_100_Daily_Crosses_Below], [Ema_50_100_4_Hourly_Crosses_Above], [Ema_50_100_4_Hourly_Crosses_Below], [Ema_50_100_1_Hourly_Crosses_Above], [Ema_50_100_1_Hourly_Crosses_Below], [Ema_50_100_15_Minutes_Crosses_Above], [Ema_50_100_15_Minutes_Crosses_Below], [Ema_100_200_Yearly_Crosses_Above], [Ema_100_200_Yearly_Crosses_Below], [Ema_100_200_Quarterly_Crosses_Above], [Ema_100_200_Quarterly_Crosses_Below], [Ema_100_200_Monthly_Crosses_Above], [Ema_100_200_Monthly_Crosses_Below], [Ema_100_200_Weekly_Crosses_Above], [Ema_100_200_Weekly_Crosses_Below], [Ema_100_200_Daily_Crosses_Above], [Ema_100_200_Daily_Crosses_Below], [Ema_100_200_4_Hourly_Crosses_Above], [Ema_100_200_4_Hourly_Crosses_Below], [Ema_100_200_1_Hourly_Crosses_Above], [Ema_100_200_1_Hourly_Crosses_Below], [Ema_100_200_15_Minutes_Crosses_Above], [Ema_100_200_15_Minutes_Crosses_Below], [Adx_Yearly_Crosses_Above], [Adx_Yearly_Crosses_Below], [Adx_Quarterly_Crosses_Above], [Adx_Quarterly_Crosses_Below], [Adx_Monthly_Crosses_Above], [Adx_Monthly_Crosses_Below], [Adx_Weekly_Crosses_Above], [Adx_Weekly_Crosses_Below], [Adx_Daily_Crosses_Above], [Adx_Daily_Crosses_Below], [Adx_4_Hourly_Crosses_Above], [Adx_4_Hourly_Crosses_Below], [Adx_1_Hourly_Crosses_Above], [Adx_1_Hourly_Crosses_Below], [Adx_15_Minutes_Crosses_Above], [Adx_15_Minutes_Crosses_Below], [Rsi_Yearly_Crosses_Above], [Rsi_Yearly_Crosses_Below], [Rsi_Quarterly_Crosses_Above], [Rsi_Quarterly_Crosses_Below], [Rsi_Monthly_Crosses_Above], [Rsi_Monthly_Crosses_Below], [Rsi_Weekly_Crosses_Above], [Rsi_Weekly_Crosses_Below], [Rsi_Daily_Crosses_Above], [Rsi_Daily_Crosses_Below], [Rsi_4_Hourly_Crosses_Above], [Rsi_4_Hourly_Crosses_Below], [Rsi_1_Hourly_Crosses_Above], [Rsi_1_Hourly_Crosses_Below], [Rsi_15_Minutes_Crosses_Above], [Rsi_15_Minutes_Crosses_Below], [Upper_Bollinger_Band3_Yearly_Greater_Than_Equal_To], [Upper_Bollinger_Band3_Yearly_Less_Than_Equal_To], [Upper_Bollinger_Band3_Quarterly_Greater_Than_Equal_To], [Upper_Bollinger_Band3_Quarterly_Less_Than_Equal_To], [Upper_Bollinger_Band3_Monthly_Greater_Than_Equal_To], [Upper_Bollinger_Band3_Monthly_Less_Than_Equal_To], [Upper_Bollinger_Band3_Weekly_Greater_Than_Equal_To], [Upper_Bollinger_Band3_Weekly_Less_Than_Equal_To], [Upper_Bollinger_Band3_Daily_Greater_Than_Equal_To], [Upper_Bollinger_Band3_Daily_Less_Than_Equal_To], [Upper_Bollinger_Band3_4_Hourly_Greater_Than_Equal_To], [Upper_Bollinger_Band3_4_Hourly_Less_Than_Equal_To], [Upper_Bollinger_Band3_1_Hourly_Greater_Than_Equal_To], [Upper_Bollinger_Band3_1_Hourly_Less_Than_Equal_To], [Upper_Bollinger_Band3_15_Minutes_Greater_Than_Equal_To], [Upper_Bollinger_Band3_15_Minutes_Less_Than_Equal_To], [Lower_Bollinger_Band3_Yearly_Greater_Than_Equal_To], [Lower_Bollinger_Band3_Yearly_Less_Than_Equal_To], [Lower_Bollinger_Band3_Quarterly_Greater_Than_Equal_To], [Lower_Bollinger_Band3_Quarterly_Less_Than_Equal_To], [Lower_Bollinger_Band3_Monthly_Greater_Than_Equal_To], [Lower_Bollinger_Band3_Monthly_Less_Than_Equal_To], [Lower_Bollinger_Band3_Weekly_Greater_Than_Equal_To], [Lower_Bollinger_Band3_Weekly_Less_Than_Equal_To], [Lower_Bollinger_Band3_Daily_Greater_Than_Equal_To], [Lower_Bollinger_Band3_Daily_Less_Than_Equal_To], [Lower_Bollinger_Band3_4_Hourly_Greater_Than_Equal_To], [Lower_Bollinger_Band3_4_Hourly_Less_Than_Equal_To], [Lower_Bollinger_Band3_1_Hourly_Greater_Than_Equal_To], [Lower_Bollinger_Band3_1_Hourly_Less_Than_Equal_To], [Lower_Bollinger_Band3_15_Minutes_Greater_Than_Equal_To], [Lower_Bollinger_Band3_15_Minutes_Less_Than_Equal_To], [Upper_Bollinger_Band2_Yearly_Greater_Than_Equal_To], [Upper_Bollinger_Band2_Yearly_Less_Than_Equal_To], [Upper_Bollinger_Band2_Quarterly_Greater_Than_Equal_To], [Upper_Bollinger_Band2_Quarterly_Less_Than_Equal_To], [Upper_Bollinger_Band2_Monthly_Greater_Than_Equal_To], [Upper_Bollinger_Band2_Monthly_Less_Than_Equal_To], [Upper_Bollinger_Band2_Weekly_Greater_Than_Equal_To], [Upper_Bollinger_Band2_Weekly_Less_Than_Equal_To], [Upper_Bollinger_Band2_Daily_Greater_Than_Equal_To], [Upper_Bollinger_Band2_Daily_Less_Than_Equal_To], [Upper_Bollinger_Band2_4_Hourly_Greater_Than_Equal_To], [Upper_Bollinger_Band2_4_Hourly_Less_Than_Equal_To], [Upper_Bollinger_Band2_1_Hourly_Greater_Than_Equal_To], [Upper_Bollinger_Band2_1_Hourly_Less_Than_Equal_To], [Upper_Bollinger_Band2_15_Minutes_Greater_Than_Equal_To], [Upper_Bollinger_Band2_15_Minutes_Less_Than_Equal_To], [Lower_Bollinger_Band2_Yearly_Greater_Than_Equal_To], [Lower_Bollinger_Band2_Yearly_Less_Than_Equal_To], [Lower_Bollinger_Band2_Quarterly_Greater_Than_Equal_To], [Lower_Bollinger_Band2_Quarterly_Less_Than_Equal_To], [Lower_Bollinger_Band2_Monthly_Greater_Than_Equal_To], [Lower_Bollinger_Band2_Monthly_Less_Than_Equal_To], [Lower_Bollinger_Band2_Weekly_Greater_Than_Equal_To], [Lower_Bollinger_Band2_Weekly_Less_Than_Equal_To], [Lower_Bollinger_Band2_Daily_Greater_Than_Equal_To], [Lower_Bollinger_Band2_Daily_Less_Than_Equal_To], [Lower_Bollinger_Band2_4_Hourly_Greater_Than_Equal_To], [Lower_Bollinger_Band2_4_Hourly_Less_Than_Equal_To], [Lower_Bollinger_Band2_1_Hourly_Greater_Than_Equal_To], [Lower_Bollinger_Band2_1_Hourly_Less_Than_Equal_To], [Lower_Bollinger_Band2_15_Minutes_Greater_Than_Equal_To], [Lower_Bollinger_Band2_15_Minutes_Less_Than_Equal_To], [Volume_Yearly_Greater_Than_Equal_To], [Volume_Yearly_Less_Than_Equal_To], [Volume_Quarterly_Greater_Than_Equal_To], [Volume_Quarterly_Less_Than_Equal_To], [Volume_Monthly_Greater_Than_Equal_To], [Volume_Monthly_Less_Than_Equal_To], [Volume_Weekly_Greater_Than_Equal_To], [Volume_Weekly_Less_Than_Equal_To], [Volume_Daily_Greater_Than_Equal_To], [Volume_Daily_Less_Than_Equal_To], [Volume_4_Hourly_Greater_Than_Equal_To], [Volume_4_Hourly_Less_Than_Equal_To], [Volume_1_Hourly_Greater_Than_Equal_To], [Volume_1_Hourly_Less_Than_Equal_To], [Volume_15_Minutes_Greater_Than_Equal_To], [Volume_15_Minutes_Less_Than_Equal_To], [Adx_Up_Tick_Yearly_Greater_Than_Equal_To], [Adx_Down_Tick_Yearly_Less_Than_Equal_To], [Adx_Up_Tick_Quarterly_Greater_Than_Equal_To], [Adx_Down_Tick_Quarterly_Less_Than_Equal_To], [Adx_Up_Tick_Monthly_Greater_Than_Equal_To], [Adx_Down_Tick_Monthly_Less_Than_Equal_To], [Adx_Up_Tick_Weekly_Greater_Than_Equal_To], [Adx_Down_Tick_Weekly_Less_Than_Equal_To], [Adx_Up_Tick_Daily_Greater_Than_Equal_To], [Adx_Down_Tick_Daily_Less_Than_Equal_To], [Adx_Up_Tick_4_Hourly_Greater_Than_Equal_To], [Adx_Down_Tick_4_Hourly_Less_Than_Equal_To], [Adx_Up_Tick_1_Hourly_Greater_Than_Equal_To], [Adx_Down_Tick_1_Hourly_Less_Than_Equal_To], [Adx_Up_Tick_15_Minutes_Greater_Than_Equal_To], [Adx_Down_Tick_15_Minutes_Less_Than_Equal_To], [volume__yearly__shockers], [volume__quarterly__shockers], [volume__monthly__shockers], [volume__weekly__shockers], [volume__daily__shockers], [volume__4_hourly__shockers], [volume__1_hourly__shockers], [volume__15_minutes__shockers]
from [_sis].[Analyse_Stocks] where Batch_No = 52 -- and volume_shockers is not null
;
...
---------------------------------------------------------------------------------------------
select top 1000 [Report Sort Order] as rso,* from _sis.Analyse_Stocks 
