...
def merge_audio():
    ...
    merged_audio += AudioSegment.from_mp3(r"C:\Users\gsrsr\MyDrive\Downloads\Nana_GayatriMantram_1time - Copy (1).mp3")
    merged_audio += AudioSegment.from_mp3(r"C:\Users\gsrsr\MyDrive\Downloads\Nana_GayatriMantram_1time - Copy (2).mp3")
