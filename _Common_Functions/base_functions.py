...
def chat_ink_xls2db(file_name=''):
    ...
    data_list1 = [
        ...
        {'Price_above_200_EMI__yearly__setup'     : {'scan_clause': '( {segments_filter} ( {cash} ( yearly close / yearly ema( yearly close , 200 ) - 1 <= 0.05 and yearly close / yearly ema( yearly close , 200 ) - 1 >= -0.01 ) ))'}},
        {'Price_above_200_EMI__quarterly__setup'  : {'scan_clause': '( {segments_filter} ( {cash} ( quarterly close / quarterly ema( quarterly close , 200 ) - 1 <= 0.05 and quarterly close / quarterly ema( quarterly close , 200 ) - 1 >= -0.01 ) ))'}},
        {'Price_above_200_EMI__monthly__setup'    : {'scan_clause': '( {segments_filter} ( {cash} ( monthly close / monthly ema( monthly close , 200 ) - 1 <= 0.05 and monthly close / monthly ema( monthly close , 200 ) - 1 >= -0.01 ) ))'}},
        {'Price_above_200_EMI__weekly__setup'     : {'scan_clause': '( {segments_filter} ( {cash} ( weekly close / weekly ema( weekly close , 200 ) - 1 <= 0.05 and weekly close / weekly ema( weekly close , 200 ) - 1 >= -0.01 ) ))'}},
        {'Price_above_200_EMI__daily__setup'      : {'scan_clause': '( {segments_filter} ( {cash} ( daily close / daily ema( daily close , 200 ) - 1 <= 0.05 and daily close / daily ema( daily close , 200 ) - 1 >= -0.01 ) ))'}},

        {'Price_below_200_EMI__yearly__setup'     : {'scan_clause': '( {segments_filter} ( {cash} ( yearly close / yearly ema( yearly close , 200 ) - 1 <= 0.01 and yearly close / yearly ema( yearly close , 200 ) - 1 >= -0.05 ) ))'}},
        {'Price_below_200_EMI__quarterly__setup'  : {'scan_clause': '( {segments_filter} ( {cash} ( quarterly close / quarterly ema( quarterly close , 200 ) - 1 <= 0.01 and quarterly close / quarterly ema( quarterly close , 200 ) - 1 >= -0.05 ) ))'}},
        {'Price_below_200_EMI__monthly__setup'    : {'scan_clause': '( {segments_filter} ( {cash} ( monthly close / monthly ema( monthly close , 200 ) - 1 <= 0.01 and monthly close / monthly ema( monthly close , 200 ) - 1 >= -0.05 ) ))'}},
        {'Price_below_200_EMI__weekly__setup'     : {'scan_clause': '( {segments_filter} ( {cash} ( weekly close / weekly ema( weekly close , 200 ) - 1 <= 0.01 and weekly close / weekly ema( weekly close , 200 ) - 1 >= -0.05 ) ))'}},
        {'Price_below_200_EMI__daily__setup'      : {'scan_clause': '( {segments_filter} ( {cash} ( daily close / daily ema( daily close , 200 ) - 1 <= 0.01 and daily close / daily ema( daily close , 200 ) - 1 >= -0.05 ) ))'}},

        {'Price_above_50_EMI__yearly__setup'      : {'scan_clause': '( {segments_filter} ( {cash} ( yearly close / yearly ema( yearly close , 50 ) - 1 <= 0.05 and yearly close / yearly ema( yearly close , 50 ) - 1 >= -0.01 ) ))'}},
        {'Price_above_50_EMI__quarterly__setup'   : {'scan_clause': '( {segments_filter} ( {cash} ( quarterly close / quarterly ema( quarterly close , 50 ) - 1 <= 0.05 and quarterly close / quarterly ema( quarterly close , 50 ) - 1 >= -0.01 ) ))'}},
        {'Price_above_50_EMI__monthly__setup'     : {'scan_clause': '( {segments_filter} ( {cash} ( monthly close / monthly ema( monthly close , 50 ) - 1 <= 0.05 and monthly close / monthly ema( monthly close , 50 ) - 1 >= -0.01 ) ))'}},
        {'Price_above_50_EMI__weekly__setup'      : {'scan_clause': '( {segments_filter} ( {cash} ( weekly close / weekly ema( weekly close , 50 ) - 1 <= 0.05 and weekly close / weekly ema( weekly close , 50 ) - 1 >= -0.01 ) ))'}},
        {'Price_above_50_EMI__daily__setup'       : {'scan_clause': '( {segments_filter} ( {cash} ( daily close / daily ema( daily close , 50 ) - 1 <= 0.05 and daily close / daily ema( daily close , 50 ) - 1 >= -0.01 ) ))'}},

        {'Price_below_50_EMI__yearly__setup'      : {'scan_clause': '( {segments_filter} ( {cash} ( yearly close / yearly ema( yearly close , 50 ) - 1 <= 0.01 and yearly close / yearly ema( yearly close , 50 ) - 1 >= -0.05 ) ))'}},
        {'Price_below_50_EMI__quarterly__setup'   : {'scan_clause': '( {segments_filter} ( {cash} ( quarterly close / quarterly ema( quarterly close , 50 ) - 1 <= 0.01 and quarterly close / quarterly ema( quarterly close , 50 ) - 1 >= -0.05 ) ))'}},
        {'Price_below_50_EMI__monthly__setup'     : {'scan_clause': '( {segments_filter} ( {cash} ( monthly close / monthly ema( monthly close , 50 ) - 1 <= 0.01 and monthly close / monthly ema( monthly close , 50 ) - 1 >= -0.05 ) ))'}},
        {'Price_below_50_EMI__weekly__setup'      : {'scan_clause': '( {segments_filter} ( {cash} ( weekly close / weekly ema( weekly close , 50 ) - 1 <= 0.01 and weekly close / weekly ema( weekly close , 50 ) - 1 >= -0.05 ) ))'}},
        {'Price_below_50_EMI__daily__setup'       : {'scan_clause': '( {segments_filter} ( {cash} ( daily close / daily ema( daily close , 50 ) - 1 <= 0.01 and daily close / daily ema( daily close , 50 ) - 1 >= -0.05 ) ))'}},
    ...
    data_list2 = [
        ...
        {'Price_above_200_EMI__4_hourly__setup'     : {'scan_clause': '( {segments_filter} ( {cash} ( [0] 4 hour close / [0] 4 hour ema( [0] 4 hour close , 200 ) - 1 <= 0.01 and [0] 4 hour close / [0] 4 hour ema( [0] 4 hour close , 200 ) - 1 >= -0.05 ) ))'}},
        {'Price_above_200_EMI__1_hourly__setup'     : {'scan_clause': '( {segments_filter} ( {cash} ( [0] 1 hour close / [0] 1 hour ema( [0] 1 hour close , 200 ) - 1 <= 0.01 and [0] 1 hour close / [0] 1 hour ema( [0] 1 hour close , 200 ) - 1 >= -0.05 ) ))'}},
        {'Price_above_200_EMI__15_minutes__setup'   : {'scan_clause': '( {segments_filter} ( {cash} ( [0] 15 minute close / [0] 15 minute ema( [0] 15 minute close , 200 ) - 1 <= 0.01 and [0] 15 minute close / [0] 15 minute ema( [0] 15 minute close , 200 ) - 1 >= -0.05 ) ))'}},

        {'Price_below_200_EMI__4_hourly__setup'     : {'scan_clause': '( {segments_filter} ( {cash} ( [0] 4 hour close / [0] 4 hour ema( [0] 4 hour close , 200 ) - 1 <= 0.05 and [0] 4 hour close / [0] 4 hour ema( [0] 4 hour close , 200 ) - 1 >= -0.01 ) ))'}},
        {'Price_below_200_EMI__1_hourly__setup'     : {'scan_clause': '( {segments_filter} ( {cash} ( [0] 1 hour close / [0] 1 hour ema( [0] 1 hour close , 200 ) - 1 <= 0.05 and [0] 1 hour close / [0] 1 hour ema( [0] 1 hour close , 200 ) - 1 >= -0.01 ) ))'}},
        {'Price_below_200_EMI__15_minutes__setup'   : {'scan_clause': '( {segments_filter} ( {cash} ( [0] 15 minute close / [0] 15 minute ema( [0] 15 minute close , 200 ) - 1 <= 0.05 and [0] 15 minute close / [0] 15 minute ema( [0] 15 minute close , 200 ) - 1 >= -0.01 ) ))'}},

        {'Price_above_50_EMI__4_hourly__setup'      : {'scan_clause': '( {segments_filter} ( {cash} ( [0] 4 hour close / [0] 4 hour ema( [0] 4 hour close , 50 ) - 1 <= 0.01 and [0] 4 hour close / [0] 4 hour ema( [0] 4 hour close , 50 ) - 1 >= -0.05 ) ))'}},
        {'Price_above_50_EMI__1_hourly__setup'      : {'scan_clause': '( {segments_filter} ( {cash} ( [0] 1 hour close / [0] 1 hour ema( [0] 1 hour close , 50 ) - 1 <= 0.01 and [0] 1 hour close / [0] 1 hour ema( [0] 1 hour close , 50 ) - 1 >= -0.05 ) ))'}},
        {'Price_above_50_EMI__15_minutes__setup'    : {'scan_clause': '( {segments_filter} ( {cash} ( [0] 15 minute close / [0] 15 minute ema( [0] 15 minute close , 50 ) - 1 <= 0.01 and [0] 15 minute close / [0] 15 minute ema( [0] 15 minute close , 50 ) - 1 >= -0.05 ) ))'}},

        {'Price_below_50_EMI__4_hourly__setup'      : {'scan_clause': '( {segments_filter} ( {cash} ( [0] 4 hour close / [0] 4 hour ema( [0] 4 hour close , 50 ) - 1 <= 0.05 and [0] 4 hour close / [0] 4 hour ema( [0] 4 hour close , 50 ) - 1 >= -0.01 ) ))'}},
        {'Price_below_50_EMI__1_hourly__setup'      : {'scan_clause': '( {segments_filter} ( {cash} ( [0] 1 hour close / [0] 1 hour ema( [0] 1 hour close , 50 ) - 1 <= 0.05 and [0] 1 hour close / [0] 1 hour ema( [0] 1 hour close , 50 ) - 1 >= -0.01 ) ))'}},
        {'Price_below_50_EMI__15_minutes__setup'    : {'scan_clause': '( {segments_filter} ( {cash} ( [0] 15 minute close / [0] 15 minute ema( [0] 15 minute close , 50 ) - 1 <= 0.05 and [0] 15 minute close / [0] 15 minute ema( [0] 15 minute close , 50 ) - 1 >= -0.01 ) ))'}},
