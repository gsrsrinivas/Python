...
def charink_excel_file_download_and_insert_into_db():
    ...
    if total_seconds_in_morning > 0 > total_seconds_in_evening:
        print(
            f"Current Time: {current_timestamp} is within the trading Hours i.e., 7:30 am to 15:30 pm \nso continuing the program")
    else:
        print(
            f"Current Time: {current_timestamp} is outside of trading Hours i.e., 7:30 am to 15:30 pm \nso existing the program")
        time.sleep(15)
        sys.exit()
    # ######################################################################################################################
...
if __name__ == "__main__":
    charink_excel_file_download_and_insert_into_db()
